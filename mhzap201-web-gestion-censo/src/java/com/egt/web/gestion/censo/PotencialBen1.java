...
public class PotencialBen1 extends AbstractPageBean
...
/**/
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("PotencialBen1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("PotencialBen1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("PotencialBen1_ETIQUETA_CLASE_MAESTRO");
