...
public class VisitaCenso2 extends AbstractPageBean
        implements PaginaActualizacionVisitaCenso, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple {
    ...
    private HelpInline helpInlineIdVisitaCenso1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineIdVisitaCenso1() {
        return helpInlineIdVisitaCenso1;
    }

    public void setHelpInlineIdVisitaCenso1(HelpInline hi) {
        this.helpInlineIdVisitaCenso1 = hi;
    }
    ...
    private Calendar campoFechaVisita1 = new com.egt.core.jsf.component.Calendario();

    public Calendar getCampoFechaVisita1() {
        return campoFechaVisita1;
    }

    public void setCampoFechaVisita1(Calendar component) {
        this.campoFechaVisita1 = component;
    }

    private HelpInline helpInlineFechaVisita1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineFechaVisita1() {
        return helpInlineFechaVisita1;
    }

    public void setHelpInlineFechaVisita1(HelpInline hi) {
        this.helpInlineFechaVisita1 = hi;
    }
...
/**/
    ...
    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("VisitaCenso2_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("VisitaCenso2_ETIQUETA_CLASE_MAESTRO");
