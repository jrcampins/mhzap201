...
public class FichaPersonaPorFichaHogar1 extends AbstractPageBean
        implements PaginaActualizacionFichaPersonaPorFichaHogar, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla, PaginaConsultaConMaestro {
    ...
    // </editor-fold>
/**/
    public FichaPersonaPorFichaHogar1() {
    }
    ...
    private AsistentePaginaActualizacionFichaPersonaPorFichaHogar asistente = new AsistentePaginaActualizacionFichaPersonaPorFichaHogar(this);

    public AsistentePaginaActualizacionFichaPersonaPorFichaHogar getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("FichaPersonaPorFichaHogar1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("FichaPersonaPorFichaHogar1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("FichaPersonaPorFichaHogar1_ETIQUETA_CLASE_MAESTRO");
    ...
    public long getFuncionCrearRecurso() {
        return FichaPersonaCachedRowSetDataProvider2.FUNCION_CREAR_FICHA_PERSONA;
    }

    @Override
    public long getFuncionModificarRecurso() {
        return FichaPersonaCachedRowSetDataProvider2.FUNCION_MODIFICAR_FICHA_PERSONA;
    }

    @Override
    public long getFuncionEliminarRecurso() {
        return FichaPersonaCachedRowSetDataProvider2.FUNCION_ELIMINAR_FICHA_PERSONA;
    }
    ...
    public String getColumnaIdentificacionRecursoMaestro() {
        return FichaPersonaCachedRowSetDataProvider2.COLUMNA_ID_FICHA_HOGAR;
    }
