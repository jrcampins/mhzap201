                                        ...
                                        <webuijsf:table
                                            ...
                                            <webuijsf:tableRowGroup 
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{PotencialBen1.gestor.designing}"/>
                                                <webuijsf:label
                                                    binding="#{PotencialBen1.labelIndiceCalidadVida1}"
                                                    id="labelIndiceCalidadVida1"
                                                    for="campoIndiceCalidadVida1"/>
                                                <webuijsf:textField id="campoIndiceCalidadVida1"
                                                    binding="#{PotencialBen1.campoIndiceCalidadVida1}"
                                                    converter="#{PotencialBen1.converterIndiceCalidadVida1}"
                                                    readOnly="true"
                                                    text="#{currentRow.value['indice_calidad_vida']}"
                                                    toolTip="BundleParametros.indice_calidad_vida.potencial_ben"
                                                    validatorExpression="#{PotencialBen1.validatorIndiceCalidadVida1.validate}"/>
                                                <webuijsf:staticText id="campoIndiceCalidadVida1Texto1"
                                                    binding="#{PotencialBen1.campoIndiceCalidadVida1Texto1}"
                                                    converter="#{PotencialBen1.converterIndiceCalidadVida1}"
                                                    text="#{currentRow.value['indice_calidad_vida']}"/>
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{PotencialBen1.gestor.designing}"/>
                                                <webuijsf:label
                                                    binding="#{PotencialBen1.labelEsPotencialBenMigrado1}"
                                                    id="labelEsPotencialBenMigrado1"
                                                    for="listaEsPotencialBenMigrado1"/>
                                                <webuijsf:dropDown id="listaEsPotencialBenMigrado1"
                                                    binding="#{PotencialBen1.listaEsPotencialBenMigrado1}"
                                                    converter="#{PotencialBen1.converterEsPotencialBenMigrado1}"
                                                    disabled="true"
                                                    items="#{PotencialBen1.asistente.opcionesListaEsPotencialBenMigrado1}"
                                                    selected="#{currentRow.value['es_potencial_ben_migrado']}"
                                                    toolTip="BundleParametros.es_potencial_ben_migrado.potencial_ben"/>
                                                <webuijsf:staticText id="listaEsPotencialBenMigrado1Texto1"
                                                    binding="#{PotencialBen1.listaEsPotencialBenMigrado1Texto1}"/>
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{PotencialBen1.gestor.designing}"/>
                                                <webuijsf:label
                                                    binding="#{PotencialBen1.labelLote1}"
                                                    id="labelLote1"
                                                    for="campoLote1"/>
                                                <webuijsf:textField id="campoLote1"
                                                    binding="#{PotencialBen1.campoLote1}"
                                                    converter="#{PotencialBen1.converterLote1}"
                                                    readOnly="true"
                                                    text="#{currentRow.value['lote']}"
                                                    toolTip="BundleParametros.lote.potencial_ben"
                                                    validatorExpression="#{PotencialBen1.validatorLote1.validate}"/>
                                                <webuijsf:staticText id="campoLote1Texto1"
                                                    binding="#{PotencialBen1.campoLote1Texto1}"
                                                    text="#{currentRow.value['lote']}"/>
