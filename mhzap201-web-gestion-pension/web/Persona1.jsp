                                    ...
                                    <h:panelGrid 
                                        ...
                                        <webuijsf:table
                                            ...
                                            <webuijsf:tableRowGroup 
                                                ...
                                                <webuijsf:tableColumn
                                                    binding="#{Persona1.tableColumnDiasVigenciaCertificadoVida1}"
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{Persona1.gestor.designing}"/>
                                                <webuijsf:label
                                                    binding="#{Persona1.labelDiasVigenciaCertificadoVida1}"
                                                ...
                                                <webuijsf:textField id="campoDiasVigenciaCertificadoVida1"
                                                    binding="#{Persona1.campoDiasVigenciaCertificadoVida1}"
                                                    converter="#{Persona1.converterDiasVigenciaCertificadoVida1}"
                                                    readOnly="true"
                                                    text="#{currentRow.value['dias_vigencia_certificado_vida']}"
                                                    toolTip="BundleParametros.dias_vigencia_certificado_vida.persona"
                                                    validatorExpression="#{Persona1.validatorDiasVigenciaCertificadoVida1.validate}"/>
                                                <webuijsf:staticText id="campoDiasVigenciaCertificadoVida1Texto1"
                                                    binding="#{Persona1.campoDiasVigenciaCertificadoVida1Texto1}"
                                                    text="#{currentRow.value['dias_vigencia_certificado_vida']}"/>
                                                ...
                                                <webuijsf:tableColumn
                                                    binding="#{Persona1.tableColumnNumeroResolucionRevPen1}"
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{Persona1.gestor.designing}"/>
                                                <webuijsf:label
                                                    binding="#{Persona1.labelNumeroResolucionRevPen1}"
                                                    id="labelNumeroResolucionRevPen1"
                                                    for="campoNumeroResolucionRevPen1"/>
                                                <webuijsf:textField id="campoNumeroResolucionRevPen1"
                                                    binding="#{Persona1.campoNumeroResolucionRevPen1}"
                                                    columns="20"
                                                    maxLength="50"
                                                    readOnly="true"
                                                    text="#{currentRow.value['numero_resolucion_rev_pen']}"
                                                    toolTip="BundleParametros.numero_resolucion_rev_pen.persona"
                                                    validatorExpression="#{Persona1.validatorNumeroResolucionRevPen1.validate}"/>
                                                <webuijsf:staticText id="campoNumeroResolucionRevPen1Texto1"
                                                    binding="#{Persona1.campoNumeroResolucionRevPen1Texto1}"
                                                    text="#{currentRow.value['numero_resolucion_rev_pen']}"/>
                                                <webuijsf:message id="messageNumeroResolucionRevPen1"
                                                    for="campoNumeroResolucionRevPen1"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn
                                                    binding="#{Persona1.tableColumnFechaResolucionRevPen1}"
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{Persona1.gestor.designing}"/>
                                                <webuijsf:label
                                                    binding="#{Persona1.labelFechaResolucionRevPen1}"
                                                    id="labelFechaResolucionRevPen1"
                                                    for="campoFechaResolucionRevPen1"/>
                                                <webuijsf:textField id="campoFechaResolucionRevPen1"
                                                    binding="#{Persona1.campoFechaResolucionRevPen1}"
                                                    converter="#{Persona1.converterFechaResolucionRevPen1}"
                                                    readOnly="true"
                                                    text="#{currentRow.value['fecha_resolucion_rev_pen']}"
                                                    toolTip="BundleParametros.fecha_resolucion_rev_pen.persona"/>
                                                <webuijsf:staticText id="campoFechaResolucionRevPen1Texto1"
                                                    binding="#{Persona1.campoFechaResolucionRevPen1Texto1}"
                                                    converter="#{Persona1.converterFechaResolucionRevPen1}"
                                                    text="#{currentRow.value['fecha_resolucion_rev_pen']}"/>
                                                ...
                                                <webuijsf:tableColumn
                                                    binding="#{Persona1.tableColumnLote1}"
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{Persona1.gestor.designing}"/>
                                                <webuijsf:label
                                                    binding="#{Persona1.labelLote1}"
                                                    id="labelLote1"
                                                    for="campoLote1"/>
                                                <webuijsf:textField id="campoLote1"
                                                    binding="#{Persona1.campoLote1}"
                                                    converter="#{Persona1.converterLote1}"
                                                    readOnly="true"
                                                    text="#{currentRow.value['lote']}"
                                                    toolTip="BundleParametros.lote.persona"
                                                    validatorExpression="#{Persona1.validatorLote1.validate}"/>
                                                <webuijsf:staticText id="campoLote1Texto1"
                                                    binding="#{Persona1.campoLote1Texto1}"
                                                    text="#{currentRow.value['lote']}"/>
                                                <webuijsf:message id="messageLote1"
                                                    for="campoLote1"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn
                                                    binding="#{Persona1.tableColumnCodigoSime1}"
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{Persona1.gestor.designing}"/>
                                                <webuijsf:label
                                                    binding="#{Persona1.labelCodigoSime1}"
                                                    id="labelCodigoSime1"
                                                    for="campoCodigoSime1"/>
                                                <webuijsf:textField id="campoCodigoSime1"
                                                    binding="#{Persona1.campoCodigoSime1}"
                                                    columns="20"
                                                    maxLength="50"
                                                    readOnly="true"
                                                    text="#{currentRow.value['codigo_sime']}"
                                                    toolTip="BundleParametros.codigo_sime.persona"
                                                    validatorExpression="#{Persona1.validatorCodigoSime1.validate}"/>
                                                <webuijsf:staticText id="campoCodigoSime1Texto1"
                                                    binding="#{Persona1.campoCodigoSime1Texto1}"
                                                    text="#{currentRow.value['codigo_sime']}"/>
                                                <webuijsf:message id="messageCodigoSime1"
                                                    for="campoCodigoSime1"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn
                                                    binding="#{Persona1.tableColumnCodigoSimeRecoPen1}"
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{Persona1.gestor.designing}"/>
                                                <webuijsf:label
                                                    binding="#{Persona1.labelCodigoSimeRecoPen1}"
                                                    id="labelCodigoSimeRecoPen1"
                                                    for="campoCodigoSimeRecoPen1"/>
                                                <webuijsf:textField id="campoCodigoSimeRecoPen1"
                                                    binding="#{Persona1.campoCodigoSimeRecoPen1}"
                                                    columns="20"
                                                    maxLength="50"
                                                    readOnly="true"
                                                    text="#{currentRow.value['codigo_sime_reco_pen']}"
                                                    toolTip="BundleParametros.codigo_sime_reco_pen.persona"
                                                    validatorExpression="#{Persona1.validatorCodigoSimeRecoPen1.validate}"/>
                                                <webuijsf:staticText id="campoCodigoSimeRecoPen1Texto1"
                                                    binding="#{Persona1.campoCodigoSimeRecoPen1Texto1}"
                                                    text="#{currentRow.value['codigo_sime_reco_pen']}"/>
                                                <webuijsf:message id="messageCodigoSimeRecoPen1"
                                                    for="campoCodigoSimeRecoPen1"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn
                                                    binding="#{Persona1.tableColumnComentariosEntregaDocumentos1}"
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{Persona1.gestor.designing}"/>
                                                <webuijsf:label
                                                    binding="#{Persona1.labelComentariosEntregaDocumentos1}"
                                                ...
                                                <webuijsf:textArea id="campoComentariosEntregaDocumentos1"
                                                    binding="#{Persona1.campoComentariosEntregaDocumentos1}"
                                                    columns="50" rows="3"
                                                    readOnly="true"
                                                    text="#{currentRow.value['comentarios_entrega_documentos']}"
                                                    toolTip="BundleParametros.comentarios_entrega_documentos.persona"
                                                    validatorExpression="#{Persona1.validatorComentariosEntregaDocumentos1.validate}"/>
                                                <webuijsf:staticText id="campoComentariosEntregaDocumentos1Texto1"
                                                    binding="#{Persona1.campoComentariosEntregaDocumentos1Texto1}"
                                                    text="#{currentRow.value['comentarios_entrega_documentos']}"/>
                                                <webuijsf:message id="messageComentariosEntregaDocumentos1"
                                                    for="campoComentariosEntregaDocumentos1"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn
                                                    binding="#{Persona1.tableColumnComentariosInsercionJupe1}"
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{Persona1.gestor.designing}"/>
                                                <webuijsf:label
                                                    binding="#{Persona1.labelComentariosInsercionJupe1}"
                                                    id="labelComentariosInsercionJupe1"
                                                    for="campoComentariosInsercionJupe1"/>
                                                <webuijsf:textArea id="campoComentariosInsercionJupe1"
                                                    binding="#{Persona1.campoComentariosInsercionJupe1}"
                                                    columns="50" rows="3"
                                                    readOnly="true"
                                                    text="#{currentRow.value['comentarios_insercion_jupe']}"
                                                    toolTip="BundleParametros.comentarios_insercion_jupe.persona"
                                                    validatorExpression="#{Persona1.validatorComentariosInsercionJupe1.validate}"/>
                                                <webuijsf:staticText id="campoComentariosInsercionJupe1Texto1"
                                                    binding="#{Persona1.campoComentariosInsercionJupe1Texto1}"
                                                    text="#{currentRow.value['comentarios_insercion_jupe']}"/>
