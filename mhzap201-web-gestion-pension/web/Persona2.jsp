                                ...
                                <div class="pos-div-detalle">
                                    <h:panelGrid 
                                        ...
                                        <h:panelGrid
                                            ...
                                            <h:panelGrid
                                                id="gridNumeroTipoArea1" rendered="#{Persona2.gestor.designing}"
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                            ...
                                            <h:panelGrid
                                                columns="7"
                                                id="gridNumeroTipoArea2" rendered="#{Persona2.gestor.designing}"
                                                styleClass="pdq-grid-elemento-1">
                                            ...
                                            <h:panelGrid
                                                columns="7"
                                                id="gridComentariosEntregaDocumentos2" rendered="#{Persona2.gestor.designing}"
                                                styleClass="pdq-grid-elemento-1">
                                                <webuijsf:textArea id="campoComentariosEntregaDocumentos1"
                                                    binding="#{Persona2.campoComentariosEntregaDocumentos1}"
                                                    columns="100" rows="3"
                                                    readOnly="true"
                                                    text="#{Persona2.personaDataProvider.value['comentarios_entrega_documentos']}"
                                                    toolTip="BundleParametros.comentarios_entrega_documentos.persona"
                                                    validatorExpression="#{Persona2.validatorComentariosEntregaDocumentos1.validate}"/>
                                                <webuijsf:staticText id="campoComentariosEntregaDocumentos1Texto1"
                                                    binding="#{Persona2.campoComentariosEntregaDocumentos1Texto1}"
                                                    text="#{Persona2.personaDataProvider.value['comentarios_entrega_documentos']}"/>
                                                <webuijsf:message id="messageComentariosEntregaDocumentos1"
                                                    for="campoComentariosEntregaDocumentos1"/>
                                                <webuijsf:helpInline id="helpInlineComentariosEntregaDocumentos1"
                                                    binding="#{Persona2.helpInlineComentariosEntregaDocumentos1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                        ...
                                        <h:panelGrid
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:textArea id="campoComentariosEntregaDocumentos1x1"
                                                    binding="#{Persona2.campoComentariosEntregaDocumentos1x1}"
                                                    columns="100" rows="3"
                                                    readOnly="true"
                                                    text="#{Persona2.personaDataProvider.value['comentarios_entrega_documentos']}"
                                                    toolTip="BundleParametros.comentarios_entrega_documentos.persona"
                                                ...
                                                <webuijsf:staticText id="campoComentariosEntregaDocumentos1x1Texto1"
                                                    binding="#{Persona2.campoComentariosEntregaDocumentos1x1Texto1}"
                                                    text="#{Persona2.personaDataProvider.value['comentarios_entrega_documentos']}"/>
                                                ...
                                                <webuijsf:helpInline id="helpInlineComentariosEntregaDocumentos1x1"
                                                    binding="#{Persona2.helpInlineComentariosEntregaDocumentos1x1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                                    text="BundleParametros.comentarios_entrega_documentos.persona"
                                                    type="field"/>
