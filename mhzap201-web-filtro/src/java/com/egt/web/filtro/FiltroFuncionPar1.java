 ...
 */
public class FiltroFuncionPar1 extends AbstractPageBean
        implements FiltroFuncionParPageBean, PaginaConsultaConFiltro, PaginaConsultaConTabla, PaginaConsultaConMaestro {
    ...
    private TextField textoSignificado1 = new com.egt.core.jsf.component.CampoTexto();

    public TextField getTextoSignificado1() {
        return textoSignificado1;
    }

    public void setTextoSignificado1(TextField tf) {
        this.textoSignificado1 = tf;
    }
    ...
    private ImageHyperlink textoCodigoObjeto1Hiper1 = new com.egt.core.jsf.component.HipervinculoVerDetalle();

    public ImageHyperlink getTextoCodigoObjeto1Hiper1() {
        return textoCodigoObjeto1Hiper1;
    }

    public void setTextoCodigoObjeto1Hiper1(ImageHyperlink ih) {
        this.textoCodigoObjeto1Hiper1 = ih;
    }
    ...
    private TextField textoValor2 = new com.egt.core.jsf.component.CampoTexto();

    public TextField getTextoValor2() {
        return textoValor2;
    }

    public void setTextoValor2(TextField tf) {
        this.textoValor2 = tf;
    }
...
/**/
    ...
    // </editor-fold>
/**/
    private final static String ETIQUETA_MIGAS_PAN = "Criterios";
...
//          textoCodigoObjeto1Hiper1 = new HipervinculoVerDetalle();
//          /**/
...
//      }
    ...
    public void consultar(Long filtro) {
        try {
            this.getFiltroFuncionParDataProvider().consultarFiltroFuncionPar(filtro);
        } catch (Exception ex) {
...
/**/
    ...
    public Integer getIdRecursoValorConfiguracionFija() {
        ...
        return this.getFiltroFuncionParDataProvider().getIdRecursoValorConfiguracionFija(rowKey);
    }

    public void setIdRecursoValorConfiguracionFija(Integer valor) {
        RowKey rowKey = this.getGestor().getCurrentRowKey();
        this.getFiltroFuncionParDataProvider().setIdRecursoValorConfiguracionFija(rowKey, valor);
    }
    ...
    public void textoValor2_validate(FacesContext context, UIComponent component, Object value) {
        sidekick.validateValorParametro(context, component, value);
    }
