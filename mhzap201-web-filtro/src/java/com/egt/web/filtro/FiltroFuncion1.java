 ...
 */
public class FiltroFuncion1 extends AbstractPageBean
...
/**/
    ...
    // </editor-fold>
/**/
    private final static String ETIQUETA_MIGAS_PAN = "Filtros";
    ...
    public void consultar() {
        ...
        filtro.addCriterio(FiltroFuncionCachedRowSetDataProvider2.COLUMNA_PROPIETARIO_RECURSO, usuario);
        this.consultar(filtro);
    }

    public void consultar(Long filtro) {
        try {
            this.getFiltroFuncionDataProvider().consultarFiltroFuncion(filtro);
        } catch (Exception ex) {
