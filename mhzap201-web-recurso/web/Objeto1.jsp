                                    ...
                                    <h:panelGrid binding="#{Objeto1.gridPanel1}" id="gridPanel1">
                                        ...
                                        <webuijsf:table binding="#{Objeto1.table1}" clearSortButton="true" deselectMultipleButton="true" id="table1"
                                            ...
                                            <webuijsf:tableRowGroup binding="#{Objeto1.tableRowGroup1}" id="tableRowGroup1" rows="1"
                                                ...
                                                <webuijsf:tableColumn binding="#{Objeto1.tableColumn8}" headerText="codigo coleccion" id="tableColumn8" sort="codigo_coleccion">
                                                    <webuijsf:staticText binding="#{Objeto1.staticText6}" id="staticText6" text="#{currentRow.value['codigo_coleccion']}"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn binding="#{Objeto1.tableColumn9}" headerText="nombre coleccion" id="tableColumn9" sort="nombre_coleccion">
                                                    <webuijsf:staticText binding="#{Objeto1.staticText7}" id="staticText7" text="#{currentRow.value['nombre_coleccion']}"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn binding="#{Objeto1.tableColumn10}" headerText="codigo banco" id="tableColumn10" sort="codigo_banco">
                                                    <webuijsf:staticText binding="#{Objeto1.staticText8}" id="staticText8" text="#{currentRow.value['codigo_banco']}"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn binding="#{Objeto1.tableColumn11}" headerText="nombre banco" id="tableColumn11" sort="nombre_banco">
                                                    <webuijsf:staticText binding="#{Objeto1.staticText9}" id="staticText9" text="#{currentRow.value['nombre_banco']}"/>
                                                </webuijsf:tableColumn>
