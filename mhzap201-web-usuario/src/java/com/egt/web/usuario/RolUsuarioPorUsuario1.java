...
public class RolUsuarioPorUsuario1 extends AbstractPageBean
        implements PaginaActualizacionRolUsuarioPorUsuario, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla, PaginaConsultaConMaestro {

    // <editor-fold defaultstate="collapsed" desc="Managed Component Definition">
    private void _init() throws Exception {
        textoFilasPorPagina1Validator1.setMinimum(1L);
        textoFilasPorPagina1Validator1.setMaximum(50L);
        validatorIdRolUsuario1.setMinimum(0L);
        validatorIdRolUsuario1.setMaximum(1000000000000000000L);
        rolUsuarioDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.rolUsuarioRowSet}"));
    ...
    private TableColumn tableColumnIdRolUsuario1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdRolUsuario1() {
        return tableColumnIdRolUsuario1;
    }

    public void setTableColumnIdRolUsuario1(TableColumn component) {
        this.tableColumnIdRolUsuario1 = component;
    }

    private Label labelIdRolUsuario1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelIdRolUsuario1() {
        return labelIdRolUsuario1;
    }

    public void setLabelIdRolUsuario1(Label l) {
        this.labelIdRolUsuario1 = l;
    }

    private TextField campoIdRolUsuario1 = new com.egt.core.jsf.component.CampoTexto();

    @Override
    public TextField getCampoIdRolUsuario1() {
        return campoIdRolUsuario1;
    }

    public void setCampoIdRolUsuario1(TextField component) {
        this.campoIdRolUsuario1 = component;
    }

    private StaticText campoIdRolUsuario1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoIdRolUsuario1Texto1() {
        return campoIdRolUsuario1Texto1;
    }

    public void setCampoIdRolUsuario1Texto1(StaticText component) {
        this.campoIdRolUsuario1Texto1 = component;
    }

    private LongConverter converterIdRolUsuario1 = new LongConverter();
  
    public LongConverter getConverterIdRolUsuario1() {
        return converterIdRolUsuario1;
    }
  
    public void setConverterIdRolUsuario1(LongConverter converter) {
        this.converterIdRolUsuario1 = converter;
    }
  
    private LongRangeValidator validatorIdRolUsuario1 = new LongRangeValidator();
  
    public LongRangeValidator getValidatorIdRolUsuario1() {
        return validatorIdRolUsuario1;
    }
  
    public void setValidatorIdRolUsuario1(LongRangeValidator validator) {
        this.validatorIdRolUsuario1 = validator;
    }
    ...
    private RolUsuarioCachedRowSetDataProvider2 rolUsuarioDataProvider = new RolUsuarioCachedRowSetDataProvider2();

    @Override
    public RolUsuarioCachedRowSetDataProvider2 getRolUsuarioDataProvider() {
        return rolUsuarioDataProvider;
    }

    public void setRolUsuarioDataProvider(RolUsuarioCachedRowSetDataProvider2 crsdp) {
        this.rolUsuarioDataProvider = crsdp;
    }
...
/**/
    ...
    // <editor-fold defaultstate="collapsed" desc="implementacion estandar de propiedades tipo fecha de la interfaz PaginaActualizacionRolUsuario...">
    // </editor-fold>
    ...
    private AsistentePaginaActualizacionRolUsuarioPorUsuario asistente = new AsistentePaginaActualizacionRolUsuarioPorUsuario(this);

    public AsistentePaginaActualizacionRolUsuarioPorUsuario getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("RolUsuarioPorUsuario1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("RolUsuarioPorUsuario1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("RolUsuarioPorUsuario1_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getRolUsuarioDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return RolUsuarioCachedRowSetDataProvider2.FUNCION_CONSULTAR_ROL_USUARIO;
    }

    @Override
    public long getFuncionCrearRecurso() {
        return RolUsuarioCachedRowSetDataProvider2.FUNCION_CREAR_ROL_USUARIO;
    }

    @Override
    public long getFuncionModificarRecurso() {
        return RolUsuarioCachedRowSetDataProvider2.FUNCION_MODIFICAR_ROL_USUARIO;
    }

    @Override
    public long getFuncionEliminarRecurso() {
        return RolUsuarioCachedRowSetDataProvider2.FUNCION_ELIMINAR_ROL_USUARIO;
    }
    ...
    public String getColumnaIdentificacionRecursoMaestro() {
        return RolUsuarioCachedRowSetDataProvider2.COLUMNA_ID_USUARIO;
    }
...
//      String urx = URX2.DETALLE_ROL_USUARIO;
//      return this.getGestor().getScriptAbrirVentanaVerDetalle(urx);
    ...
    public void consultar(Long filtro) {
        try {
            this.getRolUsuarioDataProvider().consultarRolUsuario(filtro);
        } catch (Exception ex) {
