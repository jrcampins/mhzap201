...
echo -->%SQLDDLDIR%\%PGDATABASE%_PG_200.sql
echo -->%SQLDDLDIR%\%PGDATABASE%_PG_200_METADATA.sql
echo -->%SQLDDLDIR%\%PGDATABASE%_PG_200_USERDATA.sql
...
echo.>>%LOG%
echo.
type %DIRBAT2%\delete-metadata.sql>%SQLDDLDIR%\%PGDATABASE%_PG_200_METADATA.sql
