@echo off
cd /d "%~dp0"
if not defined sourcedir goto ERR0
...
goto DONE
:ERR0
set ERRMSG=variable de entorno sourcedir no definida (sourcedir corresponde a la ruta de su directorio de trabajo de CVS)
goto TELL
:ERR1
