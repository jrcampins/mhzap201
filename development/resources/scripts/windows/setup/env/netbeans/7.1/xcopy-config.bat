@echo off
cd /d "%~dp0"
if not defined project_source_dir goto ERR0
...
goto DONE
:ERR0
set ERRMSG=variable de entorno project_source_dir no definida (project_source_dir corresponde a la ruta de su directorio de trabajo de CVS)
goto TELL
:ERR1
