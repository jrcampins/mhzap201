...
if not defined MHZAP201_SOURCE goto ERR1
if not exist %MHZAP201_SOURCE% goto ERR2

set P1=%MHZAP201_SOURCE%\mhzap201-web-template
set X1=%P1%
...
for /D %%f in (%MHZAP201_SOURCE%\mhzap201-web*)            do call XCOPY-X-2   %P1% %P2% index.html     %%f
for /D %%f in (%MHZAP201_SOURCE%\mhzap201-web*)            do call XCOPY-X-2   %P1% %P2% error.jsp      %%f
for /D %%f in (%MHZAP201_SOURCE%\mhzap201-web*)            do call XCOPY-X-2   %P1% %P2% login.jsp      %%f
...
for /D %%f in (%MHZAP201_SOURCE%\mhzap201-web*)            do call XCOPY-X-2   %P1% %P2% javascript1.js %%f
...
for /D %%f in (%MHZAP201_SOURCE%\mhzap201-web*)              do call XCOPY-X-2   %P1% %P2% %P3% %%f
...
:ERR2
set ERRMSG=directorio %MHZAP201_SOURCE% no existe
goto TELL
