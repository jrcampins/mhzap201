...
public class FiltroClaRecVinCachedRowSetDataProvider extends RecursoCachedRowSetDataProvider
        implements RecursoVersionableDataProvider {

    public FiltroClaRecVinCachedRowSetDataProvider() {
        super();
    }

    public FiltroClaRecVinCachedRowSetDataProvider(CachedRowSet cachedRowSet) {
        super(cachedRowSet);
    }

    public static final String CODIGO_DOMINIO_RECURSO = "filtro_cla_rec_vin";
    public static final String NOMBRE_DOMINIO_RECURSO = "Filtros por Vinculo";
    ...
    private static final String COMANDO_SELECT = "SELECT * FROM consulta_filtro_cla_rec_vin_1 ";
    private static final String COMANDO_SELECT_NOTHING = COMANDO_SELECT + "WHERE (0=1)";
    private static final String TABLA_DESTINO = "filtro_cla_rec_vin";
    ...
    public static final String COLUMNA_ID_FILTRO_CLA_REC_VIN = "id_filtro_cla_rec_vin";
    public static final String COLUMNA_VERSION_FILTRO_CLA_REC_VIN = "version_filtro_cla_rec_vin";
    ...
    protected void setMapaTiposJava() {
        this.getRecursoCachedRowSet().getColumnTypes().put(COLUMNA_ID_FILTRO_CLA_REC_VIN, Long.class);
        this.getRecursoCachedRowSet().getColumnTypes().put(COLUMNA_VERSION_FILTRO_CLA_REC_VIN, Long.class);
    ...
    protected void setColumnasInsertables() {
        ...
        this.setColumnasInsertables(COLUMNA_ID_FILTRO_CLA_REC_VIN, true);
        this.setColumnasInsertables(COLUMNA_VERSION_FILTRO_CLA_REC_VIN, true);
    ...
    protected void setColumnasModificables() {
        ...
        this.setColumnasModificables(COLUMNA_ID_FILTRO_CLA_REC_VIN, true);
        this.setColumnasModificables(COLUMNA_VERSION_FILTRO_CLA_REC_VIN, true);
    ...
    public Long getIdFiltroClaRecVin() {
        return (Long) super.getValue(COLUMNA_ID_FILTRO_CLA_REC_VIN);
    }
    public Long getIdFiltroClaRecVin(RowKey rowKey) {
        return (Long) super.getValue(COLUMNA_ID_FILTRO_CLA_REC_VIN, rowKey);
    }
    public void setIdFiltroClaRecVin(Long valor) {
        super.setValue(COLUMNA_ID_FILTRO_CLA_REC_VIN, valor);
    }
    public void setIdFiltroClaRecVin(RowKey rowKey, Long valor) {
        super.setValue(COLUMNA_ID_FILTRO_CLA_REC_VIN, rowKey, valor);
    }

    public Long getVersionFiltroClaRecVin() {
        return (Long) super.getValue(COLUMNA_VERSION_FILTRO_CLA_REC_VIN);
    }
    public Long getVersionFiltroClaRecVin(RowKey rowKey) {
        return (Long) super.getValue(COLUMNA_VERSION_FILTRO_CLA_REC_VIN, rowKey);
    }
    public void setVersionFiltroClaRecVin(Long valor) {
        super.setValue(COLUMNA_VERSION_FILTRO_CLA_REC_VIN, valor);
    }
    public void setVersionFiltroClaRecVin(RowKey rowKey, Long valor) {
        super.setValue(COLUMNA_VERSION_FILTRO_CLA_REC_VIN, rowKey, valor);
    }
    ...
    public static final String COLUMNA_IDENTIFICACION_RECURSO = "id_filtro_cla_rec_vin";
    public static final String COLUMNA_VERSION_RECURSO = "version_filtro_cla_rec_vin";
    ...
    public Long getIdentificacionRecurso() {
        return this.getIdFiltroClaRecVin();
    }
    @Override
    public Long getIdentificacionRecurso(RowKey rowKey) {
        return this.getIdFiltroClaRecVin(rowKey);
    }
    @Override
    public void setIdentificacionRecurso(Long identificacionRecurso) {
        this.setIdFiltroClaRecVin(identificacionRecurso);
    }
    @Override
    public void setIdentificacionRecurso(RowKey rowKey, Long identificacionRecurso) {
        this.setIdFiltroClaRecVin(rowKey, identificacionRecurso);
    }

    @Override
    public Long getVersionRecurso() {
        return this.getVersionFiltroClaRecVin();
    }
    @Override
    public Long getVersionRecurso(RowKey rowKey) {
        return this.getVersionFiltroClaRecVin(rowKey);
    }
    @Override
    public void setVersionRecurso(Long versionRecurso) {
        this.setVersionFiltroClaRecVin(versionRecurso);
    }
    @Override
    public void setVersionRecurso(RowKey rowKey, Long versionRecurso) {
        this.setVersionFiltroClaRecVin(rowKey, versionRecurso);
    }
}
