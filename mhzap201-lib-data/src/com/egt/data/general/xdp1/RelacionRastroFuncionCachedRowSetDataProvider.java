...
public class RelacionRastroFuncionCachedRowSetDataProvider extends RecursoCachedRowSetDataProvider
        implements RecursoIdentificableDataProvider, RecursoPersonalizableDataProvider {

    public RelacionRastroFuncionCachedRowSetDataProvider() {
        super();
    }

    public RelacionRastroFuncionCachedRowSetDataProvider(CachedRowSet cachedRowSet) {
        super(cachedRowSet);
    }

    public static final String CODIGO_DOMINIO_RECURSO = "relacion_rastro_funcion";
    public static final String NOMBRE_DOMINIO_RECURSO = "Ejecucion de Funciones";
    ...
    private static final String COMANDO_SELECT = "SELECT * FROM relacion_rastro_funcion ";
