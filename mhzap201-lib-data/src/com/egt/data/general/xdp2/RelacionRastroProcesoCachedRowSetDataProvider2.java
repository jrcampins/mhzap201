...
import com.egt.data.general.xdp1.RelacionRastroProcesoCachedRowSetDataProvider;
...
public class RelacionRastroProcesoCachedRowSetDataProvider2 extends RelacionRastroProcesoCachedRowSetDataProvider
        implements RecursoConsultableDataProvider {

    public RelacionRastroProcesoCachedRowSetDataProvider2() {
        super();
    }

    public RelacionRastroProcesoCachedRowSetDataProvider2(CachedRowSet cachedRowSet) {
        super(cachedRowSet);
    ...
    public static final long FUNCION_CONSULTAR_RECURSO = 107405001L;

    public static final long FUNCION_CONSULTAR_RELACION_RASTRO_PROCESO = 107405001L;
    ...
    public void ejecutarFuncionSelect(long funcion, FiltroBusqueda filtro) throws ExcepcionAplicacion {
        if (funcion == FUNCION_CONSULTAR_RELACION_RASTRO_PROCESO) {
            this.consultarRelacionRastroProceso(filtro);
            return;
        }
    }

    public void consultarRelacionRastroProceso() throws ExcepcionAplicacion {
        this.consultarRelacionRastroProceso(new FiltroBusqueda());
    }

    public void consultarRelacionRastroProceso(Long filtro) throws ExcepcionAplicacion {
        if (filtro == null) {
            this.consultarRelacionRastroProceso(new FiltroBusqueda());
        } else {
            this.consultarRelacionRastroProceso(new FiltroBusqueda(filtro));
        }
    }

    public void consultarRelacionRastroProceso(FiltroBusqueda filtro) throws ExcepcionAplicacion {
        String comando = this.getComandoSelect();
        String clausula = "WHERE";
        String criterios = null;
        try {
            this.setFuncionSelect(FUNCION_CONSULTAR_RELACION_RASTRO_PROCESO);
            if (filtro == null) {
