...
public class LogProVerElePenCachedRowSetDataProvider extends RecursoCachedRowSetDataProvider
        implements RecursoVersionableDataProvider {

    public LogProVerElePenCachedRowSetDataProvider() {
        super();
    }

    public LogProVerElePenCachedRowSetDataProvider(CachedRowSet cachedRowSet) {
        super(cachedRowSet);
    }

    public static final String CODIGO_DOMINIO_RECURSO = "log_pro_ver_ele_pen";
    public static final String NOMBRE_DOMINIO_RECURSO = "Rastros de Verificacion de Elegibles";
    ...
    private static final String COMANDO_SELECT = "SELECT * FROM consulta_log_pro_ver_ele_pen_1 ";
    private static final String COMANDO_SELECT_NOTHING = COMANDO_SELECT + "WHERE (0=1)";
    private static final String TABLA_DESTINO = "log_pro_ver_ele_pen";
    ...
    public static final String COLUMNA_ID_LOG_PRO_VER_ELE_PEN = "id_log_pro_ver_ele_pen";
    public static final String COLUMNA_VERSION_LOG_PRO_VER_ELE_PEN = "version_log_pro_ver_ele_pen";
    ...
    protected void setMapaTiposJava() {
        this.getRecursoCachedRowSet().getColumnTypes().put(COLUMNA_ID_LOG_PRO_VER_ELE_PEN, Long.class);
        this.getRecursoCachedRowSet().getColumnTypes().put(COLUMNA_VERSION_LOG_PRO_VER_ELE_PEN, Long.class);
    ...
    protected void setColumnasInsertables() {
        ...
        this.setColumnasInsertables(COLUMNA_ID_LOG_PRO_VER_ELE_PEN, true);
        this.setColumnasInsertables(COLUMNA_VERSION_LOG_PRO_VER_ELE_PEN, true);
    ...
    protected void setColumnasModificables() {
        ...
        this.setColumnasModificables(COLUMNA_ID_LOG_PRO_VER_ELE_PEN, true);
        this.setColumnasModificables(COLUMNA_VERSION_LOG_PRO_VER_ELE_PEN, true);
    ...
    public Long getIdLogProVerElePen() {
        return (Long) super.getValue(COLUMNA_ID_LOG_PRO_VER_ELE_PEN);
    }
    public Long getIdLogProVerElePen(RowKey rowKey) {
        return (Long) super.getValue(COLUMNA_ID_LOG_PRO_VER_ELE_PEN, rowKey);
    }
    public void setIdLogProVerElePen(Long valor) {
        super.setValue(COLUMNA_ID_LOG_PRO_VER_ELE_PEN, valor);
    }
    public void setIdLogProVerElePen(RowKey rowKey, Long valor) {
        super.setValue(COLUMNA_ID_LOG_PRO_VER_ELE_PEN, rowKey, valor);
    }

    public Long getVersionLogProVerElePen() {
        return (Long) super.getValue(COLUMNA_VERSION_LOG_PRO_VER_ELE_PEN);
    }
    public Long getVersionLogProVerElePen(RowKey rowKey) {
        return (Long) super.getValue(COLUMNA_VERSION_LOG_PRO_VER_ELE_PEN, rowKey);
    }
    public void setVersionLogProVerElePen(Long valor) {
        super.setValue(COLUMNA_VERSION_LOG_PRO_VER_ELE_PEN, valor);
    }
    public void setVersionLogProVerElePen(RowKey rowKey, Long valor) {
        super.setValue(COLUMNA_VERSION_LOG_PRO_VER_ELE_PEN, rowKey, valor);
    }
    ...
    public static final String COLUMNA_IDENTIFICACION_RECURSO = "id_log_pro_ver_ele_pen";
    public static final String COLUMNA_VERSION_RECURSO = "version_log_pro_ver_ele_pen";
    ...
    public Long getIdentificacionRecurso() {
        return this.getIdLogProVerElePen();
    }
    @Override
    public Long getIdentificacionRecurso(RowKey rowKey) {
        return this.getIdLogProVerElePen(rowKey);
    }
    @Override
    public void setIdentificacionRecurso(Long identificacionRecurso) {
        this.setIdLogProVerElePen(identificacionRecurso);
    }
    @Override
    public void setIdentificacionRecurso(RowKey rowKey, Long identificacionRecurso) {
        this.setIdLogProVerElePen(rowKey, identificacionRecurso);
    }

    @Override
    public Long getVersionRecurso() {
        return this.getVersionLogProVerElePen();
    }
    @Override
    public Long getVersionRecurso(RowKey rowKey) {
        return this.getVersionLogProVerElePen(rowKey);
    }
    @Override
    public void setVersionRecurso(Long versionRecurso) {
        this.setVersionLogProVerElePen(versionRecurso);
    }
    @Override
    public void setVersionRecurso(RowKey rowKey, Long versionRecurso) {
        this.setVersionLogProVerElePen(rowKey, versionRecurso);
    }
}
