...
public class LogImpFalCachedRowSetDataProvider extends RecursoCachedRowSetDataProvider
        implements RecursoVersionableDataProvider {

    public LogImpFalCachedRowSetDataProvider() {
        super();
    }

    public LogImpFalCachedRowSetDataProvider(CachedRowSet cachedRowSet) {
        super(cachedRowSet);
    }

    public static final String CODIGO_DOMINIO_RECURSO = "log_imp_fal";
    public static final String NOMBRE_DOMINIO_RECURSO = "Rastros de Importacion de Fallecidos";
    ...
    private static final String COMANDO_SELECT = "SELECT * FROM consulta_log_imp_fal_1 ";
    private static final String COMANDO_SELECT_NOTHING = COMANDO_SELECT + "WHERE (0=1)";
    private static final String TABLA_DESTINO = "log_imp_fal";
    ...
    public static final String COLUMNA_ID_LOG_IMP_FAL = "id_log_imp_fal";
    public static final String COLUMNA_VERSION_LOG_IMP_FAL = "version_log_imp_fal";
    ...
    public static final String COLUMNA_DEFUNCION = "defuncion";
    ...
    protected void setMapaTiposJava() {
        this.getRecursoCachedRowSet().getColumnTypes().put(COLUMNA_ID_LOG_IMP_FAL, Long.class);
        this.getRecursoCachedRowSet().getColumnTypes().put(COLUMNA_VERSION_LOG_IMP_FAL, Long.class);
        ...
        this.getRecursoCachedRowSet().getColumnTypes().put(COLUMNA_DEFUNCION, String.class);
    ...
    protected void setColumnasInsertables() {
        ...
        this.setColumnasInsertables(COLUMNA_ID_LOG_IMP_FAL, true);
        this.setColumnasInsertables(COLUMNA_VERSION_LOG_IMP_FAL, true);
        ...
        this.setColumnasInsertables(COLUMNA_DEFUNCION, true);
    ...
    protected void setColumnasModificables() {
        ...
        this.setColumnasModificables(COLUMNA_ID_LOG_IMP_FAL, true);
        this.setColumnasModificables(COLUMNA_VERSION_LOG_IMP_FAL, true);
        ...
        this.setColumnasModificables(COLUMNA_DEFUNCION, true);
    ...
    public Long getIdLogImpFal() {
        return (Long) super.getValue(COLUMNA_ID_LOG_IMP_FAL);
    }
    public Long getIdLogImpFal(RowKey rowKey) {
        return (Long) super.getValue(COLUMNA_ID_LOG_IMP_FAL, rowKey);
    }
    public void setIdLogImpFal(Long valor) {
        super.setValue(COLUMNA_ID_LOG_IMP_FAL, valor);
    }
    public void setIdLogImpFal(RowKey rowKey, Long valor) {
        super.setValue(COLUMNA_ID_LOG_IMP_FAL, rowKey, valor);
    }

    public Long getVersionLogImpFal() {
        return (Long) super.getValue(COLUMNA_VERSION_LOG_IMP_FAL);
    }
    public Long getVersionLogImpFal(RowKey rowKey) {
        return (Long) super.getValue(COLUMNA_VERSION_LOG_IMP_FAL, rowKey);
    }
    public void setVersionLogImpFal(Long valor) {
        super.setValue(COLUMNA_VERSION_LOG_IMP_FAL, valor);
    }
    public void setVersionLogImpFal(RowKey rowKey, Long valor) {
        super.setValue(COLUMNA_VERSION_LOG_IMP_FAL, rowKey, valor);
    }
    ...
    public String getDefuncion() {
        return (String) super.getValue(COLUMNA_DEFUNCION);
    }
    public String getDefuncion(RowKey rowKey) {
        return (String) super.getValue(COLUMNA_DEFUNCION, rowKey);
    }
    public void setDefuncion(String valor) {
        super.setValue(COLUMNA_DEFUNCION, valor);
    }
    public void setDefuncion(RowKey rowKey, String valor) {
        super.setValue(COLUMNA_DEFUNCION, rowKey, valor);
    }
    ...
    public static final String COLUMNA_IDENTIFICACION_RECURSO = "id_log_imp_fal";
    public static final String COLUMNA_VERSION_RECURSO = "version_log_imp_fal";
    ...
    public Long getIdentificacionRecurso() {
        return this.getIdLogImpFal();
    }
    @Override
    public Long getIdentificacionRecurso(RowKey rowKey) {
        return this.getIdLogImpFal(rowKey);
    }
    @Override
    public void setIdentificacionRecurso(Long identificacionRecurso) {
        this.setIdLogImpFal(identificacionRecurso);
    }
    @Override
    public void setIdentificacionRecurso(RowKey rowKey, Long identificacionRecurso) {
        this.setIdLogImpFal(rowKey, identificacionRecurso);
    }

    @Override
    public Long getVersionRecurso() {
        return this.getVersionLogImpFal();
    }
    @Override
    public Long getVersionRecurso(RowKey rowKey) {
        return this.getVersionLogImpFal(rowKey);
    }
    @Override
    public void setVersionRecurso(Long versionRecurso) {
        this.setVersionLogImpFal(versionRecurso);
    }
    @Override
    public void setVersionRecurso(RowKey rowKey, Long versionRecurso) {
        this.setVersionLogImpFal(rowKey, versionRecurso);
    }
}
