...
public class LogImpEmpCachedRowSetDataProvider extends RecursoCachedRowSetDataProvider
        implements RecursoVersionableDataProvider {

    public LogImpEmpCachedRowSetDataProvider() {
        super();
    }

    public LogImpEmpCachedRowSetDataProvider(CachedRowSet cachedRowSet) {
        super(cachedRowSet);
    }

    public static final String CODIGO_DOMINIO_RECURSO = "log_imp_emp";
    public static final String NOMBRE_DOMINIO_RECURSO = "Rastros de Importacion de Empleados";
    ...
    private static final String COMANDO_SELECT = "SELECT * FROM consulta_log_imp_emp_1 ";
    private static final String COMANDO_SELECT_NOTHING = COMANDO_SELECT + "WHERE (0=1)";
    private static final String TABLA_DESTINO = "log_imp_emp";
    ...
    public static final String COLUMNA_ID_LOG_IMP_EMP = "id_log_imp_emp";
    public static final String COLUMNA_VERSION_LOG_IMP_EMP = "version_log_imp_emp";
    ...
    protected void setMapaTiposJava() {
        this.getRecursoCachedRowSet().getColumnTypes().put(COLUMNA_ID_LOG_IMP_EMP, Long.class);
        this.getRecursoCachedRowSet().getColumnTypes().put(COLUMNA_VERSION_LOG_IMP_EMP, Long.class);
    ...
    protected void setColumnasInsertables() {
        ...
        this.setColumnasInsertables(COLUMNA_ID_LOG_IMP_EMP, true);
        this.setColumnasInsertables(COLUMNA_VERSION_LOG_IMP_EMP, true);
    ...
    protected void setColumnasModificables() {
        ...
        this.setColumnasModificables(COLUMNA_ID_LOG_IMP_EMP, true);
        this.setColumnasModificables(COLUMNA_VERSION_LOG_IMP_EMP, true);
    ...
    public Long getIdLogImpEmp() {
        return (Long) super.getValue(COLUMNA_ID_LOG_IMP_EMP);
    }
    public Long getIdLogImpEmp(RowKey rowKey) {
        return (Long) super.getValue(COLUMNA_ID_LOG_IMP_EMP, rowKey);
    }
    public void setIdLogImpEmp(Long valor) {
        super.setValue(COLUMNA_ID_LOG_IMP_EMP, valor);
    }
    public void setIdLogImpEmp(RowKey rowKey, Long valor) {
        super.setValue(COLUMNA_ID_LOG_IMP_EMP, rowKey, valor);
    }

    public Long getVersionLogImpEmp() {
        return (Long) super.getValue(COLUMNA_VERSION_LOG_IMP_EMP);
    }
    public Long getVersionLogImpEmp(RowKey rowKey) {
        return (Long) super.getValue(COLUMNA_VERSION_LOG_IMP_EMP, rowKey);
    }
    public void setVersionLogImpEmp(Long valor) {
        super.setValue(COLUMNA_VERSION_LOG_IMP_EMP, valor);
    }
    public void setVersionLogImpEmp(RowKey rowKey, Long valor) {
        super.setValue(COLUMNA_VERSION_LOG_IMP_EMP, rowKey, valor);
    }
    ...
    public static final String COLUMNA_IDENTIFICACION_RECURSO = "id_log_imp_emp";
    public static final String COLUMNA_VERSION_RECURSO = "version_log_imp_emp";
    ...
    public Long getIdentificacionRecurso() {
        return this.getIdLogImpEmp();
    }
    @Override
    public Long getIdentificacionRecurso(RowKey rowKey) {
        return this.getIdLogImpEmp(rowKey);
    }
    @Override
    public void setIdentificacionRecurso(Long identificacionRecurso) {
        this.setIdLogImpEmp(identificacionRecurso);
    }
    @Override
    public void setIdentificacionRecurso(RowKey rowKey, Long identificacionRecurso) {
        this.setIdLogImpEmp(rowKey, identificacionRecurso);
    }

    @Override
    public Long getVersionRecurso() {
        return this.getVersionLogImpEmp();
    }
    @Override
    public Long getVersionRecurso(RowKey rowKey) {
        return this.getVersionLogImpEmp(rowKey);
    }
    @Override
    public void setVersionRecurso(Long versionRecurso) {
        this.setVersionLogImpEmp(versionRecurso);
    }
    @Override
    public void setVersionRecurso(RowKey rowKey, Long versionRecurso) {
        this.setVersionLogImpEmp(rowKey, versionRecurso);
    }
}
