...
public class LogImpDeuCachedRowSetDataProvider extends RecursoCachedRowSetDataProvider
        implements RecursoVersionableDataProvider {

    public LogImpDeuCachedRowSetDataProvider() {
        super();
    }

    public LogImpDeuCachedRowSetDataProvider(CachedRowSet cachedRowSet) {
        super(cachedRowSet);
    }

    public static final String CODIGO_DOMINIO_RECURSO = "log_imp_deu";
    public static final String NOMBRE_DOMINIO_RECURSO = "Rastros de Importacion de Deudores";
    ...
    private static final String COMANDO_SELECT = "SELECT * FROM consulta_log_imp_deu_1 ";
    private static final String COMANDO_SELECT_NOTHING = COMANDO_SELECT + "WHERE (0=1)";
    private static final String TABLA_DESTINO = "log_imp_deu";
    ...
    public static final String COLUMNA_ID_LOG_IMP_DEU = "id_log_imp_deu";
    public static final String COLUMNA_VERSION_LOG_IMP_DEU = "version_log_imp_deu";
    ...
    protected void setMapaTiposJava() {
        this.getRecursoCachedRowSet().getColumnTypes().put(COLUMNA_ID_LOG_IMP_DEU, Long.class);
        this.getRecursoCachedRowSet().getColumnTypes().put(COLUMNA_VERSION_LOG_IMP_DEU, Long.class);
    ...
    protected void setColumnasInsertables() {
        ...
        this.setColumnasInsertables(COLUMNA_ID_LOG_IMP_DEU, true);
        this.setColumnasInsertables(COLUMNA_VERSION_LOG_IMP_DEU, true);
    ...
    protected void setColumnasModificables() {
        ...
        this.setColumnasModificables(COLUMNA_ID_LOG_IMP_DEU, true);
        this.setColumnasModificables(COLUMNA_VERSION_LOG_IMP_DEU, true);
    ...
    public Long getIdLogImpDeu() {
        return (Long) super.getValue(COLUMNA_ID_LOG_IMP_DEU);
    }
    public Long getIdLogImpDeu(RowKey rowKey) {
        return (Long) super.getValue(COLUMNA_ID_LOG_IMP_DEU, rowKey);
    }
    public void setIdLogImpDeu(Long valor) {
        super.setValue(COLUMNA_ID_LOG_IMP_DEU, valor);
    }
    public void setIdLogImpDeu(RowKey rowKey, Long valor) {
        super.setValue(COLUMNA_ID_LOG_IMP_DEU, rowKey, valor);
    }

    public Long getVersionLogImpDeu() {
        return (Long) super.getValue(COLUMNA_VERSION_LOG_IMP_DEU);
    }
    public Long getVersionLogImpDeu(RowKey rowKey) {
        return (Long) super.getValue(COLUMNA_VERSION_LOG_IMP_DEU, rowKey);
    }
    public void setVersionLogImpDeu(Long valor) {
        super.setValue(COLUMNA_VERSION_LOG_IMP_DEU, valor);
    }
    public void setVersionLogImpDeu(RowKey rowKey, Long valor) {
        super.setValue(COLUMNA_VERSION_LOG_IMP_DEU, rowKey, valor);
    }
    ...
    public static final String COLUMNA_IDENTIFICACION_RECURSO = "id_log_imp_deu";
    public static final String COLUMNA_VERSION_RECURSO = "version_log_imp_deu";
    ...
    public Long getIdentificacionRecurso() {
        return this.getIdLogImpDeu();
    }
    @Override
    public Long getIdentificacionRecurso(RowKey rowKey) {
        return this.getIdLogImpDeu(rowKey);
    }
    @Override
    public void setIdentificacionRecurso(Long identificacionRecurso) {
        this.setIdLogImpDeu(identificacionRecurso);
    }
    @Override
    public void setIdentificacionRecurso(RowKey rowKey, Long identificacionRecurso) {
        this.setIdLogImpDeu(rowKey, identificacionRecurso);
    }

    @Override
    public Long getVersionRecurso() {
        return this.getVersionLogImpDeu();
    }
    @Override
    public Long getVersionRecurso(RowKey rowKey) {
        return this.getVersionLogImpDeu(rowKey);
    }
    @Override
    public void setVersionRecurso(Long versionRecurso) {
        this.setVersionLogImpDeu(versionRecurso);
    }
    @Override
    public void setVersionRecurso(RowKey rowKey, Long versionRecurso) {
        this.setVersionLogImpDeu(rowKey, versionRecurso);
    }
}
