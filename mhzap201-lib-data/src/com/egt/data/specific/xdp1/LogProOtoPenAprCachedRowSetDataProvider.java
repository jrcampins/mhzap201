...
public class LogProOtoPenAprCachedRowSetDataProvider extends RecursoCachedRowSetDataProvider
        implements RecursoVersionableDataProvider {

    public LogProOtoPenAprCachedRowSetDataProvider() {
        super();
    }

    public LogProOtoPenAprCachedRowSetDataProvider(CachedRowSet cachedRowSet) {
        super(cachedRowSet);
    }

    public static final String CODIGO_DOMINIO_RECURSO = "log_pro_oto_pen_apr";
    public static final String NOMBRE_DOMINIO_RECURSO = "Rastros de Otorgamiento de Pensiones";
    ...
    private static final String COMANDO_SELECT = "SELECT * FROM consulta_log_pro_oto_pen_apr_1 ";
    private static final String COMANDO_SELECT_NOTHING = COMANDO_SELECT + "WHERE (0=1)";
    private static final String TABLA_DESTINO = "log_pro_oto_pen_apr";
    ...
    public static final String COLUMNA_ID_LOG_PRO_OTO_PEN_APR = "id_log_pro_oto_pen_apr";
    public static final String COLUMNA_VERSION_LOG_PRO_OTO_PEN_APR = "version_log_pro_oto_pen_apr";
    ...
    protected void setMapaTiposJava() {
        this.getRecursoCachedRowSet().getColumnTypes().put(COLUMNA_ID_LOG_PRO_OTO_PEN_APR, Long.class);
        this.getRecursoCachedRowSet().getColumnTypes().put(COLUMNA_VERSION_LOG_PRO_OTO_PEN_APR, Long.class);
    ...
    protected void setColumnasInsertables() {
        ...
        this.setColumnasInsertables(COLUMNA_ID_LOG_PRO_OTO_PEN_APR, true);
        this.setColumnasInsertables(COLUMNA_VERSION_LOG_PRO_OTO_PEN_APR, true);
    ...
    protected void setColumnasModificables() {
        ...
        this.setColumnasModificables(COLUMNA_ID_LOG_PRO_OTO_PEN_APR, true);
        this.setColumnasModificables(COLUMNA_VERSION_LOG_PRO_OTO_PEN_APR, true);
    ...
    public Long getIdLogProOtoPenApr() {
        return (Long) super.getValue(COLUMNA_ID_LOG_PRO_OTO_PEN_APR);
    }
    public Long getIdLogProOtoPenApr(RowKey rowKey) {
        return (Long) super.getValue(COLUMNA_ID_LOG_PRO_OTO_PEN_APR, rowKey);
    }
    public void setIdLogProOtoPenApr(Long valor) {
        super.setValue(COLUMNA_ID_LOG_PRO_OTO_PEN_APR, valor);
    }
    public void setIdLogProOtoPenApr(RowKey rowKey, Long valor) {
        super.setValue(COLUMNA_ID_LOG_PRO_OTO_PEN_APR, rowKey, valor);
    }

    public Long getVersionLogProOtoPenApr() {
        return (Long) super.getValue(COLUMNA_VERSION_LOG_PRO_OTO_PEN_APR);
    }
    public Long getVersionLogProOtoPenApr(RowKey rowKey) {
        return (Long) super.getValue(COLUMNA_VERSION_LOG_PRO_OTO_PEN_APR, rowKey);
    }
    public void setVersionLogProOtoPenApr(Long valor) {
        super.setValue(COLUMNA_VERSION_LOG_PRO_OTO_PEN_APR, valor);
    }
    public void setVersionLogProOtoPenApr(RowKey rowKey, Long valor) {
        super.setValue(COLUMNA_VERSION_LOG_PRO_OTO_PEN_APR, rowKey, valor);
    }
    ...
    public static final String COLUMNA_IDENTIFICACION_RECURSO = "id_log_pro_oto_pen_apr";
    public static final String COLUMNA_VERSION_RECURSO = "version_log_pro_oto_pen_apr";
    ...
    public Long getIdentificacionRecurso() {
        return this.getIdLogProOtoPenApr();
    }
    @Override
    public Long getIdentificacionRecurso(RowKey rowKey) {
        return this.getIdLogProOtoPenApr(rowKey);
    }
    @Override
    public void setIdentificacionRecurso(Long identificacionRecurso) {
        this.setIdLogProOtoPenApr(identificacionRecurso);
    }
    @Override
    public void setIdentificacionRecurso(RowKey rowKey, Long identificacionRecurso) {
        this.setIdLogProOtoPenApr(rowKey, identificacionRecurso);
    }

    @Override
    public Long getVersionRecurso() {
        return this.getVersionLogProOtoPenApr();
    }
    @Override
    public Long getVersionRecurso(RowKey rowKey) {
        return this.getVersionLogProOtoPenApr(rowKey);
    }
    @Override
    public void setVersionRecurso(Long versionRecurso) {
        this.setVersionLogProOtoPenApr(versionRecurso);
    }
    @Override
    public void setVersionRecurso(RowKey rowKey, Long versionRecurso) {
        this.setVersionLogProOtoPenApr(rowKey, versionRecurso);
    }
}
