...
public class LogImpSubCachedRowSetDataProvider extends RecursoCachedRowSetDataProvider
        implements RecursoVersionableDataProvider {

    public LogImpSubCachedRowSetDataProvider() {
        super();
    }

    public LogImpSubCachedRowSetDataProvider(CachedRowSet cachedRowSet) {
        super(cachedRowSet);
    }

    public static final String CODIGO_DOMINIO_RECURSO = "log_imp_sub";
    public static final String NOMBRE_DOMINIO_RECURSO = "Rastros de Importacion de Subsidios";
    ...
    private static final String COMANDO_SELECT = "SELECT * FROM consulta_log_imp_sub_1 ";
    private static final String COMANDO_SELECT_NOTHING = COMANDO_SELECT + "WHERE (0=1)";
    private static final String TABLA_DESTINO = "log_imp_sub";
    ...
    public static final String COLUMNA_ID_LOG_IMP_SUB = "id_log_imp_sub";
    public static final String COLUMNA_VERSION_LOG_IMP_SUB = "version_log_imp_sub";
    ...
    protected void setMapaTiposJava() {
        this.getRecursoCachedRowSet().getColumnTypes().put(COLUMNA_ID_LOG_IMP_SUB, Long.class);
        this.getRecursoCachedRowSet().getColumnTypes().put(COLUMNA_VERSION_LOG_IMP_SUB, Long.class);
    ...
    protected void setColumnasInsertables() {
        ...
        this.setColumnasInsertables(COLUMNA_ID_LOG_IMP_SUB, true);
        this.setColumnasInsertables(COLUMNA_VERSION_LOG_IMP_SUB, true);
    ...
    protected void setColumnasModificables() {
        ...
        this.setColumnasModificables(COLUMNA_ID_LOG_IMP_SUB, true);
        this.setColumnasModificables(COLUMNA_VERSION_LOG_IMP_SUB, true);
    ...
    public Long getIdLogImpSub() {
        return (Long) super.getValue(COLUMNA_ID_LOG_IMP_SUB);
    }
    public Long getIdLogImpSub(RowKey rowKey) {
        return (Long) super.getValue(COLUMNA_ID_LOG_IMP_SUB, rowKey);
    }
    public void setIdLogImpSub(Long valor) {
        super.setValue(COLUMNA_ID_LOG_IMP_SUB, valor);
    }
    public void setIdLogImpSub(RowKey rowKey, Long valor) {
        super.setValue(COLUMNA_ID_LOG_IMP_SUB, rowKey, valor);
    }

    public Long getVersionLogImpSub() {
        return (Long) super.getValue(COLUMNA_VERSION_LOG_IMP_SUB);
    }
    public Long getVersionLogImpSub(RowKey rowKey) {
        return (Long) super.getValue(COLUMNA_VERSION_LOG_IMP_SUB, rowKey);
    }
    public void setVersionLogImpSub(Long valor) {
        super.setValue(COLUMNA_VERSION_LOG_IMP_SUB, valor);
    }
    public void setVersionLogImpSub(RowKey rowKey, Long valor) {
        super.setValue(COLUMNA_VERSION_LOG_IMP_SUB, rowKey, valor);
    }
    ...
    public static final String COLUMNA_IDENTIFICACION_RECURSO = "id_log_imp_sub";
    public static final String COLUMNA_VERSION_RECURSO = "version_log_imp_sub";
    ...
    public Long getIdentificacionRecurso() {
        return this.getIdLogImpSub();
    }
    @Override
    public Long getIdentificacionRecurso(RowKey rowKey) {
        return this.getIdLogImpSub(rowKey);
    }
    @Override
    public void setIdentificacionRecurso(Long identificacionRecurso) {
        this.setIdLogImpSub(identificacionRecurso);
    }
    @Override
    public void setIdentificacionRecurso(RowKey rowKey, Long identificacionRecurso) {
        this.setIdLogImpSub(rowKey, identificacionRecurso);
    }

    @Override
    public Long getVersionRecurso() {
        return this.getVersionLogImpSub();
    }
    @Override
    public Long getVersionRecurso(RowKey rowKey) {
        return this.getVersionLogImpSub(rowKey);
    }
    @Override
    public void setVersionRecurso(Long versionRecurso) {
        this.setVersionLogImpSub(versionRecurso);
    }
    @Override
    public void setVersionRecurso(RowKey rowKey, Long versionRecurso) {
        this.setVersionLogImpSub(rowKey, versionRecurso);
    }
}
