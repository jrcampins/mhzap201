...
import com.egt.data.specific.xdp1.LogProVerElePenCachedRowSetDataProvider;
...
public class LogProVerElePenCachedRowSetDataProvider2 extends LogProVerElePenCachedRowSetDataProvider
        implements RecursoConsultableDataProvider {

    public LogProVerElePenCachedRowSetDataProvider2() {
        super();
    }

    public LogProVerElePenCachedRowSetDataProvider2(CachedRowSet cachedRowSet) {
        super(cachedRowSet);
    ...
    public static final long FUNCION_CONSULTAR_RECURSO = 332400101L;

    public static final long FUNCION_CONSULTAR_LOG_PRO_VER_ELE_PEN = 332400101L;

    protected static final long PARAMETRO_ID_LOG_PRO_VER_ELE_PEN = 20728L;
    protected static final long PARAMETRO_VERSION_LOG_PRO_VER_ELE_PEN = 20886L;
    ...
    public void ejecutarFuncionSelect(long funcion, FiltroBusqueda filtro) throws ExcepcionAplicacion {
        if (funcion == FUNCION_CONSULTAR_LOG_PRO_VER_ELE_PEN) {
            this.consultarLogProVerElePen(filtro);
            return;
        }
    }

    public void consultarLogProVerElePen() throws ExcepcionAplicacion {
        this.consultarLogProVerElePen(new FiltroBusqueda());
    }

    public void consultarLogProVerElePen(Long filtro) throws ExcepcionAplicacion {
        if (filtro == null) {
            this.consultarLogProVerElePen(new FiltroBusqueda());
        } else {
            this.consultarLogProVerElePen(new FiltroBusqueda(filtro));
        }
    }

    public void consultarLogProVerElePen(FiltroBusqueda filtro) throws ExcepcionAplicacion {
        String comando = this.getComandoSelect();
        String clausula = "WHERE";
        String criterios = null;
        try {
            this.setFuncionSelect(FUNCION_CONSULTAR_LOG_PRO_VER_ELE_PEN);
            ...
            if (criterios != null && !criterios.equals("")) {
                ...
                comando += clausula + " id_log_pro_ver_ele_pen ";
            }
