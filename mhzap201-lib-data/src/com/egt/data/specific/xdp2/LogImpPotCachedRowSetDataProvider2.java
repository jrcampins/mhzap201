...
import com.egt.data.specific.xdp1.LogImpPotCachedRowSetDataProvider;
...
public class LogImpPotCachedRowSetDataProvider2 extends LogImpPotCachedRowSetDataProvider
        implements RecursoConsultableDataProvider {

    public LogImpPotCachedRowSetDataProvider2() {
        super();
    }

    public LogImpPotCachedRowSetDataProvider2(CachedRowSet cachedRowSet) {
        super(cachedRowSet);
    ...
    public static final long FUNCION_CONSULTAR_RECURSO = 330700101L;

    public static final long FUNCION_CONSULTAR_LOG_IMP_POT = 330700101L;

    protected static final long PARAMETRO_ID_LOG_IMP_POT = 20721L;
    protected static final long PARAMETRO_VERSION_LOG_IMP_POT = 20879L;
    protected static final long PARAMETRO_DEPARTAMENTO = 20703L;
    protected static final long PARAMETRO_DISTRITO = 20704L;
    protected static final long PARAMETRO_NOMBRES_APELLIDOS = 20735L;
    ...
    protected static final long PARAMETRO_TELEFONO_REFERENTE = 20839L;
    ...
    public void ejecutarFuncionSelect(long funcion, FiltroBusqueda filtro) throws ExcepcionAplicacion {
        if (funcion == FUNCION_CONSULTAR_LOG_IMP_POT) {
            this.consultarLogImpPot(filtro);
            return;
        }
    }

    public void consultarLogImpPot() throws ExcepcionAplicacion {
        this.consultarLogImpPot(new FiltroBusqueda());
    }

    public void consultarLogImpPot(Long filtro) throws ExcepcionAplicacion {
        if (filtro == null) {
            this.consultarLogImpPot(new FiltroBusqueda());
        } else {
            this.consultarLogImpPot(new FiltroBusqueda(filtro));
        }
    }

    public void consultarLogImpPot(FiltroBusqueda filtro) throws ExcepcionAplicacion {
        String comando = this.getComandoSelect();
        String clausula = "WHERE";
        String criterios = null;
        try {
            this.setFuncionSelect(FUNCION_CONSULTAR_LOG_IMP_POT);
            ...
            if (criterios != null && !criterios.equals("")) {
                ...
                comando += clausula + " id_log_imp_pot ";
            }
