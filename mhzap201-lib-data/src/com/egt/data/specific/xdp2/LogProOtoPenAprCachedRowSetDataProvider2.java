...
import com.egt.data.specific.xdp1.LogProOtoPenAprCachedRowSetDataProvider;
...
public class LogProOtoPenAprCachedRowSetDataProvider2 extends LogProOtoPenAprCachedRowSetDataProvider
        implements RecursoConsultableDataProvider {

    public LogProOtoPenAprCachedRowSetDataProvider2() {
        super();
    }

    public LogProOtoPenAprCachedRowSetDataProvider2(CachedRowSet cachedRowSet) {
        super(cachedRowSet);
    ...
    public static final long FUNCION_CONSULTAR_RECURSO = 332200101L;

    public static final long FUNCION_CONSULTAR_LOG_PRO_OTO_PEN_APR = 332200101L;

    protected static final long PARAMETRO_ID_LOG_PRO_OTO_PEN_APR = 20726L;
    protected static final long PARAMETRO_VERSION_LOG_PRO_OTO_PEN_APR = 20884L;
    ...
    public void ejecutarFuncionSelect(long funcion, FiltroBusqueda filtro) throws ExcepcionAplicacion {
        if (funcion == FUNCION_CONSULTAR_LOG_PRO_OTO_PEN_APR) {
            this.consultarLogProOtoPenApr(filtro);
            return;
        }
    }

    public void consultarLogProOtoPenApr() throws ExcepcionAplicacion {
        this.consultarLogProOtoPenApr(new FiltroBusqueda());
    }

    public void consultarLogProOtoPenApr(Long filtro) throws ExcepcionAplicacion {
        if (filtro == null) {
            this.consultarLogProOtoPenApr(new FiltroBusqueda());
        } else {
            this.consultarLogProOtoPenApr(new FiltroBusqueda(filtro));
        }
    }

    public void consultarLogProOtoPenApr(FiltroBusqueda filtro) throws ExcepcionAplicacion {
        String comando = this.getComandoSelect();
        String clausula = "WHERE";
        String criterios = null;
        try {
            this.setFuncionSelect(FUNCION_CONSULTAR_LOG_PRO_OTO_PEN_APR);
            ...
            if (criterios != null && !criterios.equals("")) {
                ...
                comando += clausula + " id_log_pro_oto_pen_apr ";
            }
