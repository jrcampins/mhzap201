...
public class Ubicacion4 extends AbstractPageBean
...
/**/
    ...
    // </editor-fold>
/**/
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("Ubicacion4_ETIQUETA_MIGAS_PAN");
    ...
    // </editor-fold>
/**/
    static long FUNCION_ACCION_1 = UbicacionConstants.FUNCION_RECONSTRUIR_UBICACION;
    ...
    public String botonProcesar1_action() {
        return this.accion1(FUNCION_ACCION_1); /* reconstruirUbicacion */
    }
    // </editor-fold>
...
/**/
    ...
    @EJB
    private UbicacionBusinessProcessLocal ubicacionBusinessProcess;

    private void reconstruirUbicacion() { /* reconstruir ubicacion */
        this.reconstruirUbicacion(synchronously);
    }

    private void reconstruirUbicacion(boolean synchronously) { /* reconstruir ubicacion */
        try {
            ReconstruirUbicacionMessage message = new ReconstruirUbicacionMessage();
            TLC.getControlador().ponerUsuarioEnMensaje(message);
            if (synchronously) {
                this.ubicacionBusinessProcess.reconstruirUbicacion(message);
            } else {
