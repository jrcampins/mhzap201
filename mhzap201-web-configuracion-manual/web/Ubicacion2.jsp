                                    ...
                                    <h:panelGrid 
                                        ...
                                        <h:panelGrid
                                            ...
                                            <h:panelGrid
                                                ...
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                                    binding="#{Ubicacion2.labelNumeroTipoNodo1}"
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:dropDown id="listaNumeroTipoNodo1"
                                                    binding="#{Ubicacion2.listaNumeroTipoNodo1}"
                                                    converter="#{Ubicacion2.converterNumeroTipoNodo1}"
                                                    disabled="#{Ubicacion2.gestor.filaNoProcesada}"
                                                    items="#{Ubicacion2.asistente.opcionesListaNumeroTipoNodo1}"
                                                    selected="#{Ubicacion2.ubicacionDataProvider.value['numero_tipo_nodo']}"
                                                    toolTip="BundleParametros.numero_tipo_nodo.ubicacion"/>
                                                <webuijsf:staticText id="listaNumeroTipoNodo1Texto1"
                                                    binding="#{Ubicacion2.listaNumeroTipoNodo1Texto1}"
                                                    text="#{Ubicacion2.ubicacionDataProvider.value['codigo_tipo_nodo_1x2y2']}"/>
                                                <webuijsf:message id="messageNumeroTipoNodo1"
                                                    for="listaNumeroTipoNodo1"/>
                                                <webuijsf:helpInline id="helpInlineNumeroTipoNodo1"
                                                    binding="#{Ubicacion2.helpInlineNumeroTipoNodo1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                            ...
                                            <h:panelGrid
                                                ...
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                                    binding="#{Ubicacion2.labelNumeroNivelUbicacion1}"
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:dropDown id="listaNumeroNivelUbicacion1"
                                                    binding="#{Ubicacion2.listaNumeroNivelUbicacion1}"
                                                    converter="#{Ubicacion2.converterNumeroNivelUbicacion1}"
                                                    disabled="#{Ubicacion2.gestor.filaNoProcesada}"
                                                    items="#{Ubicacion2.asistente.opcionesListaNumeroNivelUbicacion1}"
                                                    selected="#{Ubicacion2.ubicacionDataProvider.value['numero_nivel_ubicacion']}"
                                                    toolTip="BundleParametros.numero_nivel_ubicacion.ubicacion"/>
                                                <webuijsf:staticText id="listaNumeroNivelUbicacion1Texto1"
                                                    binding="#{Ubicacion2.listaNumeroNivelUbicacion1Texto1}"
                                                    text="#{Ubicacion2.ubicacionDataProvider.value['codigo_nivel_ubicacion_1x3y2']}"/>
                                                <webuijsf:message id="messageNumeroNivelUbicacion1"
                                                    for="listaNumeroNivelUbicacion1"/>
                                                <webuijsf:helpInline id="helpInlineNumeroNivelUbicacion1"
                                                    binding="#{Ubicacion2.helpInlineNumeroNivelUbicacion1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                            ...
                                            <h:panelGrid
                                                ...
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                                    binding="#{Ubicacion2.labelSecuenciaUbicacion1}"
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:textField id="campoSecuenciaUbicacion1"
                                                    binding="#{Ubicacion2.campoSecuenciaUbicacion1}"
                                                    converter="#{Ubicacion2.converterSecuenciaUbicacion1}"
                                                    readOnly="#{Ubicacion2.gestor.filaNoProcesada}"
                                                    text="#{Ubicacion2.ubicacionDataProvider.value['secuencia_ubicacion']}"
                                                    toolTip="BundleParametros.secuencia_ubicacion.ubicacion"
                                                    validatorExpression="#{Ubicacion2.validatorSecuenciaUbicacion1.validate}"/>
                                                <webuijsf:staticText id="campoSecuenciaUbicacion1Texto1"
                                                    binding="#{Ubicacion2.campoSecuenciaUbicacion1Texto1}"
                                                    text="#{Ubicacion2.ubicacionDataProvider.value['secuencia_ubicacion']}"/>
                                                <webuijsf:message id="messageSecuenciaUbicacion1"
                                                    for="campoSecuenciaUbicacion1"/>
                                                <webuijsf:helpInline id="helpInlineSecuenciaUbicacion1"
                                                    binding="#{Ubicacion2.helpInlineSecuenciaUbicacion1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                            ...
                                            <h:panelGrid
                                                ...
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                                    binding="#{Ubicacion2.labelClaveUbicacion1}"
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:textField id="campoClaveUbicacion1"
                                                    binding="#{Ubicacion2.campoClaveUbicacion1}"
                                                    columns="20"
                                                    maxLength="30"
                                                    readOnly="#{Ubicacion2.gestor.filaNoProcesada}"
                                                    text="#{Ubicacion2.ubicacionDataProvider.value['clave_ubicacion']}"
                                                    toolTip="BundleParametros.clave_ubicacion.ubicacion"
                                                    validatorExpression="#{Ubicacion2.validatorClaveUbicacion1.validate}"/>
                                                <webuijsf:staticText id="campoClaveUbicacion1Texto1"
                                                    binding="#{Ubicacion2.campoClaveUbicacion1Texto1}"
                                                    text="#{Ubicacion2.ubicacionDataProvider.value['clave_ubicacion']}"/>
                                                <webuijsf:message id="messageClaveUbicacion1"
                                                    for="campoClaveUbicacion1"/>
                                                <webuijsf:helpInline id="helpInlineClaveUbicacion1"
                                                    binding="#{Ubicacion2.helpInlineClaveUbicacion1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
