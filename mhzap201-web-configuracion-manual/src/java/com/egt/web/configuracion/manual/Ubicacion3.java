...
public class Ubicacion3 extends AbstractPageBean
...
/**/
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("Ubicacion3_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("Ubicacion3_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("Ubicacion3_ETIQUETA_CLASE_MAESTRO");
