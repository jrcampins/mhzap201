...
public class ProveedorDatExt2 extends AbstractPageBean
        implements PaginaActualizacionProveedorDatExt, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple {
...
/**/
    ...
    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("ProveedorDatExt2_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("ProveedorDatExt2_ETIQUETA_CLASE_MAESTRO");
    ...
    public long getFuncionCrearRecurso() {
        return ProveedorDatExtCachedRowSetDataProvider2.FUNCION_CREAR_PROVEEDOR_DAT_EXT;
    }

    @Override
    public long getFuncionModificarRecurso() {
        return ProveedorDatExtCachedRowSetDataProvider2.FUNCION_MODIFICAR_PROVEEDOR_DAT_EXT;
    }

    @Override
    public long getFuncionEliminarRecurso() {
        return ProveedorDatExtCachedRowSetDataProvider2.FUNCION_ELIMINAR_PROVEEDOR_DAT_EXT;
    }
