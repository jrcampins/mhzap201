...
public class Ubicacion1 extends AbstractPageBean
    ...
    private TableColumn tableColumnCodigoUbicacionJupe1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnCodigoUbicacionJupe1() {
        return tableColumnCodigoUbicacionJupe1;
    }

    public void setTableColumnCodigoUbicacionJupe1(TableColumn component) {
        this.tableColumnCodigoUbicacionJupe1 = component;
    }
...
/**/
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("Ubicacion1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("Ubicacion1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("Ubicacion1_ETIQUETA_CLASE_MAESTRO");
