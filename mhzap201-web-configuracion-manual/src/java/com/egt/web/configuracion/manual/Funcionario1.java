...
public class Funcionario1 extends AbstractPageBean
        implements PaginaActualizacionFuncionario, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla {
    ...
    private TableColumn tableColumnIdFuncionario1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdFuncionario1() {
        return tableColumnIdFuncionario1;
    }

    public void setTableColumnIdFuncionario1(TableColumn component) {
        this.tableColumnIdFuncionario1 = component;
    }
    ...
    private TableColumn tableColumnCodigoFuncionario1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnCodigoFuncionario1() {
        return tableColumnCodigoFuncionario1;
    }

    public void setTableColumnCodigoFuncionario1(TableColumn component) {
        this.tableColumnCodigoFuncionario1 = component;
    }
    ...
    private TableColumn tableColumnNombreFuncionario1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnNombreFuncionario1() {
        return tableColumnNombreFuncionario1;
    }

    public void setTableColumnNombreFuncionario1(TableColumn component) {
        this.tableColumnNombreFuncionario1 = component;
    }
...
/**/
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("Funcionario1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("Funcionario1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("Funcionario1_ETIQUETA_CLASE_MAESTRO");
    ...
    public void consultar(Long filtro) {
        try {
            this.getFuncionarioDataProvider().consultarFuncionario(filtro);
        } catch (Exception ex) {
