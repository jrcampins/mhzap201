...
public class ProveedorDatExt1 extends AbstractPageBean
...
/**/
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("ProveedorDatExt1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("ProveedorDatExt1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("ProveedorDatExt1_ETIQUETA_CLASE_MAESTRO");
