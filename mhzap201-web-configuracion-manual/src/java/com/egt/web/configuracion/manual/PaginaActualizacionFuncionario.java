...
public interface PaginaActualizacionFuncionario extends PaginaActualizacion {

    TextField getCampoIdFuncionario1();

    TextField getCampoCodigoFuncionario1();

    TextField getCampoNombreFuncionario1();
    ...
    FuncionarioCachedRowSetDataProvider2 getFuncionarioDataProvider();
}
