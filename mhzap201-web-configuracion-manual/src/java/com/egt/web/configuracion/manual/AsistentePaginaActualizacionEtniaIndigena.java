...
public class AsistentePaginaActualizacionEtniaIndigena {

    private PaginaActualizacionEtniaIndigena bean;

    public AsistentePaginaActualizacionEtniaIndigena() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionEtniaIndigena(PaginaActualizacionEtniaIndigena bean) {
        this.bean = bean;
    }
    ...
    public Option[] getOpcionesListaFuncionEdicion() {
        ...
        return new Option[]{ //
                ...
                //  new Option(EtniaIndigenaCachedRowSetDataProvider2.FUNCION_MODIFICAR_ETNIA_INDIGENA, BundleWebui.getString("editar"))
                };
    }
    ...
    public boolean isGridCodigoEtniaIndigenaRendered() {
        return true;
    }

    public boolean isGridNombreEtniaIndigenaRendered() {
        return true;
    }

    public boolean isGridDescripcionEtniaIndigenaRendered() {
        return true;
    }
