...
@Entity
@Table(name = "log_pro_act_jupe")
public class LogProActJupe implements LogProActJupeBase, Comparable, Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @Basic(optional = false)
    @Column(name = "id_log_pro_act_jupe")
    private Long idLogProActJupe;

    @Basic(optional = false)
    @Column(name = "version_log_pro_act_jupe")
    private long versionLogProActJupe;
    ...
    public int compareTo(Object object) {
        ...
        if (object instanceof LogProActJupe) {
            LogProActJupe that = (LogProActJupe) object;
            return idLogProActJupe == null ? that.idLogProActJupe == null ? 0 : -1
                    : idLogProActJupe.compareTo(that.idLogProActJupe);
        }
    ...
    public int hashCode() {
        // Warning - this method won't work properly in the case the id fields are not set
        int hash = 0;
        hash += idLogProActJupe == null ? 0 : idLogProActJupe.hashCode();
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof LogProActJupe) {
            LogProActJupe that = (LogProActJupe) object;
            return ((idLogProActJupe == null && that.idLogProActJupe == null) ||
                    (idLogProActJupe != null && idLogProActJupe.equals(that.idLogProActJupe)));
        }
        return false;
    }
    ...
    public String toString() {
        return this.getClass().getSimpleName() + "#" + idLogProActJupe;
    }
}
