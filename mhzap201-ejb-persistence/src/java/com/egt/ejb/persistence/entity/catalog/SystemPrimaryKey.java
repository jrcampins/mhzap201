...
@Entity
@Table(name = "vista_system_sysprimarykeys")
@NamedQueries({})
public class SystemPrimaryKey implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SystemPrimaryKey)) {
            return false;
        }
        SystemPrimaryKey other = (SystemPrimaryKey) object;
