...
@Entity
@Table(name = "filtro_cla_rec_vin")
public class FiltroClaRecVin implements FiltroClaRecVinBase, Comparable, Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @Basic(optional = false)
    @Column(name = "id_filtro_cla_rec_vin")
    private Long idFiltroClaRecVin;

    @Basic(optional = false)
    @Column(name = "version_filtro_cla_rec_vin")
    private long versionFiltroClaRecVin;
    ...
    public int compareTo(Object object) {
        ...
        if (object instanceof FiltroClaRecVin) {
            FiltroClaRecVin that = (FiltroClaRecVin) object;
            return idFiltroClaRecVin == null ? that.idFiltroClaRecVin == null ? 0 : -1
                    : idFiltroClaRecVin.compareTo(that.idFiltroClaRecVin);
        }
    ...
    public int hashCode() {
        // Warning - this method won't work properly in the case the id fields are not set
        int hash = 0;
        hash += idFiltroClaRecVin == null ? 0 : idFiltroClaRecVin.hashCode();
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof FiltroClaRecVin) {
            FiltroClaRecVin that = (FiltroClaRecVin) object;
            return ((idFiltroClaRecVin == null && that.idFiltroClaRecVin == null) ||
                    (idFiltroClaRecVin != null && idFiltroClaRecVin.equals(that.idFiltroClaRecVin)));
        }
        return false;
    }
    ...
    public String toString() {
        return this.getClass().getSimpleName() + "#" + idFiltroClaRecVin;
    }
}
