...
@Entity
@Table(name = "vista_system_syscolumnconstraints")
@NamedQueries({})
public class SystemColumnConstraint implements Serializable {
    ...
    @Column(name = "conexpr", nullable = false)
    private String conexpr;
    ...
    public String getConexpr() {
        return conexpr;
    }

    public void setConexpr(String conexpr) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SystemColumnConstraint)) {
            return false;
        }
        SystemColumnConstraint other = (SystemColumnConstraint) object;
