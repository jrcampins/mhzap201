...
public class RolUsuarioPorRol1 extends AbstractPageBean
        implements PaginaActualizacionRolUsuarioPorRol, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla, PaginaConsultaConMaestro {
...
/**/
    ...
    private AsistentePaginaActualizacionRolUsuarioPorRol asistente = new AsistentePaginaActualizacionRolUsuarioPorRol(this);

    public AsistentePaginaActualizacionRolUsuarioPorRol getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("RolUsuarioPorRol1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("RolUsuarioPorRol1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("RolUsuarioPorRol1_ETIQUETA_CLASE_MAESTRO");
    ...
    public String getColumnaIdentificacionRecursoMaestro() {
        return RolUsuarioCachedRowSetDataProvider2.COLUMNA_ID_ROL;
    }
