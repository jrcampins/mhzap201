...
public class RolPaginaPorRol1 extends AbstractPageBean
        implements PaginaActualizacionRolPaginaPorRol, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla, PaginaConsultaConMaestro {

    // <editor-fold defaultstate="collapsed" desc="Managed Component Definition">
    private void _init() throws Exception {
        textoFilasPorPagina1Validator1.setMinimum(1L);
        textoFilasPorPagina1Validator1.setMaximum(50L);
        validatorIdRolPagina1.setMinimum(0L);
        validatorIdRolPagina1.setMaximum(1000000000000000000L);
        rolPaginaDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.rolPaginaRowSet}"));
    ...
    private TableColumn tableColumnIdRolPagina1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdRolPagina1() {
        return tableColumnIdRolPagina1;
    }

    public void setTableColumnIdRolPagina1(TableColumn component) {
        this.tableColumnIdRolPagina1 = component;
    }

    private Label labelIdRolPagina1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelIdRolPagina1() {
        return labelIdRolPagina1;
    }

    public void setLabelIdRolPagina1(Label l) {
        this.labelIdRolPagina1 = l;
    }

    private TextField campoIdRolPagina1 = new com.egt.core.jsf.component.CampoTexto();

    @Override
    public TextField getCampoIdRolPagina1() {
        return campoIdRolPagina1;
    }

    public void setCampoIdRolPagina1(TextField component) {
        this.campoIdRolPagina1 = component;
    }

    private StaticText campoIdRolPagina1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoIdRolPagina1Texto1() {
        return campoIdRolPagina1Texto1;
    }

    public void setCampoIdRolPagina1Texto1(StaticText component) {
        this.campoIdRolPagina1Texto1 = component;
    }

    private LongConverter converterIdRolPagina1 = new LongConverter();
  
    public LongConverter getConverterIdRolPagina1() {
        return converterIdRolPagina1;
    }
  
    public void setConverterIdRolPagina1(LongConverter converter) {
        this.converterIdRolPagina1 = converter;
    }
  
    private LongRangeValidator validatorIdRolPagina1 = new LongRangeValidator();
  
    public LongRangeValidator getValidatorIdRolPagina1() {
        return validatorIdRolPagina1;
    }
  
    public void setValidatorIdRolPagina1(LongRangeValidator validator) {
        this.validatorIdRolPagina1 = validator;
    }
    ...
    private RolPaginaCachedRowSetDataProvider2 rolPaginaDataProvider = new RolPaginaCachedRowSetDataProvider2();

    @Override
    public RolPaginaCachedRowSetDataProvider2 getRolPaginaDataProvider() {
        return rolPaginaDataProvider;
    }

    public void setRolPaginaDataProvider(RolPaginaCachedRowSetDataProvider2 crsdp) {
        this.rolPaginaDataProvider = crsdp;
    }
...
/**/
    ...
    // <editor-fold defaultstate="collapsed" desc="implementacion estandar de propiedades tipo fecha de la interfaz PaginaActualizacionRolPagina...">
    // </editor-fold>
    ...
    private AsistentePaginaActualizacionRolPaginaPorRol asistente = new AsistentePaginaActualizacionRolPaginaPorRol(this);

    public AsistentePaginaActualizacionRolPaginaPorRol getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("RolPaginaPorRol1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("RolPaginaPorRol1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("RolPaginaPorRol1_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getRolPaginaDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return RolPaginaCachedRowSetDataProvider2.FUNCION_CONSULTAR_ROL_PAGINA;
    }

    @Override
    public long getFuncionCrearRecurso() {
        return RolPaginaCachedRowSetDataProvider2.FUNCION_CREAR_ROL_PAGINA;
    }

    @Override
    public long getFuncionModificarRecurso() {
        return RolPaginaCachedRowSetDataProvider2.FUNCION_MODIFICAR_ROL_PAGINA;
    }

    @Override
    public long getFuncionEliminarRecurso() {
        return RolPaginaCachedRowSetDataProvider2.FUNCION_ELIMINAR_ROL_PAGINA;
    }
    ...
    public String getColumnaIdentificacionRecursoMaestro() {
        return RolPaginaCachedRowSetDataProvider2.COLUMNA_ID_ROL;
    }
...
//      String urx = URX2.DETALLE_ROL_PAGINA;
//      return this.getGestor().getScriptAbrirVentanaVerDetalle(urx);
    ...
    public void consultar(Long filtro) {
        try {
            this.getRolPaginaDataProvider().consultarRolPagina(filtro);
        } catch (Exception ex) {
