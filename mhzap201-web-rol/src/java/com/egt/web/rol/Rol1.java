...
public class Rol1 extends AbstractPageBean
        implements PaginaActualizacionRol, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla {
    ...
    private TableColumn tableColumnCodigoRol1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnCodigoRol1() {
        return tableColumnCodigoRol1;
    }

    public void setTableColumnCodigoRol1(TableColumn component) {
        this.tableColumnCodigoRol1 = component;
    }
    ...
    private TableColumn tableColumnNombreRol1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnNombreRol1() {
        return tableColumnNombreRol1;
    }

    public void setTableColumnNombreRol1(TableColumn component) {
        this.tableColumnNombreRol1 = component;
    }
    ...
    private TableColumn tableColumnDescripcionRol1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnDescripcionRol1() {
        return tableColumnDescripcionRol1;
    }

    public void setTableColumnDescripcionRol1(TableColumn component) {
        this.tableColumnDescripcionRol1 = component;
    }
...
/**/
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("Rol1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("Rol1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("Rol1_ETIQUETA_CLASE_MAESTRO");
    ...
    public void consultar(Long filtro) {
        try {
            this.getRolDataProvider().consultarRol(filtro);
        } catch (Exception ex) {
