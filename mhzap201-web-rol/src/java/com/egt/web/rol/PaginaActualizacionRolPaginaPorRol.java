...
public interface PaginaActualizacionRolPaginaPorRol extends PaginaActualizacion {

    TextField getCampoIdRolPagina1();

    TextField getCampoIdPagina1();

    Button getBotonAplicar1();

    RolPaginaCachedRowSetDataProvider2 getRolPaginaDataProvider();
