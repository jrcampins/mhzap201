 ...
 */
public class RastroFuncion2 extends AbstractPageBean
        implements PaginaActualizacion, PaginaConsultaConFiltro, PaginaConsultaConTabla {
...
/**/
    ...
    // </editor-fold>
/**/
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("RastroFuncion2_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("RastroFuncion2_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("RastroFuncion2_ETIQUETA_CLASE_MAESTRO");
