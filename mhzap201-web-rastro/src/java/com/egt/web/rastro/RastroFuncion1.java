 ...
 */
public class RastroFuncion1 extends AbstractPageBean
...
/**/
    ...
    // </editor-fold>
/**/
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("RastroFuncion1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("RastroFuncion1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("RastroFuncion1_ETIQUETA_CLASE_MAESTRO");
    ...
    public long getFuncionConsultarRecurso() {
        return RelacionRastroFuncionCachedRowSetDataProvider2.FUNCION_CONSULTAR_RELACION_RASTRO_FUNCION;
    }

    @Override
    public long getFuncionCrearRecurso() {
        return -1; // return RelacionRastroFuncionCachedRowSetDataProvider2.FUNCION_CREAR_RASTRO_FUNCION;
    }

    @Override
    public long getFuncionModificarRecurso() {
        return -1; // return RelacionRastroFuncionCachedRowSetDataProvider2.FUNCION_MODIFICAR_RASTRO_FUNCION;
    }

    @Override
    public long getFuncionEliminarRecurso() {
        return -1; // return RelacionRastroFuncionCachedRowSetDataProvider2.FUNCION_ELIMINAR_RASTRO_FUNCION;
    }
    ...
    public String getColumnaIdentificacionRecursoMaestro() {
        return null; // return RelacionRastroFuncionCachedRowSetDataProvider2.COLUMNA_ID_RECURSO_MAESTRO_EQUIS;
    }
    ...
    public void consultar(Long filtro) {
        try {
            this.getRastroFuncionDataProvider().consultarRelacionRastroFuncion(filtro);
        } catch (Exception ex) {
