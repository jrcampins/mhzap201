...
import com.egt.data.general.xdp2.RelacionRastroInformeCachedRowSetDataProvider2;
 ...
 */
public class RastroInforme1 extends AbstractPageBean
    ...
    private void _init() throws Exception {
        ...
        rastroInformeDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.rastroInformeRowSet}"));
    }
    ...
    private RelacionRastroInformeCachedRowSetDataProvider2 rastroInformeDataProvider = new RelacionRastroInformeCachedRowSetDataProvider2();

    public RelacionRastroInformeCachedRowSetDataProvider2 getRastroInformeDataProvider() {
        return rastroInformeDataProvider;
    }

    public void setRastroInformeDataProvider(RelacionRastroInformeCachedRowSetDataProvider2 crsdp) {
        this.rastroInformeDataProvider = crsdp;
    }
    ...
    //@PreDestroy
    public void destroy() {
        rastroInformeDataProvider.close();
    }
    // </editor-fold>
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("RastroInforme1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("RastroInforme1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("RastroInforme1_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getRastroInformeDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return RelacionRastroInformeCachedRowSetDataProvider2.FUNCION_CONSULTAR_RELACION_RASTRO_INFORME;
    }

    @Override
    public long getFuncionCrearRecurso() {
        return -1; // return RelacionRastroInformeCachedRowSetDataProvider2.FUNCION_CREAR_RASTRO_INFORME;
    }

    @Override
    public long getFuncionModificarRecurso() {
        return -1; // return RelacionRastroInformeCachedRowSetDataProvider2.FUNCION_MODIFICAR_RASTRO_INFORME;
    }

    @Override
    public long getFuncionEliminarRecurso() {
        return -1; // return RelacionRastroInformeCachedRowSetDataProvider2.FUNCION_ELIMINAR_RASTRO_INFORME;
    }
    ...
    public String getColumnaIdentificacionRecursoMaestro() {
        return null; // return RelacionRastroInformeCachedRowSetDataProvider2.COLUMNA_ID_RECURSO_MAESTRO_EQUIS;
    }
    ...
    public void consultar(Long filtro) {
        try {
            this.getRastroInformeDataProvider().consultarRelacionRastroInforme(filtro);
        } catch (Exception ex) {
    ...
    public String getExtensionNombreArchivo() {
        ...
        String archivo = this.getRastroInformeDataProvider().getNombreArchivo(rowKey);
        Long usuario = this.getRastroInformeDataProvider().getIdUsuario(rowKey);
        return JSF.getExtensionNombreArchivo(archivo, usuario);
    }
    ...
    public String getUrlNombreArchivo() {
        ...
        String archivo = this.getRastroInformeDataProvider().getNombreArchivo(rowKey);
        Long usuario = this.getRastroInformeDataProvider().getIdUsuario(rowKey);
        return JSF.getUrlNombreArchivo(archivo, usuario);
    }
...
//      if (this.getGestor().vincular()) {
        ...
        String archivo = this.getRastroInformeDataProvider().getNombreArchivo(rowKey);
        Long usuario = this.getRastroInformeDataProvider().getIdUsuario(rowKey);
        return JSF.getScriptAbrirVentanaArchivo(archivo, usuario);
//      }
//      return null;
    }
