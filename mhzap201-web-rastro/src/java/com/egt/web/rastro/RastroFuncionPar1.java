...
import com.egt.data.general.xdp2.RelacionRastroFuncionCachedRowSetDataProvider2;
import com.egt.data.general.xdp2.RelacionRastroFuncionParCachedRowSetDataProvider2;
 ...
 */
public class RastroFuncionPar1 extends AbstractPageBean
    ...
    private void _init() throws Exception {
        ...
        rastroFuncionParDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.rastroFuncionParRowSet}"));
        rastroFuncionDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.rastroFuncionRowSet}"));
    }
    ...
    private RelacionRastroFuncionParCachedRowSetDataProvider2 rastroFuncionParDataProvider = new RelacionRastroFuncionParCachedRowSetDataProvider2();

    public RelacionRastroFuncionParCachedRowSetDataProvider2 getRastroFuncionParDataProvider() {
        return rastroFuncionParDataProvider;
    }

    public void setRastroFuncionParDataProvider(RelacionRastroFuncionParCachedRowSetDataProvider2 crsdp) {
        this.rastroFuncionParDataProvider = crsdp;
    }

    private RelacionRastroFuncionCachedRowSetDataProvider2 rastroFuncionDataProvider = new RelacionRastroFuncionCachedRowSetDataProvider2();

    public RelacionRastroFuncionCachedRowSetDataProvider2 getRastroFuncionDataProvider() {
        return rastroFuncionDataProvider;
    }

    public void setRastroFuncionDataProvider(RelacionRastroFuncionCachedRowSetDataProvider2 crsdp) {
        this.rastroFuncionDataProvider = crsdp;
    }
...
/**/
    ...
    // </editor-fold>
/**/
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("RastroFuncionPar1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("RastroFuncionPar1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("RastroFuncionPar1_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getRastroFuncionParDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return RelacionRastroFuncionParCachedRowSetDataProvider2.FUNCION_CONSULTAR_RELACION_RASTRO_FUNCION_PAR;
    }

    @Override
    public long getFuncionCrearRecurso() {
        return -1; // return RelacionRastroFuncionParCachedRowSetDataProvider2.FUNCION_CREAR_RASTRO_FUNCION_PAR;
    }

    @Override
    public long getFuncionModificarRecurso() {
        return -1; // return RelacionRastroFuncionParCachedRowSetDataProvider2.FUNCION_MODIFICAR_RASTRO_FUNCION_PAR;
    }

    @Override
    public long getFuncionEliminarRecurso() {
        return -1; // return RelacionRastroFuncionParCachedRowSetDataProvider2.FUNCION_ELIMINAR_RASTRO_FUNCION_PAR;
    }

    @Override
    public RecursoCachedRowSetDataProvider getRecursoMaestroDataProvider() {
        return this.getRastroFuncionDataProvider();
    }

    @Override
    public String getColumnaIdentificacionRecursoMaestro() {
        return RelacionRastroFuncionParCachedRowSetDataProvider2.COLUMNA_ID_RASTRO_FUNCION;
    }
    ...
    public void consultar(Long filtro) {
        try {
            this.getRastroFuncionParDataProvider().consultarRelacionRastroFuncionPar(filtro);
        } catch (Exception ex) {
    ...
    // </editor-fold>
/**/
    private void setTituloTabla() {
        String titulo = ETIQUETA_CLASE_DETALLE + " " + ETIQUETA_CLASE_MAESTRO + " " +
                this.getRastroFuncionDataProvider().getCodigoFuncion() + " " +
                this.getRastroFuncionDataProvider().getDenominacionFilaEscogida();

        this.getTable1().setTitle(titulo);
    }
}
