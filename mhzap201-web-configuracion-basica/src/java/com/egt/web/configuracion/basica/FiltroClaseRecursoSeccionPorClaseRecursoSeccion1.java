...
public class FiltroClaseRecursoSeccionPorClaseRecursoSeccion1 extends AbstractPageBean
        implements PaginaActualizacionFiltroClaRecSecPorClaseRecursoSec, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla, PaginaConsultaConMaestro {

    // <editor-fold defaultstate="collapsed" desc="Managed Component Definition">
    private void _init() throws Exception {
        textoFilasPorPagina1Validator1.setMinimum(1L);
        textoFilasPorPagina1Validator1.setMaximum(50L);
        validatorIdFiltroClaRecSec1.setMinimum(0L);
        validatorIdFiltroClaRecSec1.setMaximum(1000000000000000000L);
        validatorValor1.setMaximum(8160);
        filtroClaRecSecDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.filtroClaRecSecRowSet}"));
    ...
    private TableColumn tableColumnIdFiltroClaRecSec1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdFiltroClaRecSec1() {
        return tableColumnIdFiltroClaRecSec1;
    }

    public void setTableColumnIdFiltroClaRecSec1(TableColumn component) {
        this.tableColumnIdFiltroClaRecSec1 = component;
    }

    private Label labelIdFiltroClaRecSec1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelIdFiltroClaRecSec1() {
        return labelIdFiltroClaRecSec1;
    }

    public void setLabelIdFiltroClaRecSec1(Label l) {
        this.labelIdFiltroClaRecSec1 = l;
    }

    private TextField campoIdFiltroClaRecSec1 = new com.egt.core.jsf.component.CampoTexto();

    @Override
    public TextField getCampoIdFiltroClaRecSec1() {
        return campoIdFiltroClaRecSec1;
    }

    public void setCampoIdFiltroClaRecSec1(TextField component) {
        this.campoIdFiltroClaRecSec1 = component;
    }

    private StaticText campoIdFiltroClaRecSec1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoIdFiltroClaRecSec1Texto1() {
        return campoIdFiltroClaRecSec1Texto1;
    }

    public void setCampoIdFiltroClaRecSec1Texto1(StaticText component) {
        this.campoIdFiltroClaRecSec1Texto1 = component;
    }

    private LongConverter converterIdFiltroClaRecSec1 = new LongConverter();
  
    public LongConverter getConverterIdFiltroClaRecSec1() {
        return converterIdFiltroClaRecSec1;
    }
  
    public void setConverterIdFiltroClaRecSec1(LongConverter converter) {
        this.converterIdFiltroClaRecSec1 = converter;
    }
  
    private LongRangeValidator validatorIdFiltroClaRecSec1 = new LongRangeValidator();
  
    public LongRangeValidator getValidatorIdFiltroClaRecSec1() {
        return validatorIdFiltroClaRecSec1;
    }
  
    public void setValidatorIdFiltroClaRecSec1(LongRangeValidator validator) {
        this.validatorIdFiltroClaRecSec1 = validator;
    }
    ...
    private FiltroClaRecSecCachedRowSetDataProvider2 filtroClaRecSecDataProvider = new FiltroClaRecSecCachedRowSetDataProvider2();

    @Override
    public FiltroClaRecSecCachedRowSetDataProvider2 getFiltroClaRecSecDataProvider() {
        return filtroClaRecSecDataProvider;
    }

    public void setFiltroClaRecSecDataProvider(FiltroClaRecSecCachedRowSetDataProvider2 crsdp) {
        this.filtroClaRecSecDataProvider = crsdp;
    }
    ...
    // </editor-fold>
/**/
    public FiltroClaseRecursoSeccionPorClaseRecursoSeccion1() {
    }
    ...
    // <editor-fold defaultstate="collapsed" desc="implementacion estandar de propiedades tipo fecha de la interfaz PaginaActualizacionFiltroClaRecSec...">
    // </editor-fold>
    ...
    private AsistentePaginaActualizacionFiltroClaRecSecPorClaseRecursoSec asistente = new AsistentePaginaActualizacionFiltroClaRecSecPorClaseRecursoSec(this);

    public AsistentePaginaActualizacionFiltroClaRecSecPorClaseRecursoSec getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("FiltroClaseRecursoSeccionPorClaseRecursoSeccion1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("FiltroClaseRecursoSeccionPorClaseRecursoSeccion1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("FiltroClaseRecursoSeccionPorClaseRecursoSeccion1_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getFiltroClaRecSecDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return FiltroClaRecSecCachedRowSetDataProvider2.FUNCION_CONSULTAR_FILTRO_CLA_REC_SEC;
    }

    @Override
    public long getFuncionCrearRecurso() {
        return FiltroClaRecSecCachedRowSetDataProvider2.FUNCION_CREAR_FILTRO_CLA_REC_SEC;
    }

    @Override
    public long getFuncionModificarRecurso() {
        return FiltroClaRecSecCachedRowSetDataProvider2.FUNCION_MODIFICAR_FILTRO_CLA_REC_SEC;
    }

    @Override
    public long getFuncionEliminarRecurso() {
        return FiltroClaRecSecCachedRowSetDataProvider2.FUNCION_ELIMINAR_FILTRO_CLA_REC_SEC;
    }
    ...
    public String getColumnaIdentificacionRecursoMaestro() {
        return FiltroClaRecSecCachedRowSetDataProvider2.COLUMNA_ID_CLASE_RECURSO_SEC;
    }
...
//      String urx = URX2.DETALLE_FILTRO_CLA_REC_SEC;
//      return this.getGestor().getScriptAbrirVentanaVerDetalle(urx);
    ...
    public void consultar(Long filtro) {
        try {
            this.getFiltroClaRecSecDataProvider().consultarFiltroClaRecSec(filtro);
        } catch (Exception ex) {
