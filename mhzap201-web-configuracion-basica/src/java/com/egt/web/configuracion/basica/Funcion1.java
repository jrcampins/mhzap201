...
public class Funcion1 extends AbstractPageBean
        implements PaginaActualizacionFuncion, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla {
...
/**/
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("Funcion1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("Funcion1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("Funcion1_ETIQUETA_CLASE_MAESTRO");
