...
public interface PaginaActualizacionFiltroClaRecParPorClaseRecursoPar extends PaginaActualizacion {

    TextField getCampoIdFiltroClaRecPar1();
    ...
    FiltroClaRecParCachedRowSetDataProvider2 getFiltroClaRecParDataProvider();
