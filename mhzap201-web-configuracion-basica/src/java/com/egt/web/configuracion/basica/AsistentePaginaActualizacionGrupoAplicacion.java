...
public class AsistentePaginaActualizacionGrupoAplicacion {

    private PaginaActualizacionGrupoAplicacion bean;

    public AsistentePaginaActualizacionGrupoAplicacion() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionGrupoAplicacion(PaginaActualizacionGrupoAplicacion bean) {
        this.bean = bean;
    }
    ...
    public Option[] getOpcionesListaFuncionEdicion() {
        ...
        return new Option[]{ //
                ...
                //  new Option(GrupoAplicacionCachedRowSetDataProvider2.FUNCION_MODIFICAR_GRUPO_APLICACION, BundleWebui.getString("editar"))
                };
    }
    ...
    public boolean isGridCodigoGrupoAplicacionRendered() {
        return true;
    }

    public boolean isGridNombreGrupoAplicacionRendered() {
        return true;
    }

    public boolean isGridDescripcionGrupoAplicacionRendered() {
        return true;
    }
