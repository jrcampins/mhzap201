...
public class FiltroClaseRecursoFuncionPorFuncion1 extends AbstractPageBean
        implements PaginaActualizacionFiltroClaRecFunPorFuncion, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla, PaginaConsultaConMaestro {

    // <editor-fold defaultstate="collapsed" desc="Managed Component Definition">
    private void _init() throws Exception {
        textoFilasPorPagina1Validator1.setMinimum(1L);
        textoFilasPorPagina1Validator1.setMaximum(50L);
        validatorIdFiltroClaRecFun1.setMinimum(0L);
        validatorIdFiltroClaRecFun1.setMaximum(1000000000000000000L);
        validatorValor1.setMaximum(8160);
        filtroClaRecFunDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.filtroClaRecFunRowSet}"));
    ...
    private TableColumn tableColumnIdFiltroClaRecFun1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdFiltroClaRecFun1() {
        return tableColumnIdFiltroClaRecFun1;
    }

    public void setTableColumnIdFiltroClaRecFun1(TableColumn component) {
        this.tableColumnIdFiltroClaRecFun1 = component;
    }

    private Label labelIdFiltroClaRecFun1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelIdFiltroClaRecFun1() {
        return labelIdFiltroClaRecFun1;
    }

    public void setLabelIdFiltroClaRecFun1(Label l) {
        this.labelIdFiltroClaRecFun1 = l;
    }

    private TextField campoIdFiltroClaRecFun1 = new com.egt.core.jsf.component.CampoTexto();

    @Override
    public TextField getCampoIdFiltroClaRecFun1() {
        return campoIdFiltroClaRecFun1;
    }

    public void setCampoIdFiltroClaRecFun1(TextField component) {
        this.campoIdFiltroClaRecFun1 = component;
    }

    private StaticText campoIdFiltroClaRecFun1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoIdFiltroClaRecFun1Texto1() {
        return campoIdFiltroClaRecFun1Texto1;
    }

    public void setCampoIdFiltroClaRecFun1Texto1(StaticText component) {
        this.campoIdFiltroClaRecFun1Texto1 = component;
    }

    private LongConverter converterIdFiltroClaRecFun1 = new LongConverter();
  
    public LongConverter getConverterIdFiltroClaRecFun1() {
        return converterIdFiltroClaRecFun1;
    }
  
    public void setConverterIdFiltroClaRecFun1(LongConverter converter) {
        this.converterIdFiltroClaRecFun1 = converter;
    }
  
    private LongRangeValidator validatorIdFiltroClaRecFun1 = new LongRangeValidator();
  
    public LongRangeValidator getValidatorIdFiltroClaRecFun1() {
        return validatorIdFiltroClaRecFun1;
    }
  
    public void setValidatorIdFiltroClaRecFun1(LongRangeValidator validator) {
        this.validatorIdFiltroClaRecFun1 = validator;
    }
    ...
    private FiltroClaRecFunCachedRowSetDataProvider2 filtroClaRecFunDataProvider = new FiltroClaRecFunCachedRowSetDataProvider2();

    @Override
    public FiltroClaRecFunCachedRowSetDataProvider2 getFiltroClaRecFunDataProvider() {
        return filtroClaRecFunDataProvider;
    }

    public void setFiltroClaRecFunDataProvider(FiltroClaRecFunCachedRowSetDataProvider2 crsdp) {
        this.filtroClaRecFunDataProvider = crsdp;
    }
    ...
    // </editor-fold>
/**/
    public FiltroClaseRecursoFuncionPorFuncion1() {
    }
    ...
    // <editor-fold defaultstate="collapsed" desc="implementacion estandar de propiedades tipo fecha de la interfaz PaginaActualizacionFiltroClaRecFun...">
    // </editor-fold>
    ...
    private AsistentePaginaActualizacionFiltroClaRecFunPorFuncion asistente = new AsistentePaginaActualizacionFiltroClaRecFunPorFuncion(this);

    public AsistentePaginaActualizacionFiltroClaRecFunPorFuncion getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("FiltroClaseRecursoFuncionPorFuncion1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("FiltroClaseRecursoFuncionPorFuncion1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("FiltroClaseRecursoFuncionPorFuncion1_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getFiltroClaRecFunDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return FiltroClaRecFunCachedRowSetDataProvider2.FUNCION_CONSULTAR_FILTRO_CLA_REC_FUN;
    }

    @Override
    public long getFuncionCrearRecurso() {
        return FiltroClaRecFunCachedRowSetDataProvider2.FUNCION_CREAR_FILTRO_CLA_REC_FUN;
    }

    @Override
    public long getFuncionModificarRecurso() {
        return FiltroClaRecFunCachedRowSetDataProvider2.FUNCION_MODIFICAR_FILTRO_CLA_REC_FUN;
    }

    @Override
    public long getFuncionEliminarRecurso() {
        return FiltroClaRecFunCachedRowSetDataProvider2.FUNCION_ELIMINAR_FILTRO_CLA_REC_FUN;
    }
    ...
    public String getColumnaIdentificacionRecursoMaestro() {
        return FiltroClaRecFunCachedRowSetDataProvider2.COLUMNA_ID_FUNCION;
    }
...
//      String urx = URX2.DETALLE_FILTRO_CLA_REC_FUN;
//      return this.getGestor().getScriptAbrirVentanaVerDetalle(urx);
    ...
    public void consultar(Long filtro) {
        try {
            this.getFiltroClaRecFunDataProvider().consultarFiltroClaRecFun(filtro);
        } catch (Exception ex) {
