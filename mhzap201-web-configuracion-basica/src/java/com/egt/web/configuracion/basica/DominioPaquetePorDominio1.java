...
public class DominioPaquetePorDominio1 extends AbstractPageBean
        implements PaginaActualizacionDominioPaquetePorDominio, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla, PaginaConsultaConMaestro {

    // <editor-fold defaultstate="collapsed" desc="Managed Component Definition">
    private void _init() throws Exception {
        textoFilasPorPagina1Validator1.setMinimum(1L);
        textoFilasPorPagina1Validator1.setMaximum(50L);
        validatorIdDominioPaquete1.setMinimum(0L);
        validatorIdDominioPaquete1.setMaximum(1000000000000000000L);
        dominioPaqueteDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.dominioPaqueteRowSet}"));
    ...
    private TableColumn tableColumnIdDominioPaquete1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdDominioPaquete1() {
        return tableColumnIdDominioPaquete1;
    }

    public void setTableColumnIdDominioPaquete1(TableColumn component) {
        this.tableColumnIdDominioPaquete1 = component;
    }

    private Label labelIdDominioPaquete1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelIdDominioPaquete1() {
        return labelIdDominioPaquete1;
    }

    public void setLabelIdDominioPaquete1(Label l) {
        this.labelIdDominioPaquete1 = l;
    }

    private TextField campoIdDominioPaquete1 = new com.egt.core.jsf.component.CampoTexto();

    @Override
    public TextField getCampoIdDominioPaquete1() {
        return campoIdDominioPaquete1;
    }

    public void setCampoIdDominioPaquete1(TextField component) {
        this.campoIdDominioPaquete1 = component;
    }

    private StaticText campoIdDominioPaquete1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoIdDominioPaquete1Texto1() {
        return campoIdDominioPaquete1Texto1;
    }

    public void setCampoIdDominioPaquete1Texto1(StaticText component) {
        this.campoIdDominioPaquete1Texto1 = component;
    }

    private LongConverter converterIdDominioPaquete1 = new LongConverter();
  
    public LongConverter getConverterIdDominioPaquete1() {
        return converterIdDominioPaquete1;
    }
  
    public void setConverterIdDominioPaquete1(LongConverter converter) {
        this.converterIdDominioPaquete1 = converter;
    }
  
    private LongRangeValidator validatorIdDominioPaquete1 = new LongRangeValidator();
  
    public LongRangeValidator getValidatorIdDominioPaquete1() {
        return validatorIdDominioPaquete1;
    }
  
    public void setValidatorIdDominioPaquete1(LongRangeValidator validator) {
        this.validatorIdDominioPaquete1 = validator;
    }
    ...
    private DominioPaqueteCachedRowSetDataProvider2 dominioPaqueteDataProvider = new DominioPaqueteCachedRowSetDataProvider2();

    @Override
    public DominioPaqueteCachedRowSetDataProvider2 getDominioPaqueteDataProvider() {
        return dominioPaqueteDataProvider;
    }

    public void setDominioPaqueteDataProvider(DominioPaqueteCachedRowSetDataProvider2 crsdp) {
        this.dominioPaqueteDataProvider = crsdp;
    }
    ...
    // </editor-fold>
/**/
    public DominioPaquetePorDominio1() {
    }
    ...
    //@PreDestroy
    public void destroy() {
        dominioPaqueteDataProvider.close();
    ...
    // <editor-fold defaultstate="collapsed" desc="implementacion estandar de propiedades tipo fecha de la interfaz PaginaActualizacionDominioPaquete...">
    // </editor-fold>
    ...
    private AsistentePaginaActualizacionDominioPaquetePorDominio asistente = new AsistentePaginaActualizacionDominioPaquetePorDominio(this);

    public AsistentePaginaActualizacionDominioPaquetePorDominio getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("DominioPaquetePorDominio1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("DominioPaquetePorDominio1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("DominioPaquetePorDominio1_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getDominioPaqueteDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return DominioPaqueteCachedRowSetDataProvider2.FUNCION_CONSULTAR_DOMINIO_PAQUETE;
    }

    @Override
    public long getFuncionCrearRecurso() {
        return DominioPaqueteCachedRowSetDataProvider2.FUNCION_CREAR_DOMINIO_PAQUETE;
    }

    @Override
    public long getFuncionModificarRecurso() {
        return DominioPaqueteCachedRowSetDataProvider2.FUNCION_MODIFICAR_DOMINIO_PAQUETE;
    }

    @Override
    public long getFuncionEliminarRecurso() {
        return DominioPaqueteCachedRowSetDataProvider2.FUNCION_ELIMINAR_DOMINIO_PAQUETE;
    }
    ...
    public String getColumnaIdentificacionRecursoMaestro() {
        return DominioPaqueteCachedRowSetDataProvider2.COLUMNA_ID_DOMINIO;
    }
...
//      String urx = URX2.DETALLE_DOMINIO_PAQUETE;
//      return this.getGestor().getScriptAbrirVentanaVerDetalle(urx);
    ...
    public void consultar(Long filtro) {
        try {
            this.getDominioPaqueteDataProvider().consultarDominioPaquete(filtro);
        } catch (Exception ex) {
