...
public class Parametro1 extends AbstractPageBean
        implements PaginaActualizacionParametro, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla {
    ...
    private TableColumn tableColumnCodigoParametro1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnCodigoParametro1() {
        return tableColumnCodigoParametro1;
    }

    public void setTableColumnCodigoParametro1(TableColumn component) {
        this.tableColumnCodigoParametro1 = component;
    }
    ...
    private TableColumn tableColumnNombreParametro1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnNombreParametro1() {
        return tableColumnNombreParametro1;
    }

    public void setTableColumnNombreParametro1(TableColumn component) {
        this.tableColumnNombreParametro1 = component;
    }
    ...
    private TableColumn tableColumnDetalleParametro1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnDetalleParametro1() {
        return tableColumnDetalleParametro1;
    }

    public void setTableColumnDetalleParametro1(TableColumn component) {
        this.tableColumnDetalleParametro1 = component;
    }
    ...
    private TableColumn tableColumnDescripcionParametro1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnDescripcionParametro1() {
        return tableColumnDescripcionParametro1;
    }

    public void setTableColumnDescripcionParametro1(TableColumn component) {
        this.tableColumnDescripcionParametro1 = component;
    }
    ...
    private TableColumn tableColumnNumeroTipoDatoPar1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnNumeroTipoDatoPar1() {
        return tableColumnNumeroTipoDatoPar1;
    }

    public void setTableColumnNumeroTipoDatoPar1(TableColumn component) {
        this.tableColumnNumeroTipoDatoPar1 = component;
    }
    ...
    private TableColumn tableColumnAliasParametro1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnAliasParametro1() {
        return tableColumnAliasParametro1;
    }

    public void setTableColumnAliasParametro1(TableColumn component) {
        this.tableColumnAliasParametro1 = component;
    }
...
/**/
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("Parametro1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("Parametro1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("Parametro1_ETIQUETA_CLASE_MAESTRO");
    ...
    public void consultar(Long filtro) {
        try {
            this.getParametroDataProvider().consultarParametro(filtro);
        } catch (Exception ex) {
