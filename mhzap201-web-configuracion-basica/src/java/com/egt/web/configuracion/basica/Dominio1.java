...
public class Dominio1 extends AbstractPageBean
        implements PaginaActualizacionDominio, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla {
    ...
    private ImageHyperlink campoIdClaseRecurso1Hiper1 = new com.egt.core.jsf.component.HipervinculoVerDetalle();

    public ImageHyperlink getCampoIdClaseRecurso1Hiper1() {
        return campoIdClaseRecurso1Hiper1;
    }

    public void setCampoIdClaseRecurso1Hiper1(ImageHyperlink component) {
        this.campoIdClaseRecurso1Hiper1 = component;
    }
...
/**/
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("Dominio1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("Dominio1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("Dominio1_ETIQUETA_CLASE_MAESTRO");
