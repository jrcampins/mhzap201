...
public class OpcionMenu3 extends AbstractPageBean
...
/**/
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("OpcionMenu3_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("OpcionMenu3_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("OpcionMenu3_ETIQUETA_CLASE_MAESTRO");
    ...
    public Option[] getOpcionesListaFuncionEdicion() {
        return new Option[]{ //
                ...
                // new Option(OpcionMenuCachedRowSetDataProvider3.FUNCION_DESACTIVAR_OPCION_MENU, BundleWebui.getString("desactivar")),
                // new Option(OpcionMenuCachedRowSetDataProvider3.FUNCION_REACTIVAR_OPCION_MENU, BundleWebui.getString("reactivar"))
                };
    }
...
//          new Option(OpcionMenuCachedRowSetDataProvider3.FUNCION_PROCESAR_OPCION_MENU, BundleWebui.getString("procesar"))
//      };
//      return this.getGestor().getOpcionesListaFuncionAccionAutorizadas(opciones);
    ...
    public void consultar(Long filtro) {
        try {
            this.getOpcionMenuDataProvider().setLimiteFilasFuncionSelect(500);
