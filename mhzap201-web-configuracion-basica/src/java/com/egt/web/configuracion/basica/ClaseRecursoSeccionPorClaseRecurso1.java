...
public class ClaseRecursoSeccionPorClaseRecurso1 extends AbstractPageBean
        implements PaginaActualizacionClaseRecursoSecPorClaseRecurso, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla, PaginaConsultaConMaestro {
    ...
    private TableColumn tableColumnEtiquetaClaseRecursoSec1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnEtiquetaClaseRecursoSec1() {
        return tableColumnEtiquetaClaseRecursoSec1;
    }

    public void setTableColumnEtiquetaClaseRecursoSec1(TableColumn component) {
        this.tableColumnEtiquetaClaseRecursoSec1 = component;
    }
    ...
    private TableColumn tableColumnDescripcionClaseRecursoSec1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnDescripcionClaseRecursoSec1() {
        return tableColumnDescripcionClaseRecursoSec1;
    }

    public void setTableColumnDescripcionClaseRecursoSec1(TableColumn component) {
        this.tableColumnDescripcionClaseRecursoSec1 = component;
    }
    ...
    private TableColumn tableColumnEsPestanaDetalle1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnEsPestanaDetalle1() {
        return tableColumnEsPestanaDetalle1;
    }

    public void setTableColumnEsPestanaDetalle1(TableColumn component) {
        this.tableColumnEsPestanaDetalle1 = component;
    }
    ...
    // </editor-fold>
/**/
    public ClaseRecursoSeccionPorClaseRecurso1() {
    }
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("ClaseRecursoSeccionPorClaseRecurso1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("ClaseRecursoSeccionPorClaseRecurso1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("ClaseRecursoSeccionPorClaseRecurso1_ETIQUETA_CLASE_MAESTRO");
    ...
    public void consultar(Long filtro) {
        try {
            this.getClaseRecursoSecDataProvider().consultarClaseRecursoSec(filtro);
        } catch (Exception ex) {
