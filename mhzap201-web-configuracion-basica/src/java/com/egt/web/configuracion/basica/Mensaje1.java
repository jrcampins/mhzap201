...
public class Mensaje1 extends AbstractPageBean
        implements PaginaActualizacionMensaje, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla {
    ...
    private TableColumn tableColumnIdMensaje1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdMensaje1() {
        return tableColumnIdMensaje1;
    }

    public void setTableColumnIdMensaje1(TableColumn component) {
        this.tableColumnIdMensaje1 = component;
    }
    ...
    private TableColumn tableColumnCodigoMensaje1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnCodigoMensaje1() {
        return tableColumnCodigoMensaje1;
    }

    public void setTableColumnCodigoMensaje1(TableColumn component) {
        this.tableColumnCodigoMensaje1 = component;
    }
    ...
    private TableColumn tableColumnPatronMensaje1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnPatronMensaje1() {
        return tableColumnPatronMensaje1;
    }

    public void setTableColumnPatronMensaje1(TableColumn component) {
        this.tableColumnPatronMensaje1 = component;
    }
    ...
    private TableColumn tableColumnDescripcionMensaje1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnDescripcionMensaje1() {
        return tableColumnDescripcionMensaje1;
    }

    public void setTableColumnDescripcionMensaje1(TableColumn component) {
        this.tableColumnDescripcionMensaje1 = component;
    }
...
/**/
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("Mensaje1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("Mensaje1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("Mensaje1_ETIQUETA_CLASE_MAESTRO");
    ...
    public void consultar(Long filtro) {
        try {
            this.getMensajeDataProvider().consultarMensaje(filtro);
        } catch (Exception ex) {
