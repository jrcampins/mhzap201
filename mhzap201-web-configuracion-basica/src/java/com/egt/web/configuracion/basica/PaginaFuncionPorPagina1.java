...
public class PaginaFuncionPorPagina1 extends AbstractPageBean
        implements PaginaActualizacionPaginaFuncionPorPagina, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla, PaginaConsultaConMaestro {
    ...
    private TableColumn tableColumnIdPaginaFuncion1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdPaginaFuncion1() {
        return tableColumnIdPaginaFuncion1;
    }

    public void setTableColumnIdPaginaFuncion1(TableColumn component) {
        this.tableColumnIdPaginaFuncion1 = component;
    }
    ...
    private TableColumn tableColumnEsFuncionInicial1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnEsFuncionInicial1() {
        return tableColumnEsFuncionInicial1;
    }

    public void setTableColumnEsFuncionInicial1(TableColumn component) {
        this.tableColumnEsFuncionInicial1 = component;
    }
    ...
    private TableColumn tableColumnControlPaginaFuncion1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnControlPaginaFuncion1() {
        return tableColumnControlPaginaFuncion1;
    }

    public void setTableColumnControlPaginaFuncion1(TableColumn component) {
        this.tableColumnControlPaginaFuncion1 = component;
    }
    ...
    // </editor-fold>
/**/
    public PaginaFuncionPorPagina1() {
    }
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("PaginaFuncionPorPagina1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("PaginaFuncionPorPagina1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("PaginaFuncionPorPagina1_ETIQUETA_CLASE_MAESTRO");
    ...
    public void consultar(Long filtro) {
        try {
            this.getPaginaFuncionDataProvider().consultarPaginaFuncion(filtro);
        } catch (Exception ex) {
