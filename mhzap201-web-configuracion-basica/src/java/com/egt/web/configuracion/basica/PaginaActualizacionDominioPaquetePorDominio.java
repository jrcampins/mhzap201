...
public interface PaginaActualizacionDominioPaquetePorDominio extends PaginaActualizacion {

    TextField getCampoIdDominioPaquete1();

    TextField getCampoIdPaquete1();

    Button getBotonAplicar1();

    DominioPaqueteCachedRowSetDataProvider2 getDominioPaqueteDataProvider();
