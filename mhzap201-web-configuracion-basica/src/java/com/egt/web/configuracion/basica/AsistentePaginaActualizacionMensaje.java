...
public class AsistentePaginaActualizacionMensaje {

    private PaginaActualizacionMensaje bean;

    public AsistentePaginaActualizacionMensaje() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionMensaje(PaginaActualizacionMensaje bean) {
        this.bean = bean;
    }
    ...
    public Option[] getOpcionesListaFuncionEdicion() {
        ...
        return new Option[]{ //
                ...
                //  new Option(MensajeCachedRowSetDataProvider2.FUNCION_MODIFICAR_MENSAJE, BundleWebui.getString("editar"))
                };
    }
    ...
    public boolean isGridIdMensajeRendered() {
        return true;
    }

    public boolean isGridCodigoMensajeRendered() {
        return true;
    }

    public boolean isGridPatronMensajeRendered() {
        return true;
    }

    public boolean isGridDescripcionMensajeRendered() {
        return true;
    }
