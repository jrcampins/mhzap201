...
import com.egt.data.general.xdp2.FiltroClaRecParCachedRowSetDataProvider2;
...
public class FiltroClaseRecursoParametroPorClaseRecursoParametro1 extends AbstractPageBean
        implements PaginaActualizacionFiltroClaRecParPorClaseRecursoPar, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla, PaginaConsultaConMaestro {

    // <editor-fold defaultstate="collapsed" desc="Managed Component Definition">
    private void _init() throws Exception {
        textoFilasPorPagina1Validator1.setMinimum(1L);
        textoFilasPorPagina1Validator1.setMaximum(50L);
        validatorIdFiltroClaRecPar1.setMinimum(0L);
        validatorIdFiltroClaRecPar1.setMaximum(1000000000000000000L);
        validatorValor1.setMaximum(8160);
        filtroClaRecParDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.filtroClaRecParRowSet}"));
    ...
    private TableColumn tableColumnIdFiltroClaRecPar1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdFiltroClaRecPar1() {
        return tableColumnIdFiltroClaRecPar1;
    }

    public void setTableColumnIdFiltroClaRecPar1(TableColumn component) {
        this.tableColumnIdFiltroClaRecPar1 = component;
    }

    private Label labelIdFiltroClaRecPar1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelIdFiltroClaRecPar1() {
        return labelIdFiltroClaRecPar1;
    }

    public void setLabelIdFiltroClaRecPar1(Label l) {
        this.labelIdFiltroClaRecPar1 = l;
    }

    private TextField campoIdFiltroClaRecPar1 = new com.egt.core.jsf.component.CampoTexto();

    @Override
    public TextField getCampoIdFiltroClaRecPar1() {
        return campoIdFiltroClaRecPar1;
    }

    public void setCampoIdFiltroClaRecPar1(TextField component) {
        this.campoIdFiltroClaRecPar1 = component;
    }

    private StaticText campoIdFiltroClaRecPar1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoIdFiltroClaRecPar1Texto1() {
        return campoIdFiltroClaRecPar1Texto1;
    }

    public void setCampoIdFiltroClaRecPar1Texto1(StaticText component) {
        this.campoIdFiltroClaRecPar1Texto1 = component;
    }

    private LongConverter converterIdFiltroClaRecPar1 = new LongConverter();
  
    public LongConverter getConverterIdFiltroClaRecPar1() {
        return converterIdFiltroClaRecPar1;
    }
  
    public void setConverterIdFiltroClaRecPar1(LongConverter converter) {
        this.converterIdFiltroClaRecPar1 = converter;
    }
  
    private LongRangeValidator validatorIdFiltroClaRecPar1 = new LongRangeValidator();
  
    public LongRangeValidator getValidatorIdFiltroClaRecPar1() {
        return validatorIdFiltroClaRecPar1;
    }
  
    public void setValidatorIdFiltroClaRecPar1(LongRangeValidator validator) {
        this.validatorIdFiltroClaRecPar1 = validator;
    }
    ...
    private FiltroClaRecParCachedRowSetDataProvider2 filtroClaRecParDataProvider = new FiltroClaRecParCachedRowSetDataProvider2();

    @Override
    public FiltroClaRecParCachedRowSetDataProvider2 getFiltroClaRecParDataProvider() {
        return filtroClaRecParDataProvider;
    }

    public void setFiltroClaRecParDataProvider(FiltroClaRecParCachedRowSetDataProvider2 crsdp) {
        this.filtroClaRecParDataProvider = crsdp;
    }
    ...
    // </editor-fold>
/**/
    public FiltroClaseRecursoParametroPorClaseRecursoParametro1() {
    }
    ...
    @PreDestroy
    public void destroy() {
        filtroClaRecParDataProvider.close();
    ...
    // <editor-fold defaultstate="collapsed" desc="implementacion estandar de propiedades tipo fecha de la interfaz PaginaActualizacionFiltroClaRecPar...">
    // </editor-fold>
    ...
    private AsistentePaginaActualizacionFiltroClaRecParPorClaseRecursoPar asistente = new AsistentePaginaActualizacionFiltroClaRecParPorClaseRecursoPar(this);

    public AsistentePaginaActualizacionFiltroClaRecParPorClaseRecursoPar getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("FiltroClaseRecursoParametroPorClaseRecursoParametro1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("FiltroClaseRecursoParametroPorClaseRecursoParametro1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("FiltroClaseRecursoParametroPorClaseRecursoParametro1_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getFiltroClaRecParDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return FiltroClaRecParCachedRowSetDataProvider2.FUNCION_CONSULTAR_FILTRO_CLA_REC_PAR;
    }

    @Override
    public long getFuncionCrearRecurso() {
        return FiltroClaRecParCachedRowSetDataProvider2.FUNCION_CREAR_FILTRO_CLA_REC_PAR;
    }

    @Override
    public long getFuncionModificarRecurso() {
        return FiltroClaRecParCachedRowSetDataProvider2.FUNCION_MODIFICAR_FILTRO_CLA_REC_PAR;
    }

    @Override
    public long getFuncionEliminarRecurso() {
        return FiltroClaRecParCachedRowSetDataProvider2.FUNCION_ELIMINAR_FILTRO_CLA_REC_PAR;
    }
    ...
    public String getColumnaIdentificacionRecursoMaestro() {
        return FiltroClaRecParCachedRowSetDataProvider2.COLUMNA_ID_CLASE_RECURSO_PAR;
    }
...
//      String urx = URX2.DETALLE_FILTRO_CLA_REC_PAR;
//      return this.getGestor().getScriptAbrirVentanaVerDetalle(urx);
    ...
    public void consultar(Long filtro) {
        try {
            this.getFiltroClaRecParDataProvider().consultarFiltroClaRecPar(filtro);
        } catch (Exception ex) {
