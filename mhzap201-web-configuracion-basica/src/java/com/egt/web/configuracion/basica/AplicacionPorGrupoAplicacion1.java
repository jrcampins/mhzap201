...
public class AplicacionPorGrupoAplicacion1 extends AbstractPageBean
        implements PaginaActualizacionAplicacionPorGrupoAplicacion, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla, PaginaConsultaConMaestro {
    ...
    // </editor-fold>
/**/
    public AplicacionPorGrupoAplicacion1() {
    }
    ...
    private AsistentePaginaActualizacionAplicacionPorGrupoAplicacion asistente = new AsistentePaginaActualizacionAplicacionPorGrupoAplicacion(this);

    public AsistentePaginaActualizacionAplicacionPorGrupoAplicacion getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("AplicacionPorGrupoAplicacion1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("AplicacionPorGrupoAplicacion1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("AplicacionPorGrupoAplicacion1_ETIQUETA_CLASE_MAESTRO");
    ...
    public String getColumnaIdentificacionRecursoMaestro() {
        return AplicacionCachedRowSetDataProvider2.COLUMNA_ID_GRUPO_APLICACION;
    }
