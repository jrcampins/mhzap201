...
public class RolAplicacionPorAplicacion1 extends AbstractPageBean
        implements PaginaActualizacionRolAplicacionPorAplicacion, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla, PaginaConsultaConMaestro {

    // <editor-fold defaultstate="collapsed" desc="Managed Component Definition">
    private void _init() throws Exception {
        textoFilasPorPagina1Validator1.setMinimum(1L);
        textoFilasPorPagina1Validator1.setMaximum(50L);
        validatorIdRolAplicacion1.setMinimum(0L);
        validatorIdRolAplicacion1.setMaximum(1000000000000000000L);
        rolAplicacionDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.rolAplicacionRowSet}"));
        aplicacionDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.aplicacionRowSet}"));
        rolReferenceDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.rolReferenceRowSet}"));
    }
    ...
    private TableColumn tableColumnIdRolAplicacion1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdRolAplicacion1() {
        return tableColumnIdRolAplicacion1;
    }

    public void setTableColumnIdRolAplicacion1(TableColumn component) {
        this.tableColumnIdRolAplicacion1 = component;
    }

    private Label labelIdRolAplicacion1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelIdRolAplicacion1() {
        return labelIdRolAplicacion1;
    }

    public void setLabelIdRolAplicacion1(Label l) {
        this.labelIdRolAplicacion1 = l;
    }

    private TextField campoIdRolAplicacion1 = new com.egt.core.jsf.component.CampoTexto();

    @Override
    public TextField getCampoIdRolAplicacion1() {
        return campoIdRolAplicacion1;
    }

    public void setCampoIdRolAplicacion1(TextField component) {
        this.campoIdRolAplicacion1 = component;
    }

    private StaticText campoIdRolAplicacion1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoIdRolAplicacion1Texto1() {
        return campoIdRolAplicacion1Texto1;
    }

    public void setCampoIdRolAplicacion1Texto1(StaticText component) {
        this.campoIdRolAplicacion1Texto1 = component;
    }

    private LongConverter converterIdRolAplicacion1 = new LongConverter();
  
    public LongConverter getConverterIdRolAplicacion1() {
        return converterIdRolAplicacion1;
    }
  
    public void setConverterIdRolAplicacion1(LongConverter converter) {
        this.converterIdRolAplicacion1 = converter;
    }
  
    private LongRangeValidator validatorIdRolAplicacion1 = new LongRangeValidator();
  
    public LongRangeValidator getValidatorIdRolAplicacion1() {
        return validatorIdRolAplicacion1;
    }
  
    public void setValidatorIdRolAplicacion1(LongRangeValidator validator) {
        this.validatorIdRolAplicacion1 = validator;
    }
  
    private TableColumn tableColumnIdRol1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdRol1() {
        return tableColumnIdRol1;
    }

    public void setTableColumnIdRol1(TableColumn component) {
        this.tableColumnIdRol1 = component;
    }
    ...
    private TableColumn tableColumnIdRol2 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdRol2() {
        return tableColumnIdRol2;
    }

    public void setTableColumnIdRol2(TableColumn component) {
        this.tableColumnIdRol2 = component;
    }
    ...
    private ImageHyperlink campoIdRol1Hiper1 = new com.egt.core.jsf.component.HipervinculoVerDetalle();

    public ImageHyperlink getCampoIdRol1Hiper1() {
        return campoIdRol1Hiper1;
    }

    public void setCampoIdRol1Hiper1(ImageHyperlink component) {
        this.campoIdRol1Hiper1 = component;
    }
    ...
    private RolAplicacionCachedRowSetDataProvider2 rolAplicacionDataProvider = new RolAplicacionCachedRowSetDataProvider2();

    @Override
    public RolAplicacionCachedRowSetDataProvider2 getRolAplicacionDataProvider() {
        return rolAplicacionDataProvider;
    }

    public void setRolAplicacionDataProvider(RolAplicacionCachedRowSetDataProvider2 crsdp) {
        this.rolAplicacionDataProvider = crsdp;
    }
    ...
    private RolCachedRowSetDataProvider2 rolReferenceDataProvider = new RolCachedRowSetDataProvider2();

    @Override
    public RolCachedRowSetDataProvider2 getRolReferenceDataProvider() {
        return rolReferenceDataProvider;
    }

    public void setRolReferenceDataProvider(RolCachedRowSetDataProvider2 crsdp) {
        this.rolReferenceDataProvider = crsdp;
    }

    // </editor-fold>
/**/
    public RolAplicacionPorAplicacion1() {
    }
    ...
    //@PreDestroy
    public void destroy() {
        rolAplicacionDataProvider.close();
        aplicacionDataProvider.close();
        rolReferenceDataProvider.close();
    }
    // </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="implementacion estandar de propiedades tipo fecha de la interfaz PaginaActualizacionRolAplicacion...">
    // </editor-fold>
    ...
    private AsistentePaginaActualizacionRolAplicacionPorAplicacion asistente = new AsistentePaginaActualizacionRolAplicacionPorAplicacion(this);

    public AsistentePaginaActualizacionRolAplicacionPorAplicacion getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("RolAplicacionPorAplicacion1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("RolAplicacionPorAplicacion1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("RolAplicacionPorAplicacion1_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getRolAplicacionDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return RolAplicacionCachedRowSetDataProvider2.FUNCION_CONSULTAR_ROL_APLICACION;
    }

    @Override
    public long getFuncionCrearRecurso() {
        return RolAplicacionCachedRowSetDataProvider2.FUNCION_CREAR_ROL_APLICACION;
    }

    @Override
    public long getFuncionModificarRecurso() {
        return RolAplicacionCachedRowSetDataProvider2.FUNCION_MODIFICAR_ROL_APLICACION;
    }

    @Override
    public long getFuncionEliminarRecurso() {
        return RolAplicacionCachedRowSetDataProvider2.FUNCION_ELIMINAR_ROL_APLICACION;
    }
    ...
    public String getColumnaIdentificacionRecursoMaestro() {
        return RolAplicacionCachedRowSetDataProvider2.COLUMNA_ID_APLICACION;
    }
...
//      String urx = URX2.DETALLE_ROL_APLICACION;
//      return this.getGestor().getScriptAbrirVentanaVerDetalle(urx);
    ...
    public void consultar(Long filtro) {
        try {
            this.getRolAplicacionDataProvider().consultarRolAplicacion(filtro);
        } catch (Exception ex) {
    ...
    public void campoIdRol1_validate(FacesContext context, UIComponent component, Object value) {
        this.getAsistente().campoIdRol1_validate(context, component, value);
    }
