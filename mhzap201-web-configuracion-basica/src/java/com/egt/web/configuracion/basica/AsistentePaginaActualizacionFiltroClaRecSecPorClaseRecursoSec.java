...
public class AsistentePaginaActualizacionFiltroClaRecSecPorClaseRecursoSec {

    private PaginaActualizacionFiltroClaRecSecPorClaseRecursoSec bean;

    public AsistentePaginaActualizacionFiltroClaRecSecPorClaseRecursoSec() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionFiltroClaRecSecPorClaseRecursoSec(PaginaActualizacionFiltroClaRecSecPorClaseRecursoSec bean) {
        this.bean = bean;
    }
    ...
    public Option[] getOpcionesListaFuncionEdicion() {
        ...
        return new Option[]{ //
                ...
                //  new Option(FiltroClaRecSecCachedRowSetDataProvider2.FUNCION_MODIFICAR_FILTRO_CLA_REC_SEC, BundleWebui.getString("editar"))
                };
    }
    ...
    protected GestorBusquedaReferencia getGestorBusquedaIdClaseRecursoParColumna() {
        if (this.gestorBusquedaIdClaseRecursoParColumna == null) {
            this.gestorBusquedaIdClaseRecursoParColumna = new GestorBusquedaReferencia(
                    bean.getFiltroClaRecSecDataProvider(),
                    bean.getClaseRecursoParReferenceDataProvider(),
                    FiltroClaRecSecCachedRowSetDataProvider2.COLUMNA_ID_CLASE_RECURSO_PAR_COLUMNA,
    ...
    public String getTextoCampoIdClaseRecursoParColumna1() {
        ...
        if (bean.getGestor().isFilaNoProcesada()) {
            return STP.getString(bean.getFiltroClaRecSecDataProvider().getIdClaseRecursoParColumna(rowKey));
        }
        this.getGestorBusquedaIdClaseRecursoParColumna().setFiltroBusqueda(this.getFiltroBusquedaIdClaseRecursoParColumna());
...
//      Long id = bean.getFiltroClaRecSecDataProvider().getIdClaseRecursoParColumna(rowKey);
//      return bean.getGestor().getScriptAbrirVentanaVerDetalle(urx, id);
    ...
    protected GestorBusquedaReferencia getGestorBusquedaIdClaseRecursoParValor() {
        if (this.gestorBusquedaIdClaseRecursoParValor == null) {
            this.gestorBusquedaIdClaseRecursoParValor = new GestorBusquedaReferencia(
                    bean.getFiltroClaRecSecDataProvider(),
                    bean.getClaseRecursoParReferenceDataProvider(),
                    FiltroClaRecSecCachedRowSetDataProvider2.COLUMNA_ID_CLASE_RECURSO_PAR_VALOR,
    ...
    public String getTextoCampoIdClaseRecursoParValor1() {
        ...
        RowKey rowKey = bean.getGestor().getCurrentRowKey();
        if (bean.getGestor().isFilaNoProcesada()) {
            return STP.getString(bean.getFiltroClaRecSecDataProvider().getIdClaseRecursoParValor(rowKey));
        }
        this.getGestorBusquedaIdClaseRecursoParValor().setFiltroBusqueda(this.getFiltroBusquedaIdClaseRecursoParValor());
...
//      RowKey rowKey = bean.getGestor().getCurrentRowKey();
//      String urx = URX2.DETALLE_CLASE_RECURSO_PAR;
//      Long id = bean.getFiltroClaRecSecDataProvider().getIdClaseRecursoParValor(rowKey);
//      return bean.getGestor().getScriptAbrirVentanaVerDetalle(urx, id);
        return null;
    }
    ...
    public boolean isNullNumeroOperadorCom() {
        ...
        RowKey rowKey = bean.getGestor().getCurrentRowKey();
        Integer value = bean.getFiltroClaRecSecDataProvider().getNumeroOperadorCom(rowKey);
        return value == null;
    }
    ...
    public boolean isGridIdFiltroClaRecSecRendered() {
        return true;
    }
