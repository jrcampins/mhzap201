...
public class AsistentePaginaActualizacionFuncion {

    private PaginaActualizacionFuncion bean;

    public AsistentePaginaActualizacionFuncion() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionFuncion(PaginaActualizacionFuncion bean) {
        this.bean = bean;
    }
    ...
    protected GestorBusquedaReferencia getGestorBusquedaIdDominio() {
        if (this.gestorBusquedaIdDominio == null) {
            this.gestorBusquedaIdDominio = new GestorBusquedaReferencia(
                    ...
                    FuncionCachedRowSetDataProvider2.COLUMNA_ID_DOMINIO,
    ...
    public String getTextoCampoIdDominio1() {
        ...
        if (bean.getGestor().isFilaNoProcesada()) {
            return STP.getString(bean.getFuncionDataProvider().getIdDominio(rowKey));
        }
        this.getGestorBusquedaIdDominio().setFiltroBusqueda(this.getFiltroBusquedaIdDominio());
...
//      Long id = bean.getFuncionDataProvider().getIdDominio(rowKey);
