...
public class AsistentePaginaActualizacionDominioPorClaseRecurso {

    private PaginaActualizacionDominioPorClaseRecurso bean;

    public AsistentePaginaActualizacionDominioPorClaseRecurso() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionDominioPorClaseRecurso(PaginaActualizacionDominioPorClaseRecurso bean) {
        this.bean = bean;
    }
