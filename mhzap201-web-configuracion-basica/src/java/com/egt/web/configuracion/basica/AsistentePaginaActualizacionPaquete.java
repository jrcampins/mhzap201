...
public class AsistentePaginaActualizacionPaquete {

    private PaginaActualizacionPaquete bean;

    public AsistentePaginaActualizacionPaquete() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionPaquete(PaginaActualizacionPaquete bean) {
        this.bean = bean;
    }
    ...
    public Option[] getOpcionesListaFuncionEdicion() {
        ...
        return new Option[]{ //
                ...
                //  new Option(PaqueteCachedRowSetDataProvider2.FUNCION_MODIFICAR_PAQUETE, BundleWebui.getString("editar"))
                };
    }
    ...
    public boolean isGridCodigoPaqueteRendered() {
        return true;
    }
