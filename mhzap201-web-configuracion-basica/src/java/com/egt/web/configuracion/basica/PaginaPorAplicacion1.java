...
public class PaginaPorAplicacion1 extends AbstractPageBean
        implements PaginaActualizacionPaginaPorAplicacion, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla, PaginaConsultaConMaestro {
...
/**/
    ...
    private AsistentePaginaActualizacionPaginaPorAplicacion asistente = new AsistentePaginaActualizacionPaginaPorAplicacion(this);

    public AsistentePaginaActualizacionPaginaPorAplicacion getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("PaginaPorAplicacion1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("PaginaPorAplicacion1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("PaginaPorAplicacion1_ETIQUETA_CLASE_MAESTRO");
    ...
    public String getColumnaIdentificacionRecursoMaestro() {
        return PaginaCachedRowSetDataProvider2.COLUMNA_ID_APLICACION;
    }
