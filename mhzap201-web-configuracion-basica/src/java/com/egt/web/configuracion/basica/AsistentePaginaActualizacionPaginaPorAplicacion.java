...
public class AsistentePaginaActualizacionPaginaPorAplicacion {

    private PaginaActualizacionPaginaPorAplicacion bean;

    public AsistentePaginaActualizacionPaginaPorAplicacion() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionPaginaPorAplicacion(PaginaActualizacionPaginaPorAplicacion bean) {
        this.bean = bean;
    }
