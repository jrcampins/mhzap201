...
public class LogImpJubConstants {

    public static final String CODIGO_DOMINIO_RECURSO = "log_imp_jub";

    public static final String NOMBRE_DOMINIO_RECURSO = "Rastros de Importaci\u00F3n de Jubilados y Pensionados";
    ...
    public static final long FUNCION_CONSULTAR_LOG_IMP_JUB = 330500101L;
