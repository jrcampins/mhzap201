...
import com.egt.data.specific.xdp2.TipoAreaCachedRowSetDataProvider2;
...
public class TipoArea1 extends AbstractPageBean
        implements PaginaActualizacionTipoArea, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla {

    // <editor-fold defaultstate="collapsed" desc="Managed Component Definition">
    private void _init() throws Exception {
        textoFilasPorPagina1Validator1.setMinimum(1L);
        textoFilasPorPagina1Validator1.setMaximum(50L);
        validatorNumeroTipoArea1.setMinimum(0L);
        validatorNumeroTipoArea1.setMaximum(1000000000L);
        validatorCodigoTipoArea1.setMaximum(30);
        ...
        tipoAreaDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.tipoAreaRowSet}"));
    }
    ...
    private TextField campoNumeroTipoArea1 = new com.egt.core.jsf.component.CampoTexto();

    @Override
    public TextField getCampoNumeroTipoArea1() {
        return campoNumeroTipoArea1;
    }

    public void setCampoNumeroTipoArea1(TextField component) {
        this.campoNumeroTipoArea1 = component;
    }

    private StaticText campoNumeroTipoArea1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoNumeroTipoArea1Texto1() {
        return campoNumeroTipoArea1Texto1;
    }

    public void setCampoNumeroTipoArea1Texto1(StaticText component) {
        this.campoNumeroTipoArea1Texto1 = component;
    }
    ...
    private LongRangeValidator validatorNumeroTipoArea1 = new LongRangeValidator();
  
    public LongRangeValidator getValidatorNumeroTipoArea1() {
        return validatorNumeroTipoArea1;
    }
  
    public void setValidatorNumeroTipoArea1(LongRangeValidator validator) {
        this.validatorNumeroTipoArea1 = validator;
    }
  
    private TableColumn tableColumnCodigoTipoArea1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnCodigoTipoArea1() {
        return tableColumnCodigoTipoArea1;
    }

    public void setTableColumnCodigoTipoArea1(TableColumn component) {
        this.tableColumnCodigoTipoArea1 = component;
    }

    private Label labelCodigoTipoArea1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelCodigoTipoArea1() {
        return labelCodigoTipoArea1;
    }

    public void setLabelCodigoTipoArea1(Label l) {
        this.labelCodigoTipoArea1 = l;
    }

    private TextField campoCodigoTipoArea1 = new com.egt.core.jsf.component.CampoTexto();

    @Override
    public TextField getCampoCodigoTipoArea1() {
        return campoCodigoTipoArea1;
    }

    public void setCampoCodigoTipoArea1(TextField component) {
        this.campoCodigoTipoArea1 = component;
    }

    private StaticText campoCodigoTipoArea1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoCodigoTipoArea1Texto1() {
        return campoCodigoTipoArea1Texto1;
    }

    public void setCampoCodigoTipoArea1Texto1(StaticText component) {
        this.campoCodigoTipoArea1Texto1 = component;
    }

    private LengthValidator validatorCodigoTipoArea1 = new LengthValidator();
  
    public LengthValidator getValidatorCodigoTipoArea1() {
        return validatorCodigoTipoArea1;
    }
  
    public void setValidatorCodigoTipoArea1(LengthValidator validator) {
        this.validatorCodigoTipoArea1 = validator;
    }
    ...
    private TipoAreaCachedRowSetDataProvider2 tipoAreaDataProvider = new TipoAreaCachedRowSetDataProvider2();

    @Override
    public TipoAreaCachedRowSetDataProvider2 getTipoAreaDataProvider() {
        return tipoAreaDataProvider;
    }

    public void setTipoAreaDataProvider(TipoAreaCachedRowSetDataProvider2 crsdp) {
        this.tipoAreaDataProvider = crsdp;
    }
...
/**/
    ...
    // <editor-fold defaultstate="collapsed" desc="implementacion estandar de propiedades tipo fecha de la interfaz PaginaActualizacionTipoArea...">
    // </editor-fold>
    ...
    private AsistentePaginaActualizacionTipoArea asistente = new AsistentePaginaActualizacionTipoArea(this);

    public AsistentePaginaActualizacionTipoArea getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("TipoArea1_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("TipoArea1_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("TipoArea1_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getTipoAreaDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return TipoAreaCachedRowSetDataProvider2.FUNCION_CONSULTAR_TIPO_AREA;
    }
...
//      String urx = URX2.DETALLE_TIPO_AREA;
//      return this.getGestor().getScriptAbrirVentanaVerDetalle(urx);
    ...
    public void consultar(Long filtro) {
        try {
            this.getTipoAreaDataProvider().consultarTipoArea(filtro);
        } catch (Exception ex) {
