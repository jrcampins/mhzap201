...
public class AsistentePaginaActualizacionTipoArea {

    private PaginaActualizacionTipoArea bean;

    public AsistentePaginaActualizacionTipoArea() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionTipoArea(PaginaActualizacionTipoArea bean) {
        this.bean = bean;
    }
    ...
    public Option[] getOpcionesListaFuncionEdicion() {
        ...
        return new Option[]{ //
                ...
                //  new Option(TipoAreaCachedRowSetDataProvider2.FUNCION_MODIFICAR_TIPO_AREA, BundleWebui.getString("editar"))
                };
    }
    ...
    public boolean isGridCodigoTipoAreaRendered() {
        return true;
    }
