...
import com.egt.data.specific.xdp2.LogImpJubCachedRowSetDataProvider2;
...
public class LogImpJub5 extends AbstractPageBean
        implements PaginaActualizacionLogImpJub, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla {

    // <editor-fold defaultstate="collapsed" desc="Managed Component Definition">
    private void _init() throws Exception {
        textoFilasPorPagina1Validator1.setMinimum(1L);
        textoFilasPorPagina1Validator1.setMaximum(50L);
        validatorIdLogImpJub1.setMinimum(0L);
        validatorIdLogImpJub1.setMaximum(1000000000000000000L);
        ...
        validatorTipoRegistro1.setMaximum(8160);
        ...
        logImpJubDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.logImpJubRowSet}"));
    }
    ...
    private TableColumn tableColumnIdLogImpJub1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdLogImpJub1() {
        return tableColumnIdLogImpJub1;
    }

    public void setTableColumnIdLogImpJub1(TableColumn component) {
        this.tableColumnIdLogImpJub1 = component;
    }

    private Label labelIdLogImpJub1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelIdLogImpJub1() {
        return labelIdLogImpJub1;
    }

    public void setLabelIdLogImpJub1(Label l) {
        this.labelIdLogImpJub1 = l;
    }

    private TextField campoIdLogImpJub1 = new com.egt.core.jsf.component.CampoTexto();

    @Override
    public TextField getCampoIdLogImpJub1() {
        return campoIdLogImpJub1;
    }

    public void setCampoIdLogImpJub1(TextField component) {
        this.campoIdLogImpJub1 = component;
    }

    private StaticText campoIdLogImpJub1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoIdLogImpJub1Texto1() {
        return campoIdLogImpJub1Texto1;
    }

    public void setCampoIdLogImpJub1Texto1(StaticText component) {
        this.campoIdLogImpJub1Texto1 = component;
    }

    private LongConverter converterIdLogImpJub1 = new LongConverter();
  
    public LongConverter getConverterIdLogImpJub1() {
        return converterIdLogImpJub1;
    }
  
    public void setConverterIdLogImpJub1(LongConverter converter) {
        this.converterIdLogImpJub1 = converter;
    }
  
    private LongRangeValidator validatorIdLogImpJub1 = new LongRangeValidator();
  
    public LongRangeValidator getValidatorIdLogImpJub1() {
        return validatorIdLogImpJub1;
    }
  
    public void setValidatorIdLogImpJub1(LongRangeValidator validator) {
        this.validatorIdLogImpJub1 = validator;
    }
    ...
    private TableColumn tableColumnTipoRegistro1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnTipoRegistro1() {
        return tableColumnTipoRegistro1;
    }

    public void setTableColumnTipoRegistro1(TableColumn component) {
        this.tableColumnTipoRegistro1 = component;
    }

    private Label labelTipoRegistro1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelTipoRegistro1() {
        return labelTipoRegistro1;
    }

    public void setLabelTipoRegistro1(Label l) {
        this.labelTipoRegistro1 = l;
    }

    private TextArea campoTipoRegistro1 = new com.egt.core.jsf.component.AreaTexto();

    @Override
    public TextArea getCampoTipoRegistro1() {
        return campoTipoRegistro1;
    }

    public void setCampoTipoRegistro1(TextArea component) {
        this.campoTipoRegistro1 = component;
    }

    private StaticText campoTipoRegistro1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoTipoRegistro1Texto1() {
        return campoTipoRegistro1Texto1;
    }

    public void setCampoTipoRegistro1Texto1(StaticText component) {
        this.campoTipoRegistro1Texto1 = component;
    }

    private LengthValidator validatorTipoRegistro1 = new LengthValidator();
  
    public LengthValidator getValidatorTipoRegistro1() {
        return validatorTipoRegistro1;
    }
  
    public void setValidatorTipoRegistro1(LengthValidator validator) {
        this.validatorTipoRegistro1 = validator;
    }
    ...
    private LogImpJubCachedRowSetDataProvider2 logImpJubDataProvider = new LogImpJubCachedRowSetDataProvider2();

    @Override
    public LogImpJubCachedRowSetDataProvider2 getLogImpJubDataProvider() {
        return logImpJubDataProvider;
    }

    public void setLogImpJubDataProvider(LogImpJubCachedRowSetDataProvider2 crsdp) {
        this.logImpJubDataProvider = crsdp;
    }
...
/**/
    ...
    // <editor-fold defaultstate="collapsed" desc="implementacion estandar de propiedades tipo fecha de la interfaz PaginaActualizacionLogImpJub...">
    @Override
    ...
    private AsistentePaginaActualizacionLogImpJub asistente = new AsistentePaginaActualizacionLogImpJub(this);

    public AsistentePaginaActualizacionLogImpJub getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("LogImpJub5_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogImpJub5_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogImpJub5_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getLogImpJubDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return LogImpJubCachedRowSetDataProvider2.FUNCION_CONSULTAR_LOG_IMP_JUB;
    }
    ...
    public void consultar(Long filtro) {
        try {
            this.getLogImpJubDataProvider().consultarLogImpJub(filtro);
        } catch (Exception ex) {
