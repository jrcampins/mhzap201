...
public class LogProOtoPenApr5 extends AbstractPageBean
        implements PaginaActualizacionLogProOtoPenApr, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla {
    ...
    private TableColumn tableColumnIdLogProOtoPenApr1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdLogProOtoPenApr1() {
        return tableColumnIdLogProOtoPenApr1;
    }

    public void setTableColumnIdLogProOtoPenApr1(TableColumn component) {
        this.tableColumnIdLogProOtoPenApr1 = component;
    }
...
/**/
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("LogProOtoPenApr5_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogProOtoPenApr5_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogProOtoPenApr5_ETIQUETA_CLASE_MAESTRO");
    ...
    public void consultar(Long filtro) {
        try {
            this.getLogProOtoPenAprDataProvider().consultarLogProOtoPenApr(filtro);
        } catch (Exception ex) {
