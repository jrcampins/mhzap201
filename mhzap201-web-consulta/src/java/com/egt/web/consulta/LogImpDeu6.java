...
public class LogImpDeu6 extends AbstractPageBean
        implements PaginaActualizacionLogImpDeu, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple {
    ...
    private HelpInline helpInlineIdLogImpDeu1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineIdLogImpDeu1() {
        return helpInlineIdLogImpDeu1;
    }

    public void setHelpInlineIdLogImpDeu1(HelpInline hi) {
        this.helpInlineIdLogImpDeu1 = hi;
    }
...
/**/
    ...
    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogImpDeu6_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogImpDeu6_ETIQUETA_CLASE_MAESTRO");
