...
public class LogImpPen6 extends AbstractPageBean
        implements PaginaActualizacionLogImpPen, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple {
    ...
    private HelpInline helpInlineIdLogImpPen1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineIdLogImpPen1() {
        return helpInlineIdLogImpPen1;
    }

    public void setHelpInlineIdLogImpPen1(HelpInline hi) {
        this.helpInlineIdLogImpPen1 = hi;
    }
...
/**/
    ...
    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogImpPen6_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogImpPen6_ETIQUETA_CLASE_MAESTRO");
