...
public class AsistentePaginaActualizacionLogImpJub {

    private PaginaActualizacionLogImpJub bean;

    public AsistentePaginaActualizacionLogImpJub() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionLogImpJub(PaginaActualizacionLogImpJub bean) {
        this.bean = bean;
    }
    ...
    public String getTextCampoNombreArchivo1Boton3() {
        ...
        String nombre = bean.getLogImpJubDataProvider().getNombreArchivo(rowKey);
   ...
   public boolean isEsImportado() {
        ...
        RowKey rowKey = bean.getGestor().getCurrentRowKey();
        Integer value = bean.getLogImpJubDataProvider().getEsImportado(rowKey);
    ...
    public boolean isGridIdLogImpJubRendered() {
        return true;
    }
    ...
    public boolean isGridTipoRegistroRendered() {
        return true;
    }
