...
import com.egt.data.specific.xdp2.LogImpFalCachedRowSetDataProvider2;
...
public class LogImpFal5 extends AbstractPageBean
        implements PaginaActualizacionLogImpFal, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla {

    // <editor-fold defaultstate="collapsed" desc="Managed Component Definition">
    private void _init() throws Exception {
        textoFilasPorPagina1Validator1.setMinimum(1L);
        textoFilasPorPagina1Validator1.setMaximum(50L);
        validatorIdLogImpFal1.setMinimum(0L);
        validatorIdLogImpFal1.setMaximum(1000000000000000000L);
        ...
        validatorDefuncion1.setMaximum(8160);
        ...
        logImpFalDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.logImpFalRowSet}"));
    }
    ...
    private TableColumn tableColumnIdLogImpFal1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdLogImpFal1() {
        return tableColumnIdLogImpFal1;
    }

    public void setTableColumnIdLogImpFal1(TableColumn component) {
        this.tableColumnIdLogImpFal1 = component;
    }

    private Label labelIdLogImpFal1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelIdLogImpFal1() {
        return labelIdLogImpFal1;
    }

    public void setLabelIdLogImpFal1(Label l) {
        this.labelIdLogImpFal1 = l;
    }

    private TextField campoIdLogImpFal1 = new com.egt.core.jsf.component.CampoTexto();

    @Override
    public TextField getCampoIdLogImpFal1() {
        return campoIdLogImpFal1;
    }

    public void setCampoIdLogImpFal1(TextField component) {
        this.campoIdLogImpFal1 = component;
    }

    private StaticText campoIdLogImpFal1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoIdLogImpFal1Texto1() {
        return campoIdLogImpFal1Texto1;
    }

    public void setCampoIdLogImpFal1Texto1(StaticText component) {
        this.campoIdLogImpFal1Texto1 = component;
    }

    private LongConverter converterIdLogImpFal1 = new LongConverter();
  
    public LongConverter getConverterIdLogImpFal1() {
        return converterIdLogImpFal1;
    }
  
    public void setConverterIdLogImpFal1(LongConverter converter) {
        this.converterIdLogImpFal1 = converter;
    }
  
    private LongRangeValidator validatorIdLogImpFal1 = new LongRangeValidator();
  
    public LongRangeValidator getValidatorIdLogImpFal1() {
        return validatorIdLogImpFal1;
    }
  
    public void setValidatorIdLogImpFal1(LongRangeValidator validator) {
        this.validatorIdLogImpFal1 = validator;
    }
    ...
    private TableColumn tableColumnDefuncion1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnDefuncion1() {
        return tableColumnDefuncion1;
    }

    public void setTableColumnDefuncion1(TableColumn component) {
        this.tableColumnDefuncion1 = component;
    }

    private Label labelDefuncion1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelDefuncion1() {
        return labelDefuncion1;
    }

    public void setLabelDefuncion1(Label l) {
        this.labelDefuncion1 = l;
    }

    private TextArea campoDefuncion1 = new com.egt.core.jsf.component.AreaTexto();

    @Override
    public TextArea getCampoDefuncion1() {
        return campoDefuncion1;
    }

    public void setCampoDefuncion1(TextArea component) {
        this.campoDefuncion1 = component;
    }

    private StaticText campoDefuncion1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoDefuncion1Texto1() {
        return campoDefuncion1Texto1;
    }

    public void setCampoDefuncion1Texto1(StaticText component) {
        this.campoDefuncion1Texto1 = component;
    }

    private LengthValidator validatorDefuncion1 = new LengthValidator();
  
    public LengthValidator getValidatorDefuncion1() {
        return validatorDefuncion1;
    }
  
    public void setValidatorDefuncion1(LengthValidator validator) {
        this.validatorDefuncion1 = validator;
    }
    ...
    private LogImpFalCachedRowSetDataProvider2 logImpFalDataProvider = new LogImpFalCachedRowSetDataProvider2();

    @Override
    public LogImpFalCachedRowSetDataProvider2 getLogImpFalDataProvider() {
        return logImpFalDataProvider;
    }

    public void setLogImpFalDataProvider(LogImpFalCachedRowSetDataProvider2 crsdp) {
        this.logImpFalDataProvider = crsdp;
    }
...
/**/
    ...
    // <editor-fold defaultstate="collapsed" desc="implementacion estandar de propiedades tipo fecha de la interfaz PaginaActualizacionLogImpFal...">
    @Override
    ...
    private AsistentePaginaActualizacionLogImpFal asistente = new AsistentePaginaActualizacionLogImpFal(this);

    public AsistentePaginaActualizacionLogImpFal getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("LogImpFal5_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogImpFal5_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogImpFal5_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getLogImpFalDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return LogImpFalCachedRowSetDataProvider2.FUNCION_CONSULTAR_LOG_IMP_FAL;
    }
    ...
    public void consultar(Long filtro) {
        try {
            this.getLogImpFalDataProvider().consultarLogImpFal(filtro);
        } catch (Exception ex) {
