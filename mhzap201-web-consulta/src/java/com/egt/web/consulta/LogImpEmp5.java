...
public class LogImpEmp5 extends AbstractPageBean
        implements PaginaActualizacionLogImpEmp, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla {
    ...
    private TableColumn tableColumnIdLogImpEmp1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdLogImpEmp1() {
        return tableColumnIdLogImpEmp1;
    }

    public void setTableColumnIdLogImpEmp1(TableColumn component) {
        this.tableColumnIdLogImpEmp1 = component;
    }
...
/**/
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("LogImpEmp5_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogImpEmp5_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogImpEmp5_ETIQUETA_CLASE_MAESTRO");
    ...
    public void consultar(Long filtro) {
        try {
            this.getLogImpEmpDataProvider().consultarLogImpEmp(filtro);
        } catch (Exception ex) {
