...
public class AsistentePaginaActualizacionLogImpSub {

    private PaginaActualizacionLogImpSub bean;

    public AsistentePaginaActualizacionLogImpSub() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionLogImpSub(PaginaActualizacionLogImpSub bean) {
        this.bean = bean;
    }
    ...
    public String getTextCampoNombreArchivo1Boton3() {
        ...
        String nombre = bean.getLogImpSubDataProvider().getNombreArchivo(rowKey);
   ...
   public boolean isEsImportado() {
        ...
        RowKey rowKey = bean.getGestor().getCurrentRowKey();
        Integer value = bean.getLogImpSubDataProvider().getEsImportado(rowKey);
    ...
    public boolean isGridIdLogImpSubRendered() {
        return true;
    }
