...
public interface PaginaActualizacionLogImpFal extends PaginaActualizacion {

    TextField getCampoIdLogImpFal1();
    ...
    LogImpFalCachedRowSetDataProvider2 getLogImpFalDataProvider();
}
