...
import com.egt.data.specific.xdp2.LogImpSubCachedRowSetDataProvider2;
...
public class LogImpSub5 extends AbstractPageBean
        implements PaginaActualizacionLogImpSub, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla {

    // <editor-fold defaultstate="collapsed" desc="Managed Component Definition">
    private void _init() throws Exception {
        textoFilasPorPagina1Validator1.setMinimum(1L);
        textoFilasPorPagina1Validator1.setMaximum(50L);
        validatorIdLogImpSub1.setMinimum(0L);
        validatorIdLogImpSub1.setMaximum(1000000000000000000L);
        ...
        logImpSubDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.logImpSubRowSet}"));
    }
    ...
    private TableColumn tableColumnIdLogImpSub1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdLogImpSub1() {
        return tableColumnIdLogImpSub1;
    }

    public void setTableColumnIdLogImpSub1(TableColumn component) {
        this.tableColumnIdLogImpSub1 = component;
    }

    private Label labelIdLogImpSub1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelIdLogImpSub1() {
        return labelIdLogImpSub1;
    }

    public void setLabelIdLogImpSub1(Label l) {
        this.labelIdLogImpSub1 = l;
    }

    private TextField campoIdLogImpSub1 = new com.egt.core.jsf.component.CampoTexto();

    @Override
    public TextField getCampoIdLogImpSub1() {
        return campoIdLogImpSub1;
    }

    public void setCampoIdLogImpSub1(TextField component) {
        this.campoIdLogImpSub1 = component;
    }

    private StaticText campoIdLogImpSub1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoIdLogImpSub1Texto1() {
        return campoIdLogImpSub1Texto1;
    }

    public void setCampoIdLogImpSub1Texto1(StaticText component) {
        this.campoIdLogImpSub1Texto1 = component;
    }

    private LongConverter converterIdLogImpSub1 = new LongConverter();
  
    public LongConverter getConverterIdLogImpSub1() {
        return converterIdLogImpSub1;
    }
  
    public void setConverterIdLogImpSub1(LongConverter converter) {
        this.converterIdLogImpSub1 = converter;
    }
  
    private LongRangeValidator validatorIdLogImpSub1 = new LongRangeValidator();
  
    public LongRangeValidator getValidatorIdLogImpSub1() {
        return validatorIdLogImpSub1;
    }
  
    public void setValidatorIdLogImpSub1(LongRangeValidator validator) {
        this.validatorIdLogImpSub1 = validator;
    }
    ...
    private LogImpSubCachedRowSetDataProvider2 logImpSubDataProvider = new LogImpSubCachedRowSetDataProvider2();

    @Override
    public LogImpSubCachedRowSetDataProvider2 getLogImpSubDataProvider() {
        return logImpSubDataProvider;
    }

    public void setLogImpSubDataProvider(LogImpSubCachedRowSetDataProvider2 crsdp) {
        this.logImpSubDataProvider = crsdp;
    }
...
/**/
    ...
    // <editor-fold defaultstate="collapsed" desc="implementacion estandar de propiedades tipo fecha de la interfaz PaginaActualizacionLogImpSub...">
    @Override
    ...
    private AsistentePaginaActualizacionLogImpSub asistente = new AsistentePaginaActualizacionLogImpSub(this);

    public AsistentePaginaActualizacionLogImpSub getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("LogImpSub5_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogImpSub5_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogImpSub5_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getLogImpSubDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return LogImpSubCachedRowSetDataProvider2.FUNCION_CONSULTAR_LOG_IMP_SUB;
    }
    ...
    public void consultar(Long filtro) {
        try {
            this.getLogImpSubDataProvider().consultarLogImpSub(filtro);
        } catch (Exception ex) {
