...
public interface PaginaActualizacionLogProActJupe extends PaginaActualizacion {

    TextField getCampoIdLogProActJupe1();
    ...
    LogProActJupeCachedRowSetDataProvider2 getLogProActJupeDataProvider();
