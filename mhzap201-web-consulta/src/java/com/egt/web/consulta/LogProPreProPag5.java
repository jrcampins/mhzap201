...
public class LogProPreProPag5 extends AbstractPageBean
        implements PaginaActualizacionLogProPreProPag, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla {
    ...
    private void _init() throws Exception {
        ...
        logProPreProPagDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.logProPreProPagRowSet}"));
    ...
    private TableColumn tableColumnIdLogProPreProPag1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdLogProPreProPag1() {
        return tableColumnIdLogProPreProPag1;
    }

    public void setTableColumnIdLogProPreProPag1(TableColumn component) {
        this.tableColumnIdLogProPreProPag1 = component;
    }

    private Label labelIdLogProPreProPag1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelIdLogProPreProPag1() {
        return labelIdLogProPreProPag1;
    }

    public void setLabelIdLogProPreProPag1(Label l) {
        this.labelIdLogProPreProPag1 = l;
    }

    private TextField campoIdLogProPreProPag1 = new com.egt.core.jsf.component.CampoTexto();

    @Override
    public TextField getCampoIdLogProPreProPag1() {
        return campoIdLogProPreProPag1;
    }

    public void setCampoIdLogProPreProPag1(TextField component) {
        this.campoIdLogProPreProPag1 = component;
    }

    private StaticText campoIdLogProPreProPag1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoIdLogProPreProPag1Texto1() {
        return campoIdLogProPreProPag1Texto1;
    }

    public void setCampoIdLogProPreProPag1Texto1(StaticText component) {
        this.campoIdLogProPreProPag1Texto1 = component;
    }

    private LongConverter converterIdLogProPreProPag1 = new LongConverter();
  
    public LongConverter getConverterIdLogProPreProPag1() {
        return converterIdLogProPreProPag1;
    }
  
    public void setConverterIdLogProPreProPag1(LongConverter converter) {
        this.converterIdLogProPreProPag1 = converter;
    }
  
    private LongRangeValidator validatorIdLogProPreProPag1 = new LongRangeValidator();
  
    public LongRangeValidator getValidatorIdLogProPreProPag1() {
        return validatorIdLogProPreProPag1;
    }
  
    public void setValidatorIdLogProPreProPag1(LongRangeValidator validator) {
        this.validatorIdLogProPreProPag1 = validator;
    }
    ...
    private LogProPreProPagCachedRowSetDataProvider2 logProPreProPagDataProvider = new LogProPreProPagCachedRowSetDataProvider2();

    @Override
    public LogProPreProPagCachedRowSetDataProvider2 getLogProPreProPagDataProvider() {
        return logProPreProPagDataProvider;
    }

    public void setLogProPreProPagDataProvider(LogProPreProPagCachedRowSetDataProvider2 crsdp) {
        this.logProPreProPagDataProvider = crsdp;
    }
...
/**/
    ...
    //@PreDestroy
    public void destroy() {
        logProPreProPagDataProvider.close();
    ...
    // <editor-fold defaultstate="collapsed" desc="implementacion estandar de propiedades tipo fecha de la interfaz PaginaActualizacionLogProPreProPag...">
    @Override
    ...
    private AsistentePaginaActualizacionLogProPreProPag asistente = new AsistentePaginaActualizacionLogProPreProPag(this);

    public AsistentePaginaActualizacionLogProPreProPag getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("LogProPreProPag5_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogProPreProPag5_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogProPreProPag5_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getLogProPreProPagDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return LogProPreProPagCachedRowSetDataProvider2.FUNCION_CONSULTAR_LOG_PRO_PRE_PRO_PAG;
    }
    ...
    public void consultar(Long filtro) {
        try {
            this.getLogProPreProPagDataProvider().consultarLogProPreProPag(filtro);
        } catch (Exception ex) {
