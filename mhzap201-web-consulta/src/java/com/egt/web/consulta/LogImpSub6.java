...
public class LogImpSub6 extends AbstractPageBean
        implements PaginaActualizacionLogImpSub, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple {
    ...
    private HelpInline helpInlineIdLogImpSub1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineIdLogImpSub1() {
        return helpInlineIdLogImpSub1;
    }

    public void setHelpInlineIdLogImpSub1(HelpInline hi) {
        this.helpInlineIdLogImpSub1 = hi;
    }
...
/**/
    ...
    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogImpSub6_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogImpSub6_ETIQUETA_CLASE_MAESTRO");
