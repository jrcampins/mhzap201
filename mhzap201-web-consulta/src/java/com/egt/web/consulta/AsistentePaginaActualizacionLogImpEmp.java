...
public class AsistentePaginaActualizacionLogImpEmp {

    private PaginaActualizacionLogImpEmp bean;

    public AsistentePaginaActualizacionLogImpEmp() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionLogImpEmp(PaginaActualizacionLogImpEmp bean) {
        this.bean = bean;
    }
    ...
    public String getTextCampoNombreArchivo1Boton3() {
        ...
        String nombre = bean.getLogImpEmpDataProvider().getNombreArchivo(rowKey);
   ...
   public boolean isEsImportado() {
        ...
        RowKey rowKey = bean.getGestor().getCurrentRowKey();
        Integer value = bean.getLogImpEmpDataProvider().getEsImportado(rowKey);
    ...
    public boolean isGridIdLogImpEmpRendered() {
        return true;
    }
