...
public class LogProActJupe5 extends AbstractPageBean
        implements PaginaActualizacionLogProActJupe, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla {

    // <editor-fold defaultstate="collapsed" desc="Managed Component Definition">
    private void _init() throws Exception {
        textoFilasPorPagina1Validator1.setMinimum(1L);
        textoFilasPorPagina1Validator1.setMaximum(50L);
        validatorIdLogProActJupe1.setMinimum(0L);
        validatorIdLogProActJupe1.setMaximum(1000000000000000000L);
        ...
        logProActJupeDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.logProActJupeRowSet}"));
    ...
    private TableColumn tableColumnIdLogProActJupe1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdLogProActJupe1() {
        return tableColumnIdLogProActJupe1;
    }

    public void setTableColumnIdLogProActJupe1(TableColumn component) {
        this.tableColumnIdLogProActJupe1 = component;
    }

    private Label labelIdLogProActJupe1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelIdLogProActJupe1() {
        return labelIdLogProActJupe1;
    }

    public void setLabelIdLogProActJupe1(Label l) {
        this.labelIdLogProActJupe1 = l;
    }

    private TextField campoIdLogProActJupe1 = new com.egt.core.jsf.component.CampoTexto();

    @Override
    public TextField getCampoIdLogProActJupe1() {
        return campoIdLogProActJupe1;
    }

    public void setCampoIdLogProActJupe1(TextField component) {
        this.campoIdLogProActJupe1 = component;
    }

    private StaticText campoIdLogProActJupe1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoIdLogProActJupe1Texto1() {
        return campoIdLogProActJupe1Texto1;
    }

    public void setCampoIdLogProActJupe1Texto1(StaticText component) {
        this.campoIdLogProActJupe1Texto1 = component;
    }

    private LongConverter converterIdLogProActJupe1 = new LongConverter();
  
    public LongConverter getConverterIdLogProActJupe1() {
        return converterIdLogProActJupe1;
    }
  
    public void setConverterIdLogProActJupe1(LongConverter converter) {
        this.converterIdLogProActJupe1 = converter;
    }
  
    private LongRangeValidator validatorIdLogProActJupe1 = new LongRangeValidator();
  
    public LongRangeValidator getValidatorIdLogProActJupe1() {
        return validatorIdLogProActJupe1;
    }
  
    public void setValidatorIdLogProActJupe1(LongRangeValidator validator) {
        this.validatorIdLogProActJupe1 = validator;
    }
    ...
    private LogProActJupeCachedRowSetDataProvider2 logProActJupeDataProvider = new LogProActJupeCachedRowSetDataProvider2();

    @Override
    public LogProActJupeCachedRowSetDataProvider2 getLogProActJupeDataProvider() {
        return logProActJupeDataProvider;
    }

    public void setLogProActJupeDataProvider(LogProActJupeCachedRowSetDataProvider2 crsdp) {
        this.logProActJupeDataProvider = crsdp;
    }
...
/**/
    ...
    //@PreDestroy
    public void destroy() {
        logProActJupeDataProvider.close();
    ...
    // <editor-fold defaultstate="collapsed" desc="implementacion estandar de propiedades tipo fecha de la interfaz PaginaActualizacionLogProActJupe...">
    @Override
    ...
    private AsistentePaginaActualizacionLogProActJupe asistente = new AsistentePaginaActualizacionLogProActJupe(this);

    public AsistentePaginaActualizacionLogProActJupe getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("LogProActJupe5_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogProActJupe5_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogProActJupe5_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getLogProActJupeDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return LogProActJupeCachedRowSetDataProvider2.FUNCION_CONSULTAR_LOG_PRO_ACT_JUPE;
    }
    ...
    public void consultar(Long filtro) {
        try {
            this.getLogProActJupeDataProvider().consultarLogProActJupe(filtro);
        } catch (Exception ex) {
