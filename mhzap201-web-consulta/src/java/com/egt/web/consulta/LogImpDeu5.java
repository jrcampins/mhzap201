...
import com.egt.data.specific.xdp2.LogImpDeuCachedRowSetDataProvider2;
...
public class LogImpDeu5 extends AbstractPageBean
        implements PaginaActualizacionLogImpDeu, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple, PaginaConsultaConFiltro, PaginaConsultaConTabla {

    // <editor-fold defaultstate="collapsed" desc="Managed Component Definition">
    private void _init() throws Exception {
        textoFilasPorPagina1Validator1.setMinimum(1L);
        textoFilasPorPagina1Validator1.setMaximum(50L);
        validatorIdLogImpDeu1.setMinimum(0L);
        validatorIdLogImpDeu1.setMaximum(1000000000000000000L);
        ...
        logImpDeuDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.logImpDeuRowSet}"));
    }
    ...
    private TableColumn tableColumnIdLogImpDeu1 = new com.egt.core.jsf.component.ColumnaTabla();

    public TableColumn getTableColumnIdLogImpDeu1() {
        return tableColumnIdLogImpDeu1;
    }

    public void setTableColumnIdLogImpDeu1(TableColumn component) {
        this.tableColumnIdLogImpDeu1 = component;
    }

    private Label labelIdLogImpDeu1 = new com.egt.core.jsf.component.Etiqueta();

    public Label getLabelIdLogImpDeu1() {
        return labelIdLogImpDeu1;
    }

    public void setLabelIdLogImpDeu1(Label l) {
        this.labelIdLogImpDeu1 = l;
    }

    private TextField campoIdLogImpDeu1 = new com.egt.core.jsf.component.CampoTexto();

    @Override
    public TextField getCampoIdLogImpDeu1() {
        return campoIdLogImpDeu1;
    }

    public void setCampoIdLogImpDeu1(TextField component) {
        this.campoIdLogImpDeu1 = component;
    }

    private StaticText campoIdLogImpDeu1Texto1 = new com.egt.core.jsf.component.TextoEstaticoAlternativo();

    public StaticText getCampoIdLogImpDeu1Texto1() {
        return campoIdLogImpDeu1Texto1;
    }

    public void setCampoIdLogImpDeu1Texto1(StaticText component) {
        this.campoIdLogImpDeu1Texto1 = component;
    }

    private LongConverter converterIdLogImpDeu1 = new LongConverter();
  
    public LongConverter getConverterIdLogImpDeu1() {
        return converterIdLogImpDeu1;
    }
  
    public void setConverterIdLogImpDeu1(LongConverter converter) {
        this.converterIdLogImpDeu1 = converter;
    }
  
    private LongRangeValidator validatorIdLogImpDeu1 = new LongRangeValidator();
  
    public LongRangeValidator getValidatorIdLogImpDeu1() {
        return validatorIdLogImpDeu1;
    }
  
    public void setValidatorIdLogImpDeu1(LongRangeValidator validator) {
        this.validatorIdLogImpDeu1 = validator;
    }
    ...
    private LogImpDeuCachedRowSetDataProvider2 logImpDeuDataProvider = new LogImpDeuCachedRowSetDataProvider2();

    @Override
    public LogImpDeuCachedRowSetDataProvider2 getLogImpDeuDataProvider() {
        return logImpDeuDataProvider;
    }

    public void setLogImpDeuDataProvider(LogImpDeuCachedRowSetDataProvider2 crsdp) {
        this.logImpDeuDataProvider = crsdp;
    }
...
/**/
    ...
    // <editor-fold defaultstate="collapsed" desc="implementacion estandar de propiedades tipo fecha de la interfaz PaginaActualizacionLogImpDeu...">
    @Override
    ...
    private AsistentePaginaActualizacionLogImpDeu asistente = new AsistentePaginaActualizacionLogImpDeu(this);

    public AsistentePaginaActualizacionLogImpDeu getAsistente() {
        return this.asistente;
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="propiedades y metodos estandar: preiniciar, iniciar, preprocesar, prepresentar, consultar, posconsultar, posrefrescar">
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("LogImpDeu5_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogImpDeu5_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogImpDeu5_ETIQUETA_CLASE_MAESTRO");

    @Override
    public RecursoCachedRowSetDataProvider getRecursoDataProvider() {
        return this.getLogImpDeuDataProvider();
    }

    @Override
    public long getFuncionConsultarRecurso() {
        return LogImpDeuCachedRowSetDataProvider2.FUNCION_CONSULTAR_LOG_IMP_DEU;
    }
    ...
    public void consultar(Long filtro) {
        try {
            this.getLogImpDeuDataProvider().consultarLogImpDeu(filtro);
        } catch (Exception ex) {
