...
public class LogImpJub6 extends AbstractPageBean
        implements PaginaActualizacionLogImpJub, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple {
    ...
    private HelpInline helpInlineIdLogImpJub1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineIdLogImpJub1() {
        return helpInlineIdLogImpJub1;
    }

    public void setHelpInlineIdLogImpJub1(HelpInline hi) {
        this.helpInlineIdLogImpJub1 = hi;
    }
    ...
    private HelpInline helpInlineTipoRegistro1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineTipoRegistro1() {
        return helpInlineTipoRegistro1;
    }

    public void setHelpInlineTipoRegistro1(HelpInline hi) {
        this.helpInlineTipoRegistro1 = hi;
    }
...
/**/
    ...
    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogImpJub6_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogImpJub6_ETIQUETA_CLASE_MAESTRO");
