...
public interface PaginaActualizacionLogImpJub extends PaginaActualizacion {

    TextField getCampoIdLogImpJub1();
    ...
    TextArea getCampoTipoRegistro1();
    ...
    LogImpJubCachedRowSetDataProvider2 getLogImpJubDataProvider();
}
