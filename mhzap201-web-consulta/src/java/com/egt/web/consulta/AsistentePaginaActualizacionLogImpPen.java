...
public class AsistentePaginaActualizacionLogImpPen {

    private PaginaActualizacionLogImpPen bean;

    public AsistentePaginaActualizacionLogImpPen() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionLogImpPen(PaginaActualizacionLogImpPen bean) {
        this.bean = bean;
    }
    ...
    public String getTextCampoNombreArchivo1Boton3() {
        ...
        String nombre = bean.getLogImpPenDataProvider().getNombreArchivo(rowKey);
   ...
   public boolean isEsImportado() {
        ...
        RowKey rowKey = bean.getGestor().getCurrentRowKey();
        Integer value = bean.getLogImpPenDataProvider().getEsImportado(rowKey);
    ...
    public boolean isGridIdLogImpPenRendered() {
        return true;
    }
