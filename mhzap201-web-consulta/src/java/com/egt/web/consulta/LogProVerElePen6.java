...
public class LogProVerElePen6 extends AbstractPageBean
        implements PaginaActualizacionLogProVerElePen, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple {
    ...
    private HelpInline helpInlineIdLogProVerElePen1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineIdLogProVerElePen1() {
        return helpInlineIdLogProVerElePen1;
    }

    public void setHelpInlineIdLogProVerElePen1(HelpInline hi) {
        this.helpInlineIdLogProVerElePen1 = hi;
    }
...
/**/
    ...
    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogProVerElePen6_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogProVerElePen6_ETIQUETA_CLASE_MAESTRO");
