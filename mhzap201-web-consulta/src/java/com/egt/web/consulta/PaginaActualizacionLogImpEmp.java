...
public interface PaginaActualizacionLogImpEmp extends PaginaActualizacion {

    TextField getCampoIdLogImpEmp1();
    ...
    LogImpEmpCachedRowSetDataProvider2 getLogImpEmpDataProvider();
}
