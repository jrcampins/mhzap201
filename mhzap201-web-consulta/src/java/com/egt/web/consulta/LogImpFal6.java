...
public class LogImpFal6 extends AbstractPageBean
        implements PaginaActualizacionLogImpFal, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple {
    ...
    private HelpInline helpInlineIdLogImpFal1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineIdLogImpFal1() {
        return helpInlineIdLogImpFal1;
    }

    public void setHelpInlineIdLogImpFal1(HelpInline hi) {
        this.helpInlineIdLogImpFal1 = hi;
    }
    ...
    private HelpInline helpInlineDefuncion1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineDefuncion1() {
        return helpInlineDefuncion1;
    }

    public void setHelpInlineDefuncion1(HelpInline hi) {
        this.helpInlineDefuncion1 = hi;
    }
...
/**/
    ...
    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogImpFal6_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogImpFal6_ETIQUETA_CLASE_MAESTRO");
