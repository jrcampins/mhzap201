...
public interface PaginaActualizacionObjecionElePen extends PaginaActualizacion {

    TextField getCampoIdObjecionElePen1();

    TextField getCampoIdPersona1();

    TextField getCampoIdProveedorDatExt1();

    DropDown getListaNumeroTipoObjElePen1();

    DropDown getListaEsObjecionElePenInactiva1();

    TextField getTextFieldCampoFechaUltimaActualizacion1();

    TextArea getCampoNombreArchivoUltimaAct1();

    TextArea getCampoObservaciones1();

    TextField getTextFieldCampoFechaAnulacion1();

    TextArea getCampoObservacionesAnulacion1();
