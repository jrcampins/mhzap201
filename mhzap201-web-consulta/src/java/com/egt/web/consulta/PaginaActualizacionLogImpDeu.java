...
public interface PaginaActualizacionLogImpDeu extends PaginaActualizacion {

    TextField getCampoIdLogImpDeu1();
    ...
    LogImpDeuCachedRowSetDataProvider2 getLogImpDeuDataProvider();
}
