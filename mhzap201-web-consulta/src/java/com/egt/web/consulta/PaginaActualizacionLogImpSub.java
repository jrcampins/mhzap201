...
public interface PaginaActualizacionLogImpSub extends PaginaActualizacion {

    TextField getCampoIdLogImpSub1();
    ...
    LogImpSubCachedRowSetDataProvider2 getLogImpSubDataProvider();
}
