...
public class AsistentePaginaActualizacionLogImpUbi {

    private PaginaActualizacionLogImpUbi bean;

    public AsistentePaginaActualizacionLogImpUbi() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionLogImpUbi(PaginaActualizacionLogImpUbi bean) {
        this.bean = bean;
    }
    ...
    public String getTextCampoNombreArchivo1Boton3() {
        ...
        String nombre = bean.getLogImpUbiDataProvider().getNombreArchivo(rowKey);
   ...
   public boolean isEsImportado() {
        ...
        RowKey rowKey = bean.getGestor().getCurrentRowKey();
        Integer value = bean.getLogImpUbiDataProvider().getEsImportado(rowKey);
    ...
    public boolean isGridIdLogImpUbiRendered() {
        return true;
    }

    public boolean isGridCodigoRendered() {
        return true;
    }

    public boolean isGridUbicacionRendered() {
        return true;
    }

    public boolean isGridTipoUbicacionRendered() {
        return true;
    }

    public boolean isGridTipoAreaRendered() {
        return true;
    }

    public boolean isGridCodigoUbicacionSuperiorRendered() {
        return true;
    }
