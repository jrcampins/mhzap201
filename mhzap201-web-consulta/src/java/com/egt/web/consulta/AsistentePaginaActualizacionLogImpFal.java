...
public class AsistentePaginaActualizacionLogImpFal {

    private PaginaActualizacionLogImpFal bean;

    public AsistentePaginaActualizacionLogImpFal() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionLogImpFal(PaginaActualizacionLogImpFal bean) {
        this.bean = bean;
    }
    ...
    public String getTextCampoNombreArchivo1Boton3() {
        ...
        String nombre = bean.getLogImpFalDataProvider().getNombreArchivo(rowKey);
   ...
   public boolean isEsImportado() {
        ...
        RowKey rowKey = bean.getGestor().getCurrentRowKey();
        Integer value = bean.getLogImpFalDataProvider().getEsImportado(rowKey);
    ...
    public boolean isGridIdLogImpFalRendered() {
        return true;
    }
    ...
    public boolean isGridDefuncionRendered() {
        return true;
    }
