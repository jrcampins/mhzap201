...
public class AsistentePaginaActualizacionFuncionario {

    private PaginaActualizacionFuncionario bean;

    public AsistentePaginaActualizacionFuncionario() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionFuncionario(PaginaActualizacionFuncionario bean) {
        this.bean = bean;
    }
    ...
    public Option[] getOpcionesListaFuncionEdicion() {
        ...
        return new Option[]{ //
                ...
                //  new Option(FuncionarioCachedRowSetDataProvider2.FUNCION_MODIFICAR_FUNCIONARIO, BundleWebui.getString("editar"))
                };
    }
    ...
    public boolean isGridIdFuncionarioRendered() {
        return true;
    }

    public boolean isGridCodigoFuncionarioRendered() {
        return true;
    }

    public boolean isGridNombreFuncionarioRendered() {
        return true;
    }
