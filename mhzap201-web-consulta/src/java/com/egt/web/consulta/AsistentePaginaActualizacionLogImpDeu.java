...
public class AsistentePaginaActualizacionLogImpDeu {

    private PaginaActualizacionLogImpDeu bean;

    public AsistentePaginaActualizacionLogImpDeu() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionLogImpDeu(PaginaActualizacionLogImpDeu bean) {
        this.bean = bean;
    }
    ...
    public String getTextCampoNombreArchivo1Boton3() {
        ...
        String nombre = bean.getLogImpDeuDataProvider().getNombreArchivo(rowKey);
   ...
   public boolean isEsImportado() {
        ...
        RowKey rowKey = bean.getGestor().getCurrentRowKey();
        Integer value = bean.getLogImpDeuDataProvider().getEsImportado(rowKey);
    ...
    public boolean isGridIdLogImpDeuRendered() {
        return true;
    }
