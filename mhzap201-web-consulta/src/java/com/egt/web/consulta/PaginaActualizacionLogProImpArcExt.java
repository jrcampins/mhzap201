...
public interface PaginaActualizacionLogProImpArcExt extends PaginaActualizacion {

    TextField getCampoIdLogProImpArcExt1();
    ...
    LogProImpArcExtCachedRowSetDataProvider2 getLogProImpArcExtDataProvider();

    ArchivoDatosExtCachedRowSetDataProvider2 getArchivoDatosExtReferenceDataProvider();
}
