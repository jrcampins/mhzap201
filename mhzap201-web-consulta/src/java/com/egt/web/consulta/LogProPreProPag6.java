...
public class LogProPreProPag6 extends AbstractPageBean
        implements PaginaActualizacionLogProPreProPag, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple {
    ...
    private HelpInline helpInlineIdLogProPreProPag1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineIdLogProPreProPag1() {
        return helpInlineIdLogProPreProPag1;
    }

    public void setHelpInlineIdLogProPreProPag1(HelpInline hi) {
        this.helpInlineIdLogProPreProPag1 = hi;
    }
...
/**/
    ...
    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogProPreProPag6_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogProPreProPag6_ETIQUETA_CLASE_MAESTRO");
