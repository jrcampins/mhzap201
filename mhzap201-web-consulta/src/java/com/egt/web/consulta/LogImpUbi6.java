...
public class LogImpUbi6 extends AbstractPageBean
        implements PaginaActualizacionLogImpUbi, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple {
    ...
    private HelpInline helpInlineIdLogImpUbi1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineIdLogImpUbi1() {
        return helpInlineIdLogImpUbi1;
    }

    public void setHelpInlineIdLogImpUbi1(HelpInline hi) {
        this.helpInlineIdLogImpUbi1 = hi;
    }
    ...
    private HelpInline helpInlineCodigo1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineCodigo1() {
        return helpInlineCodigo1;
    }

    public void setHelpInlineCodigo1(HelpInline hi) {
        this.helpInlineCodigo1 = hi;
    }
    ...
    private HelpInline helpInlineUbicacion1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineUbicacion1() {
        return helpInlineUbicacion1;
    }

    public void setHelpInlineUbicacion1(HelpInline hi) {
        this.helpInlineUbicacion1 = hi;
    }
    ...
    private HelpInline helpInlineTipoUbicacion1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineTipoUbicacion1() {
        return helpInlineTipoUbicacion1;
    }

    public void setHelpInlineTipoUbicacion1(HelpInline hi) {
        this.helpInlineTipoUbicacion1 = hi;
    }
    ...
    private HelpInline helpInlineTipoArea1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineTipoArea1() {
        return helpInlineTipoArea1;
    }

    public void setHelpInlineTipoArea1(HelpInline hi) {
        this.helpInlineTipoArea1 = hi;
    }
    ...
    private HelpInline helpInlineCodigoUbicacionSuperior1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineCodigoUbicacionSuperior1() {
        return helpInlineCodigoUbicacionSuperior1;
    }

    public void setHelpInlineCodigoUbicacionSuperior1(HelpInline hi) {
        this.helpInlineCodigoUbicacionSuperior1 = hi;
    }
...
/**/
    ...
    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogImpUbi6_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogImpUbi6_ETIQUETA_CLASE_MAESTRO");
