...
public class Ubicacion7 extends AbstractPageBean
...
/**/
    ...
    private final static String ETIQUETA_MIGAS_PAN = Bundle.getString("Ubicacion7_ETIQUETA_MIGAS_PAN");

    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("Ubicacion7_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("Ubicacion7_ETIQUETA_CLASE_MAESTRO");
    ...
    public Option[] getOpcionesListaFuncionEdicion() {
        return new Option[]{ //
                ...
                // new Option(UbicacionCachedRowSetDataProvider2.FUNCION_DESACTIVAR_UBICACION, BundleWebui.getString("desactivar")),
                // new Option(UbicacionCachedRowSetDataProvider2.FUNCION_REACTIVAR_UBICACION, BundleWebui.getString("reactivar"))
                };
    }
...
//          new Option(UbicacionCachedRowSetDataProvider2.FUNCION_PROCESAR_UBICACION, BundleWebui.getString("procesar"))
//      };
//      return this.getGestor().getOpcionesListaFuncionAccionAutorizadas(opciones);
    ...
    public void consultar(Long filtro) {
        try {
            this.getUbicacionDataProvider().setLimiteFilasFuncionSelect(500);
