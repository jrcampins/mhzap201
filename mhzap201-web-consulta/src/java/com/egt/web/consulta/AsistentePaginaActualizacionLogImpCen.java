...
public class AsistentePaginaActualizacionLogImpCen {

    private PaginaActualizacionLogImpCen bean;

    public AsistentePaginaActualizacionLogImpCen() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionLogImpCen(PaginaActualizacionLogImpCen bean) {
        this.bean = bean;
    }
    ...
    public String getTextCampoNombreArchivo1Boton3() {
        ...
        String nombre = bean.getLogImpCenDataProvider().getNombreArchivo(rowKey);
   ...
   public boolean isEsImportado() {
        ...
        RowKey rowKey = bean.getGestor().getCurrentRowKey();
        Integer value = bean.getLogImpCenDataProvider().getEsImportado(rowKey);
    ...
    public boolean isGridIdLogImpCenRendered() {
        return true;
    }
    ...
    public boolean isGridParentescoRendered() {
        return true;
    }
    ...
    public boolean isGridCedulaJefeHogarRendered() {
        return true;
    }
    ...
    public boolean isGridValidadoRendered() {
        return true;
    }
    ...
    public boolean isGridFuncionarioRendered() {
        return true;
    }

    public boolean isGridCausaInvalidacionRendered() {
        return true;
    }
