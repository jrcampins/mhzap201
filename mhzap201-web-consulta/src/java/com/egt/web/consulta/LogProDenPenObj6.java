...
public class LogProDenPenObj6 extends AbstractPageBean
        implements PaginaActualizacionLogProDenPenObj, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple {
    ...
    private HelpInline helpInlineIdLogProDenPenObj1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineIdLogProDenPenObj1() {
        return helpInlineIdLogProDenPenObj1;
    }

    public void setHelpInlineIdLogProDenPenObj1(HelpInline hi) {
        this.helpInlineIdLogProDenPenObj1 = hi;
    }
...
/**/
    ...
    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogProDenPenObj6_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogProDenPenObj6_ETIQUETA_CLASE_MAESTRO");
