...
public class AsistentePaginaActualizacionFichaPersona {

    private PaginaActualizacionFichaPersona bean;

    public AsistentePaginaActualizacionFichaPersona() {
        this.bean = null;
    }

    public AsistentePaginaActualizacionFichaPersona(PaginaActualizacionFichaPersona bean) {
        this.bean = bean;
    }
...
//      String urx = URX2.COMANDO_FICHA_PERSONA;
    ...
    protected GestorBusquedaReferencia getGestorBusquedaIdFichaHogar() {
        if (this.gestorBusquedaIdFichaHogar == null) {
            this.gestorBusquedaIdFichaHogar = new GestorBusquedaReferencia(
                    ...
                    FichaPersonaCachedRowSetDataProvider2.COLUMNA_ID_FICHA_HOGAR,
    ...
    public String getTextoCampoIdFichaHogar1() {
        ...
        if (bean.getGestor().isFilaNoProcesada()) {
            return STP.getString(bean.getFichaPersonaDataProvider().getIdFichaHogar(rowKey));
        }
        this.getGestorBusquedaIdFichaHogar().setFiltroBusqueda(this.getFiltroBusquedaIdFichaHogar());
    ...
    public String getScriptCampoIdFichaHogar1Boton2() {
        ...
        Long id = bean.getFichaPersonaDataProvider().getIdFichaHogar(rowKey);
    ...
    public boolean isCampoIdFichaHogar1Panel2Rendered() {
        return isCampoIdFichaHogar1Boton2Rendered() && isGridIdFichaHogarRendered();
    }
