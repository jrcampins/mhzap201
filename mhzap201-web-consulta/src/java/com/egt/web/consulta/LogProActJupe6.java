...
public class LogProActJupe6 extends AbstractPageBean
        implements PaginaActualizacionLogProActJupe, PaginaActualizacionConAccionMultiple, PaginaActualizacionConEdicionMultiple {
    ...
    private HelpInline helpInlineIdLogProActJupe1 = new com.egt.core.jsf.component.AyudaEnLinea();

    public HelpInline getHelpInlineIdLogProActJupe1() {
        return helpInlineIdLogProActJupe1;
    }

    public void setHelpInlineIdLogProActJupe1(HelpInline hi) {
        this.helpInlineIdLogProActJupe1 = hi;
    }
...
/**/
    ...
    private final static String ETIQUETA_CLASE_DETALLE = Bundle.getString("LogProActJupe6_ETIQUETA_CLASE_DETALLE");

    private final static String ETIQUETA_CLASE_MAESTRO = Bundle.getString("LogProActJupe6_ETIQUETA_CLASE_MAESTRO");
