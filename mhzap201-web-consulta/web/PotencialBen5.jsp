                                    ...
                                    <h:panelGrid 
                                        ...
                                        <webuijsf:table
                                            ...
                                            <webuijsf:tableRowGroup 
                                                ...
                                                <webuijsf:tableColumn
                                                    binding="#{PotencialBen5.tableColumnIdFuncionarioRegPotBen1}"
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{PotencialBen5.gestor.designing}"/>
                                                <webuijsf:label
                                                    binding="#{PotencialBen5.labelIdFuncionarioRegPotBen1}"
                                                    id="labelIdFuncionarioRegPotBen1"
                                                    for="campoIdFuncionarioRegPotBen1"/>
                                                <webuijsf:textField id="campoIdFuncionarioRegPotBen1"
                                                    binding="#{PotencialBen5.campoIdFuncionarioRegPotBen1}"
                                                    readOnly="true"
                                                    text="#{PotencialBen5.asistente.textoCampoIdFuncionarioRegPotBen1}"
                                                    toolTip="#{PotencialBen5.asistente.toolTipCampoIdFuncionarioRegPotBen1}"
                                                    validatorExpression="#{PotencialBen5.campoIdFuncionarioRegPotBen1_validate}"/>
                                                <webuijsf:staticText id="campoIdFuncionarioRegPotBen1Texto1"
                                                    binding="#{PotencialBen5.campoIdFuncionarioRegPotBen1Texto1}"
                                                    text="#{currentRow.value['codigo_funcionario_1x15y3']}"/>
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{PotencialBen5.gestor.designing}"/>
                                                <webuijsf:button
                                                    binding="#{PotencialBen5.campoIdFuncionarioRegPotBen1Boton1}"
                                                    id="campoIdFuncionarioRegPotBen1Boton1"
                                                    onClick="#{PotencialBen5.asistente.scriptCampoIdFuncionarioRegPotBen1Boton1}"/>
                                                <webuijsf:button
                                                    binding="#{PotencialBen5.campoIdFuncionarioRegPotBen1Boton3}"
                                                    id="campoIdFuncionarioRegPotBen1Boton3"
                                                    onClick="#{PotencialBen5.asistente.scriptCampoIdFuncionarioRegPotBen1Boton2}"
                                                    rendered="#{PotencialBen5.asistente.campoIdFuncionarioRegPotBen1Boton3Rendered}"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn 
                                                    binding="#{PotencialBen5.tableColumnIdFuncionarioRegPotBen2}"
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{PotencialBen5.gestor.designing}"/>
                                                <webuijsf:label
                                                    binding="#{PotencialBen5.labelIdFuncionarioRegPotBen2}"
                                                    id="labelIdFuncionarioRegPotBen2"
                                                    text=""/>
                                                <webuijsf:imageHyperlink
                                                    binding="#{PotencialBen5.campoIdFuncionarioRegPotBen1Hiper1}"
