                                    ...
                                    <h:panelGrid 
                                        ...
                                        <h:panelGrid
                                            ...
                                            <h:panelGrid
                                                ...
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                                    binding="#{ArchivoDatosExt6.labelNombreArchivoDatos1}"
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:textArea id="campoNombreArchivoDatos1"
                                                    binding="#{ArchivoDatosExt6.campoNombreArchivoDatos1}"
                                                    columns="100" rows="3"
                                                    readOnly="true"
                                                    text="#{ArchivoDatosExt6.archivoDatosExtDataProvider.value['nombre_archivo_datos']}"
                                                    toolTip="BundleParametros.nombre_archivo_datos.archivo_datos_ext"
                                                    validatorExpression="#{ArchivoDatosExt6.validatorNombreArchivoDatos1.validate}"/>
                                                <webuijsf:staticText id="campoNombreArchivoDatos1Texto1"
                                                    binding="#{ArchivoDatosExt6.campoNombreArchivoDatos1Texto1}"
                                                    text="#{ArchivoDatosExt6.archivoDatosExtDataProvider.value['nombre_archivo_datos']}"/>
                                                <webuijsf:button id="campoNombreArchivoDatos1Boton3"
                                                    binding="#{ArchivoDatosExt6.campoNombreArchivoDatos1Boton3}"
                                                    onClick="#{ArchivoDatosExt6.asistente.scriptCampoNombreArchivoDatos1Boton3}"
                                                    rendered="#{ArchivoDatosExt6.asistente.campoNombreArchivoDatos1Boton3Rendered}"
                                                    text="#{ArchivoDatosExt6.asistente.textCampoNombreArchivoDatos1Boton3}"
                                                    toolTip="#{ArchivoDatosExt6.asistente.toolTipCampoNombreArchivoDatos1Boton3}"/>
                                                <webuijsf:message id="messageNombreArchivoDatos1"
                                                    for="campoNombreArchivoDatos1"/>
                                                <webuijsf:helpInline id="helpInlineNombreArchivoDatos1"
                                                    binding="#{ArchivoDatosExt6.helpInlineNombreArchivoDatos1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                            ...
                                            <h:panelGrid
                                                ...
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                                    binding="#{ArchivoDatosExt6.labelNombreOriginalArchivoDatos1}"
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:textArea id="campoNombreOriginalArchivoDatos1"
                                                    binding="#{ArchivoDatosExt6.campoNombreOriginalArchivoDatos1}"
                                                    columns="100" rows="3"
                                                    readOnly="true"
                                                    text="#{ArchivoDatosExt6.archivoDatosExtDataProvider.value['nombre_original_archivo_datos']}"
                                                    toolTip="BundleParametros.nombre_original_archivo_datos.archivo_datos_ext"
                                                    validatorExpression="#{ArchivoDatosExt6.validatorNombreOriginalArchivoDatos1.validate}"/>
                                                <webuijsf:staticText id="campoNombreOriginalArchivoDatos1Texto1"
                                                    binding="#{ArchivoDatosExt6.campoNombreOriginalArchivoDatos1Texto1}"
                                                    text="#{ArchivoDatosExt6.archivoDatosExtDataProvider.value['nombre_original_archivo_datos']}"/>
                                                <webuijsf:message id="messageNombreOriginalArchivoDatos1"
                                                    for="campoNombreOriginalArchivoDatos1"/>
                                                <webuijsf:helpInline id="helpInlineNombreOriginalArchivoDatos1"
                                                    binding="#{ArchivoDatosExt6.helpInlineNombreOriginalArchivoDatos1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
