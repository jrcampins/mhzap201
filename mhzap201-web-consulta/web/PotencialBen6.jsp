                                ...
                                <div class="pos-div-detalle">
                                    <h:panelGrid 
                                        ...
                                        <h:panelGrid
                                            ...
                                            <h:panelGrid
                                                id="gridIdUsuarioRegPotBen1" rendered="#{PotencialBen6.gestor.designing}"
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                            ...
                                            <h:panelGrid
                                                columns="7"
                                                id="gridIdUsuarioRegPotBen2" rendered="#{PotencialBen6.gestor.designing}"
                                                styleClass="pdq-grid-elemento-1">
                                                <webuijsf:textField id="campoIdUsuarioRegPotBen1"
                                                    binding="#{PotencialBen6.campoIdUsuarioRegPotBen1}"
                                                    readOnly="true"
                                                    text="#{PotencialBen6.asistente.textoCampoIdUsuarioRegPotBen1}"
                                                    toolTip="#{PotencialBen6.asistente.toolTipCampoIdUsuarioRegPotBen1}"
                                                    validatorExpression="#{PotencialBen6.campoIdUsuarioRegPotBen1_validate}"/>
                                                <webuijsf:staticText id="campoIdUsuarioRegPotBen1Texto1"
                                                    binding="#{PotencialBen6.campoIdUsuarioRegPotBen1Texto1}"
                                                    text="#{PotencialBen6.potencialBenDataProvider.value['codigo_usuario_1x15y3']}"/>
                                                <webuijsf:button id="campoIdUsuarioRegPotBen1Boton1"
                                                    binding="#{PotencialBen6.campoIdUsuarioRegPotBen1Boton1}"
                                                    onClick="#{PotencialBen6.asistente.scriptCampoIdUsuarioRegPotBen1Boton1}"/>
                                                <webuijsf:button id="campoIdUsuarioRegPotBen1Boton3"
                                                    binding="#{PotencialBen6.campoIdUsuarioRegPotBen1Boton3}"
                                                    onClick="#{PotencialBen6.asistente.scriptCampoIdUsuarioRegPotBen1Boton2}"
                                                    rendered="#{PotencialBen6.asistente.campoIdUsuarioRegPotBen1Boton3Rendered}"/>
                                                <webuijsf:message id="messageIdUsuarioRegPotBen1"
                                                    for="campoIdUsuarioRegPotBen1"/>
                                                <webuijsf:helpInline id="helpInlineIdUsuarioRegPotBen1"
                                                    binding="#{PotencialBen6.helpInlineIdUsuarioRegPotBen1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                            ...
                                            <h:panelGrid
                                                id="gridIdUsuarioRegPotBen3" rendered="#{PotencialBen6.gestor.designing}"
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                                    binding="#{PotencialBen6.labelIdUsuarioRegPotBen2}"
                                            ...
                                            <h:panelGrid
                                                columns="7"
                                                id="gridIdUsuarioRegPotBen4" rendered="#{PotencialBen6.gestor.designing}"
                                                styleClass="pdq-grid-elemento-1">
                                                <webuijsf:staticText
                                                    binding="#{PotencialBen6.campoIdUsuarioRegPotBen1Texto2}"
                                                    text="#{PotencialBen6.potencialBenDataProvider.value['nombre_usuario_1x15y4']}"
                                                    id="campoIdUsuarioRegPotBen1Texto2"/>
                                                <webuijsf:button
                                                    binding="#{PotencialBen6.campoIdUsuarioRegPotBen1Boton2}"
                                            ...
                                            <h:panelGrid
                                                id="gridEsPotencialBenMigrado1" rendered="#{PotencialBen6.gestor.designing}"
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                            ...
                                            <h:panelGrid
                                                columns="7"
                                                id="gridEsPotencialBenMigrado2" rendered="#{PotencialBen6.gestor.designing}"
                                                styleClass="pdq-grid-elemento-1">
                                                <webuijsf:dropDown id="listaEsPotencialBenMigrado1"
                                                    binding="#{PotencialBen6.listaEsPotencialBenMigrado1}"
                                                    converter="#{PotencialBen6.converterEsPotencialBenMigrado1}"
                                                    disabled="true"
                                                    items="#{PotencialBen6.asistente.opcionesListaEsPotencialBenMigrado1}"
                                                    selected="#{PotencialBen6.potencialBenDataProvider.value['es_potencial_ben_migrado']}"
                                                    toolTip="BundleParametros.es_potencial_ben_migrado.potencial_ben"/>
                                                <webuijsf:staticText id="listaEsPotencialBenMigrado1Texto1"
                                                    binding="#{PotencialBen6.listaEsPotencialBenMigrado1Texto1}"/>
                                                <webuijsf:message id="messageEsPotencialBenMigrado1"
                                                    for="listaEsPotencialBenMigrado1"/>
                                                <webuijsf:helpInline id="helpInlineEsPotencialBenMigrado1"
                                                    binding="#{PotencialBen6.helpInlineEsPotencialBenMigrado1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                            ...
                                            <h:panelGrid
                                                id="gridLote1" rendered="#{PotencialBen6.gestor.designing}"
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                            ...
                                            <h:panelGrid
                                                columns="7"
                                                id="gridLote2" rendered="#{PotencialBen6.gestor.designing}"
                                                styleClass="pdq-grid-elemento-1">
                                                <webuijsf:textField id="campoLote1"
                                                    binding="#{PotencialBen6.campoLote1}"
                                                    converter="#{PotencialBen6.converterLote1}"
                                                    readOnly="true"
                                                    text="#{PotencialBen6.potencialBenDataProvider.value['lote']}"
                                                    toolTip="BundleParametros.lote.potencial_ben"
                                                    validatorExpression="#{PotencialBen6.validatorLote1.validate}"/>
                                                <webuijsf:staticText id="campoLote1Texto1"
                                                    binding="#{PotencialBen6.campoLote1Texto1}"
                                                    text="#{PotencialBen6.potencialBenDataProvider.value['lote']}"/>
                                                <webuijsf:message id="messageLote1"
                                                    for="campoLote1"/>
                                                <webuijsf:helpInline id="helpInlineLote1"
                                                    binding="#{PotencialBen6.helpInlineLote1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                            ...
                                            <h:panelGrid
                                                id="gridNumeroTipoArea1" rendered="#{PotencialBen6.gestor.designing}"
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                            ...
                                            <h:panelGrid
                                                columns="7"
                                                id="gridNumeroTipoArea2" rendered="#{PotencialBen6.gestor.designing}"
                                                styleClass="pdq-grid-elemento-1">
                                            ...
                                            <h:panelGrid
                                                id="gridIndiceCalidadVida1" rendered="#{PotencialBen6.gestor.designing}"
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                            ...
                                            <h:panelGrid
                                                columns="7"
                                                id="gridIndiceCalidadVida2" rendered="#{PotencialBen6.gestor.designing}"
                                                styleClass="pdq-grid-elemento-1">
                                                <webuijsf:textField id="campoIndiceCalidadVida1"
                                                    binding="#{PotencialBen6.campoIndiceCalidadVida1}"
                                                    converter="#{PotencialBen6.converterIndiceCalidadVida1}"
                                                    readOnly="true"
                                                    text="#{PotencialBen6.potencialBenDataProvider.value['indice_calidad_vida']}"
                                                    toolTip="BundleParametros.indice_calidad_vida.potencial_ben"
                                                    validatorExpression="#{PotencialBen6.validatorIndiceCalidadVida1.validate}"/>
                                                <webuijsf:staticText id="campoIndiceCalidadVida1Texto1"
                                                    binding="#{PotencialBen6.campoIndiceCalidadVida1Texto1}"
                                                    converter="#{PotencialBen6.converterIndiceCalidadVida1}"
                                                    text="#{PotencialBen6.potencialBenDataProvider.value['indice_calidad_vida']}"/>
                                                <webuijsf:message id="messageIndiceCalidadVida1"
                                                    for="campoIndiceCalidadVida1"/>
                                                <webuijsf:helpInline id="helpInlineIndiceCalidadVida1"
                                                    binding="#{PotencialBen6.helpInlineIndiceCalidadVida1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                        ...
                                        <h:panelGrid
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:textField id="campoIdUsuarioRegPotBen1x1"
                                                    binding="#{PotencialBen6.campoIdUsuarioRegPotBen1x1}"
                                                    readOnly="true"
                                                    text="#{PotencialBen6.asistente.textoCampoIdUsuarioRegPotBen1}"
                                                    toolTip="#{PotencialBen6.asistente.toolTipCampoIdUsuarioRegPotBen1}"
                                                    validatorExpression="#{PotencialBen6.campoIdUsuarioRegPotBen1_validate}"/>
                                                <webuijsf:staticText id="campoIdUsuarioRegPotBen1x1Texto1"
                                                    binding="#{PotencialBen6.campoIdUsuarioRegPotBen1x1Texto1}"
                                                    text="#{PotencialBen6.potencialBenDataProvider.value['codigo_usuario_1x15y3']}"/>
                                                <webuijsf:button id="campoIdUsuarioRegPotBen1x1Boton1"
                                                    binding="#{PotencialBen6.campoIdUsuarioRegPotBen1x1Boton1}"
                                                    onClick="#{PotencialBen6.asistente.scriptCampoIdUsuarioRegPotBen1Boton1}"/>
                                                <webuijsf:button id="campoIdUsuarioRegPotBen1x1Boton3"
                                                    binding="#{PotencialBen6.campoIdUsuarioRegPotBen1x1Boton3}"
                                                    onClick="#{PotencialBen6.asistente.scriptCampoIdUsuarioRegPotBen1Boton2}"
                                                    rendered="#{PotencialBen6.asistente.campoIdUsuarioRegPotBen1Boton3Rendered}"/>
                                                <webuijsf:message id="messageIdUsuarioRegPotBen1x1"
                                                    for="campoIdUsuarioRegPotBen1x1"/>
                                                <webuijsf:helpInline id="helpInlineIdUsuarioRegPotBen1x1"
                                                    binding="#{PotencialBen6.helpInlineIdUsuarioRegPotBen1x1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                                    text="BundleParametros.id_usuario_reg_pot_ben.potencial_ben"
                                                    type="field"/>
                                            ...
                                            <h:panelGrid
                                                ...
                                                rendered="#{PotencialBen6.asistente.campoIdUsuarioRegPotBen1Boton2Rendered}"
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                                    binding="#{PotencialBen6.labelIdUsuarioRegPotBen1x2}"
                                            ...
                                            <h:panelGrid
                                                ...
                                                styleClass="pdq-grid-elemento-1">
                                                <webuijsf:staticText
                                                    binding="#{PotencialBen6.campoIdUsuarioRegPotBen1x1Texto2}"
                                                    text="#{PotencialBen6.potencialBenDataProvider.value['nombre_usuario_1x15y4']}"
                                                    id="campoIdUsuarioRegPotBen1x1Texto2"/>
                                                <webuijsf:button
                                                    binding="#{PotencialBen6.campoIdUsuarioRegPotBen1x1Boton2}"
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:dropDown id="listaEsPotencialBenMigrado1x1"
                                                    binding="#{PotencialBen6.listaEsPotencialBenMigrado1x1}"
                                                    converter="#{PotencialBen6.converterEsPotencialBenMigrado1}"
                                                    disabled="true"
                                                    items="#{PotencialBen6.asistente.opcionesListaEsPotencialBenMigrado1}"
                                                    selected="#{PotencialBen6.potencialBenDataProvider.value['es_potencial_ben_migrado']}"
                                                ...
                                                <webuijsf:staticText id="listaEsPotencialBenMigrado1x1Texto1"
                                                    binding="#{PotencialBen6.listaEsPotencialBenMigrado1x1Texto1}"/>
                                                <webuijsf:message id="messageEsPotencialBenMigrado1x1"
                                                    for="listaEsPotencialBenMigrado1x1"/>
                                                <webuijsf:helpInline id="helpInlineEsPotencialBenMigrado1x1"
                                                    binding="#{PotencialBen6.helpInlineEsPotencialBenMigrado1x1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                                    text="BundleParametros.es_potencial_ben_migrado.potencial_ben"
                                                    type="field"/>
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:textField id="campoLote1x1"
                                                    binding="#{PotencialBen6.campoLote1x1}"
                                                    converter="#{PotencialBen6.converterLote1}"
                                                    readOnly="true"
                                                    text="#{PotencialBen6.potencialBenDataProvider.value['lote']}"
                                                    toolTip="BundleParametros.lote.potencial_ben"
                                                ...
                                                <webuijsf:staticText id="campoLote1x1Texto1"
                                                    binding="#{PotencialBen6.campoLote1x1Texto1}"
                                                    text="#{PotencialBen6.potencialBenDataProvider.value['lote']}"/>
                                                <webuijsf:message id="messageLote1x1"
                                                    for="campoLote1x1"/>
                                                <webuijsf:helpInline id="helpInlineLote1x1"
                                                    binding="#{PotencialBen6.helpInlineLote1x1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                                    text="BundleParametros.lote.potencial_ben"
                                                    type="field"/>
                                        ...
                                        <h:panelGrid
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:textField id="campoIndiceCalidadVida1x1"
                                                    binding="#{PotencialBen6.campoIndiceCalidadVida1x1}"
                                                    converter="#{PotencialBen6.converterIndiceCalidadVida1}"
                                                    readOnly="true"
                                                    text="#{PotencialBen6.potencialBenDataProvider.value['indice_calidad_vida']}"
                                                    toolTip="BundleParametros.indice_calidad_vida.potencial_ben"
                                                ...
                                                <webuijsf:staticText id="campoIndiceCalidadVida1x1Texto1"
                                                    binding="#{PotencialBen6.campoIndiceCalidadVida1x1Texto1}"
                                                    converter="#{PotencialBen6.converterIndiceCalidadVida1}"
                                                    text="#{PotencialBen6.potencialBenDataProvider.value['indice_calidad_vida']}"/>
                                                <webuijsf:message id="messageIndiceCalidadVida1x1"
                                                    for="campoIndiceCalidadVida1x1"/>
                                                <webuijsf:helpInline id="helpInlineIndiceCalidadVida1x1"
                                                    binding="#{PotencialBen6.helpInlineIndiceCalidadVida1x1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                                    text="BundleParametros.indice_calidad_vida.potencial_ben"
                                                    type="field"/>
