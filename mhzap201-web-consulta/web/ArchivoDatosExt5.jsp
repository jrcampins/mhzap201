                                        ...
                                        <webuijsf:table
                                            ...
                                            <webuijsf:tableRowGroup 
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{ArchivoDatosExt5.gestor.designing}"/>
                                                <webuijsf:label
                                                    binding="#{ArchivoDatosExt5.labelNombreArchivoDatos1}"
                                                    id="labelNombreArchivoDatos1"
                                                    for="campoNombreArchivoDatos1"/>
                                                <webuijsf:textArea id="campoNombreArchivoDatos1"
                                                    binding="#{ArchivoDatosExt5.campoNombreArchivoDatos1}"
                                                    columns="50" rows="3"
                                                    readOnly="true"
                                                    text="#{currentRow.value['nombre_archivo_datos']}"
                                                    toolTip="BundleParametros.nombre_archivo_datos.archivo_datos_ext"
                                                    validatorExpression="#{ArchivoDatosExt5.validatorNombreArchivoDatos1.validate}"/>
                                                <webuijsf:staticText id="campoNombreArchivoDatos1Texto1"
                                                    binding="#{ArchivoDatosExt5.campoNombreArchivoDatos1Texto1}"
                                                    text="#{currentRow.value['nombre_archivo_datos']}"/>
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{ArchivoDatosExt5.gestor.designing}"/>
                                                <webuijsf:button
                                                    binding="#{ArchivoDatosExt5.campoNombreArchivoDatos1Boton3}"
                                                    id="campoNombreArchivoDatos1Boton3"
                                                    onClick="#{ArchivoDatosExt5.asistente.scriptCampoNombreArchivoDatos1Boton3}"
                                                    rendered="#{ArchivoDatosExt5.asistente.campoNombreArchivoDatos1Boton3Rendered}"
                                                    text="#{ArchivoDatosExt5.asistente.textCampoNombreArchivoDatos1Boton3}"
                                                    toolTip="#{ArchivoDatosExt5.asistente.toolTipCampoNombreArchivoDatos1Boton3}"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    rendered="#{ArchivoDatosExt5.gestor.designing}"/>
                                                <webuijsf:label
                                                    binding="#{ArchivoDatosExt5.labelNombreOriginalArchivoDatos1}"
                                                ...
                                                <webuijsf:textArea id="campoNombreOriginalArchivoDatos1"
                                                    binding="#{ArchivoDatosExt5.campoNombreOriginalArchivoDatos1}"
                                                    columns="50" rows="3"
                                                    readOnly="true"
                                                    text="#{currentRow.value['nombre_original_archivo_datos']}"
                                                    toolTip="BundleParametros.nombre_original_archivo_datos.archivo_datos_ext"
                                                    validatorExpression="#{ArchivoDatosExt5.validatorNombreOriginalArchivoDatos1.validate}"/>
                                                <webuijsf:staticText id="campoNombreOriginalArchivoDatos1Texto1"
                                                    binding="#{ArchivoDatosExt5.campoNombreOriginalArchivoDatos1Texto1}"
                                                    text="#{currentRow.value['nombre_original_archivo_datos']}"/>
