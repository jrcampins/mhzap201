                                    ...
                                    <h:panelGrid 
                                        ...
                                        <h:panelGrid
                                            ...
                                            <h:panelGrid
                                                ...
                                                rendered="#{FichaHogar6.asistente.gridNumeroTipoAreaRendered}"
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                        ...
                                        <webuijsf:tab
                                            id="tab11"
                                            rendered="#{FichaHogar6.asistente.seccionEtcRendered}"
                                            text="etc">
                                        <h:panelGrid
                                            id="gridPanel136"
                                            rendered="#{FichaHogar6.asistente.seccionEtcHidden}">
                                            <webuijsf:staticText
