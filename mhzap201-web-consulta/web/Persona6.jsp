                                ...
                                <div class="pos-div-detalle">
                                    <h:panelGrid 
                                        ...
                                        <h:panelGrid
                                            ...
                                            <h:panelGrid
                                                id="gridComentariosAnulCerVida1" rendered="#{Persona6.gestor.designing}"
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                            ...
                                            <h:panelGrid
                                                columns="7"
                                                id="gridComentariosAnulCerVida2" rendered="#{Persona6.gestor.designing}"
                                                styleClass="pdq-grid-elemento-1">
                                                <webuijsf:textArea id="campoComentariosAnulCerVida1"
                                                    binding="#{Persona6.campoComentariosAnulCerVida1}"
                                                    columns="100" rows="3"
                                                    readOnly="true"
                                                    text="#{Persona6.personaDataProvider.value['comentarios_anul_cer_vida']}"
                                                    toolTip="BundleParametros.comentarios_anul_cer_vida.persona"
                                                    validatorExpression="#{Persona6.validatorComentariosAnulCerVida1.validate}"/>
                                                <webuijsf:staticText id="campoComentariosAnulCerVida1Texto1"
                                                    binding="#{Persona6.campoComentariosAnulCerVida1Texto1}"
                                                    text="#{Persona6.personaDataProvider.value['comentarios_anul_cer_vida']}"/>
                                                <webuijsf:message id="messageComentariosAnulCerVida1"
                                                    for="campoComentariosAnulCerVida1"/>
                                                <webuijsf:helpInline id="helpInlineComentariosAnulCerVida1"
                                                    binding="#{Persona6.helpInlineComentariosAnulCerVida1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                            ...
                                            <h:panelGrid
                                                id="gridComentariosAnulCerDefuncion1" rendered="#{Persona6.gestor.designing}"
                                                styleClass="pdq-grid-etiqueta-1">
                                                <webuijsf:label
                                            ...
                                            <h:panelGrid
                                                columns="7"
                                                id="gridComentariosAnulCerDefuncion2" rendered="#{Persona6.gestor.designing}"
                                                styleClass="pdq-grid-elemento-1">
                                                <webuijsf:textArea id="campoComentariosAnulCerDefuncion1"
                                                    binding="#{Persona6.campoComentariosAnulCerDefuncion1}"
                                                    columns="100" rows="3"
                                                    readOnly="true"
                                                    text="#{Persona6.personaDataProvider.value['comentarios_anul_cer_defuncion']}"
                                                    toolTip="BundleParametros.comentarios_anul_cer_defuncion.persona"
                                                    validatorExpression="#{Persona6.validatorComentariosAnulCerDefuncion1.validate}"/>
                                                <webuijsf:staticText id="campoComentariosAnulCerDefuncion1Texto1"
                                                    binding="#{Persona6.campoComentariosAnulCerDefuncion1Texto1}"
                                                    text="#{Persona6.personaDataProvider.value['comentarios_anul_cer_defuncion']}"/>
                                                <webuijsf:message id="messageComentariosAnulCerDefuncion1"
                                                    for="campoComentariosAnulCerDefuncion1"/>
                                                <webuijsf:helpInline id="helpInlineComentariosAnulCerDefuncion1"
                                                    binding="#{Persona6.helpInlineComentariosAnulCerDefuncion1}"
                                                    rendered="#{SessionBean1.contextoSesion.helpInlineRendered}"
                                                    styleClass="pdq-helpInline-field"
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:staticText id="listaNumeroCondicionPension1Texto1"
                                                    ...
                                                    text="#{Persona6.personaDataProvider.value['codigo_condicion_pension_1x9y2']}"/>
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:staticText id="listaNumeroCausaDenPension1Texto1"
                                                    ...
                                                    text="#{Persona6.personaDataProvider.value['codigo_causa_den_pensio_1x10y2']}"/>
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:staticText id="listaNumeroCausaRevPension1Texto1"
                                                    ...
                                                    text="#{Persona6.personaDataProvider.value['codigo_causa_rev_pensio_1x11y2']}"/>
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:staticText id="listaNumeroCondicionRecoPen1Texto1"
                                                    ...
                                                    text="#{Persona6.personaDataProvider.value['codigo_condicion_reco_p_1x12y2']}"/>
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:staticText id="listaNumeroCausaDenRecoPen1Texto1"
                                                    ...
                                                    text="#{Persona6.personaDataProvider.value['codigo_causa_den_reco_p_1x13y2']}"/>
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:staticText id="listaNumeroCondicionDenuPen1Texto1"
                                                    ...
                                                    text="#{Persona6.personaDataProvider.value['codigo_condicion_denu_p_1x14y2']}"/>
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:staticText id="campoIdFichaPersona1Texto1"
                                                    ...
                                                    text="#{Persona6.personaDataProvider.value['codigo_ficha_persona_1x15y3']}"/>
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:staticText
                                                    ...
                                                    text="#{Persona6.personaDataProvider.value['nombre_ficha_persona_1x15y4']}"
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:staticText id="listaNumeroTipoActJupe1Texto1"
                                                    ...
                                                    text="#{Persona6.personaDataProvider.value['codigo_tipo_act_jupe_1x16y2']}"/>
                                        ...
                                        <h:panelGrid
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:textArea id="campoComentariosAnulCerVida1x1"
                                                    binding="#{Persona6.campoComentariosAnulCerVida1x1}"
                                                    columns="100" rows="3"
                                                    readOnly="true"
                                                    text="#{Persona6.personaDataProvider.value['comentarios_anul_cer_vida']}"
                                                    toolTip="BundleParametros.comentarios_anul_cer_vida.persona"
                                            ...
                                            <h:panelGrid
                                                ...
                                                <webuijsf:textArea id="campoComentariosAnulCerDefuncion1x1"
                                                    binding="#{Persona6.campoComentariosAnulCerDefuncion1x1}"
                                                    columns="100" rows="3"
                                                    readOnly="true"
                                                    text="#{Persona6.personaDataProvider.value['comentarios_anul_cer_defuncion']}"
                                                    toolTip="BundleParametros.comentarios_anul_cer_defuncion.persona"
                                        ...
                                        <webuijsf:tab
                                            id="tab11"
                                            rendered="#{Persona6.asistente.seccionEtcRendered}"
                                            text="etc">
                                        <h:panelGrid
                                            id="gridPanel136"
                                            rendered="#{Persona6.asistente.seccionEtcHidden}">
                                            <webuijsf:staticText
