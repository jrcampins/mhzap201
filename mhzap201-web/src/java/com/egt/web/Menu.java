...
public class Menu extends AbstractPageBean
    ...
    public void preprocess() {
        com.egt.core.aplicacion.Bitacora.trace(getClass().getName() + ".preprocess");
        this.preprocesar();
    }
    ...
    public void prerender() {
        com.egt.core.aplicacion.Bitacora.trace(getClass().getName() + ".prerender");
        this.prepresentar();
    }
    ...
    public Object getColumnaEtiqueta() {
        return EnumColumnaEtiqueta.COLUMNA_NOMBRE;
    }
    ...
    private final static String ETIQUETA_MIGAS_PAN = "Menú";

    private final static String ETIQUETA_CLASE_DETALLE = "Menú";

    private final static String ETIQUETA_ARBOL_RECURSO = "Haga clic sobre el nombre de la aplicación que desea ejecutar";
    ...
    public long getFuncionCrearRecurso() {
        return -1; // return OpcionMenuCachedRowSetDataProvider3.FUNCION_CREAR_OPCION_MENU;
    }

    @Override
    public long getFuncionModificarRecurso() {
        return -1; // return OpcionMenuCachedRowSetDataProvider3.FUNCION_MODIFICAR_OPCION_MENU;
    }

    @Override
    public long getFuncionEliminarRecurso() {
        return -1; // return OpcionMenuCachedRowSetDataProvider3.FUNCION_ELIMINAR_OPCION_MENU;
    }

    public Option[] getOpcionesListaFuncionEdicion() {
        return new Option[]{ // esta lista debe incluir al menos 2 opciones
                // new Option(OpcionMenuCachedRowSetDataProvider3.FUNCION_MODIFICAR_OPCION_MENU, "Modificar recurso"),
                // new Option(OpcionMenuCachedRowSetDataProvider3.FUNCION_DESACTIVAR_OPCION_MENU, "Desactivar recurso"),
                // new Option(OpcionMenuCachedRowSetDataProvider3.FUNCION_REACTIVAR_OPCION_MENU, "Reactivar recurso")
                };
    }
    ...
    public String getColumnaIdentificacionRecursoMaestro() {
        return null; // return OpcionMenuCachedRowSetDataProvider3.COLUMNA_ID_RECURSO_MAESTRO_EQUIS;
    }
    ...
    protected void prepresentar() {
        ...
        this.getTree1().setText(ETIQUETA_ARBOL_RECURSO);
    }
    ...
    public void consultar() {
        ...
        filtro.addCriterio(OpcionMenuCachedRowSetDataProvider3.COLUMNA_ES_OPCION_MENU_INACTIVA, IntUtils.FALSE);
        this.consultar(filtro);
    }

    public void consultar(Long filtro) {
        try {
            this.setCriteriosOrden();
            this.getOpcionMenuDataProvider().setLimiteFilasFuncionSelect(0);
    ...
    private void setCriteriosOrden() {
        this.getGestor().trace("setCriteriosOrden");
        OrdenConjuntoResultados criterios = new OrdenConjuntoResultados();
        criterios.addCriterio(OpcionMenuCachedRowSetDataProvider3.COLUMNA_CLAVE_OPCION_MENU);
        criterios.addCriterio(OpcionMenuCachedRowSetDataProvider3.COLUMNA_CODIGO_OPCION_MENU);
        this.getOpcionMenuDataProvider().setCriteriosOrden(criterios);
    }
