...
/**
 * <p>Application scope data bean for your application. Create properties here to represent cached data that
 * should be made available to all users and pages in the application.</p>
 *
...
/**/
    ...
    /**
     * <p>This method is called when this bean is initially added to application scope. Typically, this occurs
     * as a result of evaluating a value binding or method binding expression, which utilizes the managed bean
     * facility to instantiate this bean and store it into application scope.</p>
     *
     * <p>You may customize this method to initialize and cache application wide data values (such as the
     * lists of valid options for dropdown list components), or to allocate resources that are required for
    ...
    /**
     * <p>This method is called when this bean is removed from application scope. Typically, this occurs as a
     * result of the application being shut down by its owning container.</p>
     *
     ...
     * <code>Locale</code> defined for the current JavaServer Faces view. If no more suitable encoding can be
     * found, return "UTF-8" as a general purpose default.</p>
     *
     * <p>The default implementation uses the implementation from our superclass,
     * <code>AbstractApplicationBean</code>.</p>
     */
    @Override
