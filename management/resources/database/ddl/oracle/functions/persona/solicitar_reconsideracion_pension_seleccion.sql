...
--
create or replace function persona_solicitar_reco_pen_sel(rastro number, observaciones varchar2) return number is
...
begin
    ...
    mensaje:=sp$persona.solicitar_reco_pen_sel(usuario_proceso,observaciones);
