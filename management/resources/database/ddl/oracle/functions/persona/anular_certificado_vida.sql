...
--
create or replace function persona_anular_cer_vida(rastro number, persona_consultada number, comentarios varchar) return number is
    mensaje varchar2(200);
    retcode number;
begin
    mensaje:=sp$persona.anular_cer_vida(persona_consultada,comentarios);
