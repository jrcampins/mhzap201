...
--
create or replace function proceso_denegar_pensiones_obj(rastro number,ubicacion_consultada number,numero_resolucion varchar2, fecha_resolucion timestamp) return number is
    mensaje varchar2(2000);
    retcode number;
begin
    mensaje:=sp$proceso.denegar_pensiones_obj(ubicacion_consultada,numero_resolucion,fecha_resolucion);
