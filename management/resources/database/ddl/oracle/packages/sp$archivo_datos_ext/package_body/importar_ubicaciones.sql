procedure importar_ubicaciones(nombre_archivo varchar2) as
    retorno number:=0;
...
begin
    ...
    loop
        begin
            ...
            update log_imp_ubi set es_importado=1, fecha_hora_transaccion=current_timestamp where id_log_imp_ubi=current_ubicacion.id_log_imp_ubi;
            ...
            exception
                when others then
                    ...
                    update log_imp_ubi set observacion=mensaje, fecha_hora_transaccion=current_timestamp where id_log_imp_ubi=current_ubicacion.id_log_imp_ubi;
        end;
    end loop;
    --Distritos
