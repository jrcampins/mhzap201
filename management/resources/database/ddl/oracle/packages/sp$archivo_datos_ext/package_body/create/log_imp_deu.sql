procedure create_csv_log_imp_deu(archivo varchar2, conjunto varchar2, ignorados varchar2, separador varchar2, delimitador varchar2) is
    comando varchar2(4000);
begin    
    xsp.dropone('TABLE','csv_log_imp_deu');
    comando := 'create table csv_log_imp_deu '
            || '( '
            || 'cedula varchar2(255), '
