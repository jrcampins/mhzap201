procedure create_csv_log_imp_emp(archivo varchar2, conjunto varchar2, ignorados varchar2, separador varchar2, delimitador varchar2) is
    comando varchar2(4000);
begin
    xsp.dropone('TABLE','csv_log_imp_emp');
    comando := 'create table csv_log_imp_emp '
            || '( '
            || 'cedula varchar2(255), '
