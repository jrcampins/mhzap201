    ...
    loop
        ...
        exception
                when others then
                    ...
                    update log_imp_deu set es_importado=0, nombre_archivo=nombre_Archivo, codigo_archivo=codigo_archivo, fecha_hora_transaccion= current_timestamp, observacion=mensaje where id_log_imp_deu=deudor.id_log_imp_deu;
                    continue;
        end;
    end loop;
end;
