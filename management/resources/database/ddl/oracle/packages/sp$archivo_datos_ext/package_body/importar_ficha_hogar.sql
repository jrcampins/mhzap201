procedure importar_ficha_hogar_sas(nombre_archivo varchar2, codigo_archivo varchar2, retorno out number) as
    --retorno number:=0;
...
begin
    ...
    --importar fichas
    for current_row in (select * from log_imp_hog where es_importado=0 and observacion is null)
    loop
        begin
