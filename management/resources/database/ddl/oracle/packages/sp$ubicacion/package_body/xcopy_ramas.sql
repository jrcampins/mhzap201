...
begin
    ...
    loop
        ...
        elsif (row_ubicacion.numero_nivel_ubicacion < 2) then
        ...
        elsif (row_ubicacion.numero_nivel_ubicacion < 3) then
        ...
        elsif (row_ubicacion.numero_nivel_ubicacion < 4) then
        ...
        elsif (row_ubicacion.numero_nivel_ubicacion < 5) then
        ...
        elsif (row_ubicacion.numero_nivel_ubicacion < 6) then
        ...
        elsif (row_ubicacion.numero_nivel_ubicacion < 7) then
        ...
        elsif (row_ubicacion.numero_nivel_ubicacion < 8) then
        ...
        elsif (row_ubicacion.numero_nivel_ubicacion < 9) then
        ...
        elsif (row_ubicacion.numero_nivel_ubicacion < 10) then
        ...
        elsif (row_ubicacion.numero_nivel_ubicacion < 11) then
        ...
        elsif (row_ubicacion.numero_nivel_ubicacion < 12) then
        ...
        elsif (row_ubicacion.numero_nivel_ubicacion < 13) then
        ...
        elsif (row_ubicacion.numero_nivel_ubicacion < 14) then
        ...
        elsif (row_ubicacion.numero_nivel_ubicacion < 15) then
