...
begin
    ...
    begin
        ...
        v_str:='Cédula;Primer Nombre;Segundo Nombre;Primer Apellido;Segundo Apellido;Apellido Casada;Edad;Causa de Denegación';
        ...
        if vista_pen_rev.count=0 then
            return 'No hay Pensiones revocadas con el código de SIME '||codigo_sime;
        end if;
     ...
     mensaje:=conta||' objeciones de personas con pensión revocada exportadas';
     return mensaje;
end;