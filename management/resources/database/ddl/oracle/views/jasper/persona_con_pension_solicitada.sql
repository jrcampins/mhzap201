CREATE OR REPLACE VIEW persona_con_pension_solicitada
AS
...
ORDER BY persona.codigo_sime, persona.nombre_persona,persona.fecha_solicitud_pension, persona.id_departamento,
