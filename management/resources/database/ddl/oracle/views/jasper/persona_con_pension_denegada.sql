...
SELECT persona.codigo_persona AS cedula, persona.nombre_persona,
    ...
    persona.direccion, persona.numero_condicion_pension,
    persona.fecha_solicitud_pension, fecha_denegacion_pension,
    ...
    referencia_casa, persona.numero_causa_den_pension,
...
WHERE persona.numero_condicion_pension = 3
