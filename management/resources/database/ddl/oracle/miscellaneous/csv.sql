...
--
exec sp$100.create_csv_log_imp_deu('deu.csv', 'WE8ISO8859P1', '0', ',', '"');
exec sp$100.create_csv_log_imp_emp('emp.csv', 'WE8ISO8859P1', '0', ',', '"');
exec sp$100.create_csv_log_imp_fal('fal.csv', 'WE8ISO8859P1', '0', ',', '"');
exec sp$100.create_csv_log_imp_hog('hog.csv', 'WE8ISO8859P1', '0', ',', '"');
exec sp$100.create_csv_log_imp_ids('ids.csv', 'WE8ISO8859P1', '0', ',', '"');
exec sp$100.create_csv_log_imp_jub('jub.csv', 'WE8ISO8859P1', '0', ',', '"');
exec sp$100.create_csv_log_imp_pen('pen.csv', 'WE8ISO8859P1', '0', ',', '"');
exec sp$100.create_csv_log_imp_per('per.csv', 'WE8ISO8859P1', '0', ',', '"');
