...
SELECT pb.id_potencial_ben,pb.nombre_potencial_ben,pb.codigo_potencial_ben,
       pb.fecha_nacimiento,cast(date_part('year'::text, age(pb.fecha_nacimiento)) as integer) AS edad,
       pb.letra_cedula,pb.numero_cedula,pb.numero_cedula||concat_or_empty(cast('-' as varchar),pb.letra_cedula) as cedula,
