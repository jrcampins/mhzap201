if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[consulta_persona_1]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[consulta_persona_1]
GO
...
CREATE VIEW [dbo].[consulta_persona_1] AS
SELECT
	...
	persona.dias_vigencia_certificado_vida AS dias_vigencia_certificado_vida,
	...
	persona.numero_condicion_pension AS numero_condicion_pension,
		condicion_pension_1x8.codigo_condicion_pension AS codigo_condicion_pension_1x8y2,
	...
	persona.numero_causa_den_pension AS numero_causa_den_pension,
		causa_den_pension_1x9.codigo_causa_den_pension AS codigo_causa_den_pension_1x9y2,
	...
	persona.numero_causa_rev_pension AS numero_causa_rev_pension,
		causa_rev_pension_1x10.codigo_causa_rev_pension AS codigo_causa_rev_pensio_1x10y2,
	persona.otra_causa_rev_pension AS otra_causa_rev_pension,
	persona.numero_resolucion_rev_pen AS numero_resolucion_rev_pen,
	persona.fecha_resolucion_rev_pen AS fecha_resolucion_rev_pen,
	...
	persona.numero_condicion_reco_pen AS numero_condicion_reco_pen,
		condicion_reco_pen_1x11.codigo_condicion_reco_pen AS codigo_condicion_reco_p_1x11y2,
	...
	persona.numero_causa_den_reco_pen AS numero_causa_den_reco_pen,
		causa_den_reco_pen_1x12.codigo_causa_den_reco_pen AS codigo_causa_den_reco_p_1x12y2,
	...
	persona.numero_condicion_denu_pen AS numero_condicion_denu_pen,
		condicion_denu_pen_1x13.codigo_condicion_denu_pen AS codigo_condicion_denu_p_1x13y2,
	...
	persona.id_ficha_persona AS id_ficha_persona,
		ficha_persona_1x14.codigo_ficha_persona AS codigo_ficha_persona_1x14y3,
		ficha_persona_1x14.nombre_ficha_persona AS nombre_ficha_persona_1x14y4,
		ficha_persona_1x14.es_respondente AS es_respondente_1x14y5,
		ficha_persona_1x14.id_ficha_hogar AS id_ficha_hogar_1x14y6,
		ficha_persona_1x14.numero_orden_identificacion AS numero_orden_identifica_1x14y7,
		ficha_persona_1x14.primer_nombre AS primer_nombre_1x14y8,
		ficha_persona_1x14.segundo_nombre AS segundo_nombre_1x14y9,
		ficha_persona_1x14.primer_apellido AS primer_apellido_1x14y10,
		ficha_persona_1x14.segundo_apellido AS segundo_apellido_1x14y11,
		ficha_persona_1x14.apellido_casada AS apellido_casada_1x14y12,
		ficha_persona_1x14.apodo AS apodo_1x14y13,
		ficha_persona_1x14.edad AS edad_1x14y14,
		ficha_persona_1x14.numero_sexo_persona AS numero_sexo_persona_1x14y15,
		ficha_persona_1x14.numero_estado_civil AS numero_estado_civil_1x14y16,
		ficha_persona_1x14.numero_tipo_persona_hogar AS numero_tipo_persona_ho_1x14y17,
		ficha_persona_1x14.numero_siono_miembro_hogar AS numero_siono_miembro_h_1x14y18,
		ficha_persona_1x14.numero_orden_iden_conyuge AS numero_orden_iden_cony_1x14y19,
		ficha_persona_1x14.numero_orden_iden_padre AS numero_orden_iden_padr_1x14y20,
		ficha_persona_1x14.numero_orden_iden_madre AS numero_orden_iden_madr_1x14y21,
		ficha_persona_1x14.numero_cedula AS numero_cedula_1x14y22,
		ficha_persona_1x14.letra_cedula AS letra_cedula_1x14y23,
		ficha_persona_1x14.numero_tipo_excepcion_ced AS numero_tipo_excepcion__1x14y24,
		ficha_persona_1x14.fecha_nacimiento AS fecha_nacimiento_1x14y25,
		ficha_persona_1x14.id_departamento_nacimiento AS id_departamento_nacimi_1x14y26,
		ficha_persona_1x14.id_distrito_nacimiento AS id_distrito_nacimiento_1x14y27,
		ficha_persona_1x14.numero_tipo_area_lugar_nac AS numero_tipo_area_lugar_1x14y28,
		ficha_persona_1x14.numero_idioma_hogar AS numero_idioma_hogar_1x14y29,
		ficha_persona_1x14.otro_idioma_hogar AS otro_idioma_hogar_1x14y30,
		ficha_persona_1x14.numero_siono_asistencia_esc AS numero_siono_asistenci_1x14y31,
		ficha_persona_1x14.numero_motivo_ina_esc AS numero_motivo_ina_esc_1x14y32,
		ficha_persona_1x14.otro_motivo_ina_esc AS otro_motivo_ina_esc_1x14y33,
		ficha_persona_1x14.numero_siono_matriculacion_esc AS numero_siono_matricula_1x14y34,
		ficha_persona_1x14.ultimo_curso_aprobado AS ultimo_curso_aprobado_1x14y35,
		ficha_persona_1x14.numero_nivel_edu_ult_cur_aprob AS numero_nivel_edu_ult_c_1x14y36,
		ficha_persona_1x14.numero_siono_curso_no_formal AS numero_siono_curso_no__1x14y37,
		ficha_persona_1x14.numero_tipo_seguro_medico AS numero_tipo_seguro_med_1x14y38,
		ficha_persona_1x14.numero_estado_salud AS numero_estado_salud_1x14y39,
		ficha_persona_1x14.numero_clase_enf_acc AS numero_clase_enf_acc_1x14y40,
		ficha_persona_1x14.otra_clase_enf_acc AS otra_clase_enf_acc_1x14y41,
		ficha_persona_1x14.numero_clase_enf_cronica AS numero_clase_enf_croni_1x14y42,
		ficha_persona_1x14.otra_clase_enf_cronica AS otra_clase_enf_cronica_1x14y43,
		ficha_persona_1x14.numero_siono_atencion_medica AS numero_siono_atencion__1x14y44,
		ficha_persona_1x14.numero_motivo_no_atencion AS numero_motivo_no_atenc_1x14y45,
		ficha_persona_1x14.otro_motivo_no_atencion AS otro_motivo_no_atencio_1x14y46,
		ficha_persona_1x14.numero_siono_carnet_vacunacion AS numero_siono_carnet_va_1x14y47,
		ficha_persona_1x14.numero_clase_impedimento AS numero_clase_impedimen_1x14y48,
		ficha_persona_1x14.otra_clase_impedimento AS otra_clase_impedimento_1x14y49,
		ficha_persona_1x14.numero_causa_impedimento AS numero_causa_impedimen_1x14y50,
		ficha_persona_1x14.otra_causa_impedimento AS otra_causa_impedimento_1x14y51,
		ficha_persona_1x14.numero_siono_dif_para_caminar AS numero_siono_dif_para__1x14y52,
		ficha_persona_1x14.numero_siono_dif_para_vestirse AS numero_siono_dif_para__1x14y53,
		ficha_persona_1x14.numero_siono_dif_para_banarse AS numero_siono_dif_para__1x14y54,
		ficha_persona_1x14.numero_siono_dif_para_comer AS numero_siono_dif_para__1x14y55,
		ficha_persona_1x14.numero_siono_dif_para_la_cama AS numero_siono_dif_para__1x14y56,
		ficha_persona_1x14.numero_siono_dif_para_el_bano AS numero_siono_dif_para__1x14y57,
		ficha_persona_1x14.numero_siono_trabajo AS numero_siono_trabajo_1x14y58,
		ficha_persona_1x14.numero_motivo_no_trabajo AS numero_motivo_no_traba_1x14y59,
		ficha_persona_1x14.otro_motivo_no_trabajo AS otro_motivo_no_trabajo_1x14y60,
		ficha_persona_1x14.descripcion_ocupacion_prin AS descripcion_ocupacion__1x14y61,
		ficha_persona_1x14.descripcion_dedicacion_prin AS descripcion_dedicacion_1x14y62,
		ficha_persona_1x14.numero_tipo_relacion_lab AS numero_tipo_relacion_l_1x14y63,
		ficha_persona_1x14.monto_ingreso_ocupacion_prin AS monto_ingreso_ocupacio_1x14y64,
		ficha_persona_1x14.monto_ingreso_ocupacion_secun AS monto_ingreso_ocupacio_1x14y65,
		ficha_persona_1x14.monto_ingreso_otras_ocup AS monto_ingreso_otras_oc_1x14y66,
		ficha_persona_1x14.monto_ingreso_alquileres AS monto_ingreso_alquiler_1x14y67,
		ficha_persona_1x14.monto_ingreso_intereses AS monto_ingreso_interese_1x14y68,
		ficha_persona_1x14.monto_ingreso_ayuda_fam_pais AS monto_ingreso_ayuda_fa_1x14y69,
		ficha_persona_1x14.monto_ingreso_ayuda_fam_exter AS monto_ingreso_ayuda_fa_1x14y70,
		ficha_persona_1x14.monto_ingreso_jubilacion AS monto_ingreso_jubilaci_1x14y71,
		ficha_persona_1x14.monto_ingreso_pensiones AS monto_ingreso_pensione_1x14y72,
		ficha_persona_1x14.monto_ingreso_tekopora AS monto_ingreso_tekopora_1x14y73,
		ficha_persona_1x14.monto_ingreso_programas AS monto_ingreso_programa_1x14y74,
		ficha_persona_1x14.monto_ingreso_adicional AS monto_ingreso_adiciona_1x14y75,
		ficha_persona_1x14.total_ingreso_mensual AS total_ingreso_mensual_1x14y76,
		ficha_persona_1x14.id_potencial_ben AS id_potencial_ben_1x14y77,
		ficha_persona_1x14.es_ficha_persona_inactiva AS es_ficha_persona_inact_1x14y78,
		ficha_persona_1x14.es_ficha_persona_importada AS es_ficha_persona_impor_1x14y79,
		ficha_persona_1x14.fecha_importacion AS fecha_importacion_1x14y80,
	...
	persona.numero_tipo_act_jupe AS numero_tipo_act_jupe,
		tipo_act_jupe_1x15.codigo_tipo_act_jupe AS codigo_tipo_act_jupe_1x15y2,
	persona.fecha_hora_ult_act_jupe AS fecha_hora_ult_act_jupe,
	persona.lote AS lote,
	persona.codigo_sime AS codigo_sime,
	persona.codigo_sime_reco_pen AS codigo_sime_reco_pen,
	persona.comentarios_entrega_documentos AS comentarios_entrega_documentos,
	persona.comentarios_insercion_jupe AS comentarios_insercion_jupe
FROM
	persona persona
	...
	LEFT OUTER JOIN condicion_pension condicion_pension_1x8 ON condicion_pension_1x8.numero_condicion_pension = persona.numero_condicion_pension
	LEFT OUTER JOIN causa_den_pension causa_den_pension_1x9 ON causa_den_pension_1x9.numero_causa_den_pension = persona.numero_causa_den_pension
	LEFT OUTER JOIN causa_rev_pension causa_rev_pension_1x10 ON causa_rev_pension_1x10.numero_causa_rev_pension = persona.numero_causa_rev_pension
	LEFT OUTER JOIN condicion_reco_pen condicion_reco_pen_1x11 ON condicion_reco_pen_1x11.numero_condicion_reco_pen = persona.numero_condicion_reco_pen
	LEFT OUTER JOIN causa_den_reco_pen causa_den_reco_pen_1x12 ON causa_den_reco_pen_1x12.numero_causa_den_reco_pen = persona.numero_causa_den_reco_pen
	LEFT OUTER JOIN condicion_denu_pen condicion_denu_pen_1x13 ON condicion_denu_pen_1x13.numero_condicion_denu_pen = persona.numero_condicion_denu_pen
	LEFT OUTER JOIN ficha_persona ficha_persona_1x14 ON ficha_persona_1x14.id_ficha_persona = persona.id_ficha_persona
	LEFT OUTER JOIN tipo_act_jupe tipo_act_jupe_1x15 ON tipo_act_jupe_1x15.numero_tipo_act_jupe = persona.numero_tipo_act_jupe
GO
