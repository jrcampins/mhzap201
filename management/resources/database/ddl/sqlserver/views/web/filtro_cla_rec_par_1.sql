if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[consulta_filtro_cla_rec_par_1]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[consulta_filtro_cla_rec_par_1]
GO
...
CREATE VIEW [dbo].[consulta_filtro_cla_rec_par_1] AS
SELECT
	filtro_cla_rec_par.id_filtro_cla_rec_par AS id_filtro_cla_rec_par,
	filtro_cla_rec_par.version_filtro_cla_rec_par AS version_filtro_cla_rec_par,
	filtro_cla_rec_par.id_clase_recurso_par AS id_clase_recurso_par,
		clase_recurso_par_1x1.id_clase_recurso AS id_clase_recurso_1x1y3,
		clase_recurso_par_1x1.id_parametro AS id_parametro_1x1y4,
		clase_recurso_par_1x1.numero_tipo_parametro AS numero_tipo_parametro_1x1y5,
		clase_recurso_par_1x1.numero_tipo_comparacion AS numero_tipo_comparacion_1x1y6,
		clase_recurso_par_1x1.id_funcion_referencia AS id_funcion_referencia_1x1y7,
		clase_recurso_par_1x1.numero_tipo_valor AS numero_tipo_valor_1x1y8,
		clase_recurso_par_1x1.id_lista_valor AS id_lista_valor_1x1y9,
		clase_recurso_par_1x1.id_clase_objeto_valor AS id_clase_objeto_valor_1x1y10,
		clase_recurso_par_1x1.id_clase_recurso_valor AS id_clase_recurso_valor_1x1y11,
		clase_recurso_par_1x1.valor_minimo AS valor_minimo_1x1y12,
		clase_recurso_par_1x1.valor_maximo AS valor_maximo_1x1y13,
		clase_recurso_par_1x1.valor_omision AS valor_omision_1x1y14,
		clase_recurso_par_1x1.es_parametro_omisible AS es_parametro_omisible_1x1y15,
		clase_recurso_par_1x1.es_parametro_inmutable AS es_parametro_inmutable_1x1y16,
		clase_recurso_par_1x1.es_parametro_submit AS es_parametro_submit_1x1y17,
		clase_recurso_par_1x1.es_parametro_primordial AS es_parametro_primordial_1x1y18,
		clase_recurso_par_1x1.es_parametro_maestro AS es_parametro_maestro_1x1y19,
		clase_recurso_par_1x1.es_parametro_segmento AS es_parametro_segmento_1x1y20,
		clase_recurso_par_1x1.es_parametro_sin_rastro AS es_parametro_sin_rastro_1x1y21,
		clase_recurso_par_1x1.es_parametro_sincronizado AS es_parametro_sincroniza_1x1y22,
		clase_recurso_par_1x1.orden_presentacion AS orden_presentacion_1x1y23,
		clase_recurso_par_1x1.id_clase_recurso_sec AS id_clase_recurso_sec_1x1y24,
		clase_recurso_par_1x1.es_referencia_alternativa AS es_referencia_alternati_1x1y25,
		clase_recurso_par_1x1.numero_tipo_valor_alternativo AS numero_tipo_valor_alter_1x1y26,
		clase_recurso_par_1x1.id_funcion_referencia_alt AS id_funcion_referencia_a_1x1y27,
		clase_recurso_par_1x1.id_lista_valor_alternativa AS id_lista_valor_alternat_1x1y28,
		clase_recurso_par_1x1.id_clase_objeto_valor_alt AS id_clase_objeto_valor_a_1x1y29,
		clase_recurso_par_1x1.id_clase_recurso_valor_alt AS id_clase_recurso_valor__1x1y30,
		clase_recurso_par_1x1.orden_pagina_seleccion AS orden_pagina_seleccion_1x1y31,
	filtro_cla_rec_par.id_clase_recurso_par_columna AS id_clase_recurso_par_columna,
	...
	filtro_cla_rec_par.numero_operador_com AS numero_operador_com,
		operador_com_1x3.codigo_operador_com AS codigo_operador_com_1x3y2,
	filtro_cla_rec_par.id_clase_recurso_par_valor AS id_clase_recurso_par_valor,
	...
	filtro_cla_rec_par.valor AS valor
FROM
	filtro_cla_rec_par filtro_cla_rec_par
	INNER JOIN clase_recurso_par clase_recurso_par_1x1 ON clase_recurso_par_1x1.id_clase_recurso_par = filtro_cla_rec_par.id_clase_recurso_par
	INNER JOIN clase_recurso_par clase_recurso_par_1x2 ON clase_recurso_par_1x2.id_clase_recurso_par = filtro_cla_rec_par.id_clase_recurso_par_columna
	INNER JOIN operador_com operador_com_1x3 ON operador_com_1x3.numero_operador_com = filtro_cla_rec_par.numero_operador_com
	LEFT OUTER JOIN clase_recurso_par clase_recurso_par_1x4 ON clase_recurso_par_1x4.id_clase_recurso_par = filtro_cla_rec_par.id_clase_recurso_par_valor
GO
