if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[consulta_dominio_1]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[consulta_dominio_1]
GO
...
CREATE VIEW [dbo].[consulta_dominio_1] AS
SELECT
