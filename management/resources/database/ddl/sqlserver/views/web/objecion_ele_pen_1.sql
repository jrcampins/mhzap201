if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[consulta_objecion_ele_pen_1]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[consulta_objecion_ele_pen_1]
GO
...
CREATE VIEW [dbo].[consulta_objecion_ele_pen_1] AS
SELECT
	...
	objecion_ele_pen.id_persona AS id_persona,
		...
		persona_1x1.monto_pension AS monto_pension_1x1y49,
		persona_1x1.numero_condicion_pension AS numero_condicion_pensio_1x1y50,
		persona_1x1.lugar_solicitud_pension AS lugar_solicitud_pension_1x1y51,
		persona_1x1.fecha_solicitud_pension AS fecha_solicitud_pension_1x1y52,
		persona_1x1.comentarios_solicitud_pension AS comentarios_solicitud_p_1x1y53,
		persona_1x1.fecha_aprobacion_pension AS fecha_aprobacion_pensio_1x1y54,
		persona_1x1.comentarios_aprobacion_pension AS comentarios_aprobacion__1x1y55,
		persona_1x1.fecha_otorgamiento_pen AS fecha_otorgamiento_pen_1x1y56,
		persona_1x1.comentarios_otorgamiento_pen AS comentarios_otorgamient_1x1y57,
		persona_1x1.fecha_denegacion_pension AS fecha_denegacion_pensio_1x1y58,
		...
		persona_1x1.comentarios_denegacion_pension AS comentarios_denegacion__1x1y61,
		persona_1x1.fecha_revocacion_pension AS fecha_revocacion_pensio_1x1y62,
		persona_1x1.numero_causa_rev_pension AS numero_causa_rev_pensio_1x1y63,
		persona_1x1.otra_causa_rev_pension AS otra_causa_rev_pension_1x1y64,
		persona_1x1.comentarios_revocacion_pension AS comentarios_revocacion__1x1y65,
		persona_1x1.numero_condicion_reco_pen AS numero_condicion_reco_p_1x1y66,
		persona_1x1.fecha_solicitud_reco_pen AS fecha_solicitud_reco_pe_1x1y67,
		persona_1x1.comentarios_solicitud_reco_pen AS comentarios_solicitud_r_1x1y68,
		persona_1x1.fecha_aprobacion_reco_pen AS fecha_aprobacion_reco_p_1x1y69,
		persona_1x1.comentarios_apr_reco_pen AS comentarios_apr_reco_pe_1x1y70,
		persona_1x1.fecha_denegacion_reco_pen AS fecha_denegacion_reco_p_1x1y71,
		persona_1x1.numero_causa_den_reco_pen AS numero_causa_den_reco_p_1x1y72,
		persona_1x1.otra_causa_den_reco_pen AS otra_causa_den_reco_pen_1x1y73,
		persona_1x1.comentarios_den_reco_pen AS comentarios_den_reco_pe_1x1y74,
		persona_1x1.numero_condicion_denu_pen AS numero_condicion_denu_p_1x1y75,
		persona_1x1.fecha_registro_denuncia_pen AS fecha_registro_denuncia_1x1y76,
		persona_1x1.comentarios_registro_denu_pen AS comentarios_registro_de_1x1y77,
		persona_1x1.fecha_confirmacion_denu_pen AS fecha_confirmacion_denu_1x1y78,
		persona_1x1.comentarios_conf_denu_pen AS comentarios_conf_denu_p_1x1y79,
		persona_1x1.fecha_desmentido_denuncia_pen AS fecha_desmentido_denunc_1x1y80,
		persona_1x1.comentarios_des_denu_pen AS comentarios_des_denu_pe_1x1y81,
		persona_1x1.id_ficha_persona AS id_ficha_persona_1x1y82,
		persona_1x1.fecha_ficha_persona AS fecha_ficha_persona_1x1y83,
		persona_1x1.indice_calidad_vida AS indice_calidad_vida_1x1y84,
		persona_1x1.fecha_ultimo_cobro_pension AS fecha_ultimo_cobro_pens_1x1y85,
		persona_1x1.notas_anul_fec_ult_cob_pen AS notas_anul_fec_ult_cob__1x1y86,
		persona_1x1.numero_tipo_act_jupe AS numero_tipo_act_jupe_1x1y87,
		persona_1x1.fecha_hora_ult_act_jupe AS fecha_hora_ult_act_jupe_1x1y88,
		persona_1x1.numero_resolucion_otor_pen AS numero_resolucion_otor__1x1y89,
		persona_1x1.fecha_resolucion_otor_pen AS fecha_resolucion_otor_p_1x1y90,
