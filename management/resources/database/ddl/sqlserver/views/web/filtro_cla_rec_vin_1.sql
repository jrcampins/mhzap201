if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[consulta_filtro_cla_rec_vin_1]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[consulta_filtro_cla_rec_vin_1]
GO
...
CREATE VIEW [dbo].[consulta_filtro_cla_rec_vin_1] AS
SELECT
	filtro_cla_rec_vin.id_filtro_cla_rec_vin AS id_filtro_cla_rec_vin,
	filtro_cla_rec_vin.version_filtro_cla_rec_vin AS version_filtro_cla_rec_vin,
	filtro_cla_rec_vin.id_clase_recurso_par AS id_clase_recurso_par,
	...
	filtro_cla_rec_vin.id_clase_recurso_par_columna AS id_clase_recurso_par_columna,
	...
	filtro_cla_rec_vin.numero_operador_com AS numero_operador_com,
		operador_com_1x3.codigo_operador_com AS codigo_operador_com_1x3y2,
	filtro_cla_rec_vin.id_clase_recurso_par_valor AS id_clase_recurso_par_valor,
	...
	filtro_cla_rec_vin.valor AS valor
FROM
	filtro_cla_rec_vin filtro_cla_rec_vin
	INNER JOIN clase_recurso_par clase_recurso_par_1x1 ON clase_recurso_par_1x1.id_clase_recurso_par = filtro_cla_rec_vin.id_clase_recurso_par
	INNER JOIN clase_recurso_par clase_recurso_par_1x2 ON clase_recurso_par_1x2.id_clase_recurso_par = filtro_cla_rec_vin.id_clase_recurso_par_columna
	INNER JOIN operador_com operador_com_1x3 ON operador_com_1x3.numero_operador_com = filtro_cla_rec_vin.numero_operador_com
	LEFT OUTER JOIN clase_recurso_par clase_recurso_par_1x4 ON clase_recurso_par_1x4.id_clase_recurso_par = filtro_cla_rec_vin.id_clase_recurso_par_valor
GO
