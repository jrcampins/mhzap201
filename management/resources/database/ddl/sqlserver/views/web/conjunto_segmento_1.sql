if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[consulta_conjunto_segmento_1]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[consulta_conjunto_segmento_1]
GO
...
CREATE VIEW [dbo].[consulta_conjunto_segmento_1] AS
SELECT
	conjunto_segmento.id_conjunto_segmento AS id_conjunto_segmento,
	conjunto_segmento.version_conjunto_segmento AS version_conjunto_segmento,
	conjunto_segmento.codigo_conjunto_segmento AS codigo_conjunto_segmento,
	conjunto_segmento.nombre_conjunto_segmento AS nombre_conjunto_segmento,
	conjunto_segmento.descripcion_conjunto_segmento AS descripcion_conjunto_segmento,
	conjunto_segmento.id_clase_recurso AS id_clase_recurso,
...
FROM
	conjunto_segmento conjunto_segmento
	INNER JOIN clase_recurso clase_recurso_1x1 ON clase_recurso_1x1.id_clase_recurso = conjunto_segmento.id_clase_recurso
GO
