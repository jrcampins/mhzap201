if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[consulta_log_pro_act_jupe_1]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[consulta_log_pro_act_jupe_1]
GO
...
CREATE VIEW [dbo].[consulta_log_pro_act_jupe_1] AS
SELECT
	log_pro_act_jupe.id_log_pro_act_jupe AS id_log_pro_act_jupe,
	log_pro_act_jupe.version_log_pro_act_jupe AS version_log_pro_act_jupe,
	log_pro_act_jupe.id_persona AS id_persona,
	...
	log_pro_act_jupe.codigo_persona AS codigo_persona,
	log_pro_act_jupe.nombre_persona AS nombre_persona,
	log_pro_act_jupe.id_departamento AS id_departamento,
	...
	log_pro_act_jupe.id_distrito AS id_distrito,
	...
	log_pro_act_jupe.id_barrio AS id_barrio,
	...
	log_pro_act_jupe.numero_condicion_pension AS numero_condicion_pension,
		condicion_pension_1x5.codigo_condicion_pension AS codigo_condicion_pension_1x5y2,
	log_pro_act_jupe.es_procesado AS es_procesado,
	log_pro_act_jupe.observacion AS observacion,
	log_pro_act_jupe.fecha_hora_transaccion AS fecha_hora_transaccion
FROM
	log_pro_act_jupe log_pro_act_jupe
	LEFT OUTER JOIN persona persona_1x1 ON persona_1x1.id_persona = log_pro_act_jupe.id_persona
	LEFT OUTER JOIN ubicacion ubicacion_1x2 ON ubicacion_1x2.id_ubicacion = log_pro_act_jupe.id_departamento
	LEFT OUTER JOIN ubicacion ubicacion_1x3 ON ubicacion_1x3.id_ubicacion = log_pro_act_jupe.id_distrito
	LEFT OUTER JOIN ubicacion ubicacion_1x4 ON ubicacion_1x4.id_ubicacion = log_pro_act_jupe.id_barrio
	LEFT OUTER JOIN condicion_pension condicion_pension_1x5 ON condicion_pension_1x5.numero_condicion_pension = log_pro_act_jupe.numero_condicion_pension
GO
