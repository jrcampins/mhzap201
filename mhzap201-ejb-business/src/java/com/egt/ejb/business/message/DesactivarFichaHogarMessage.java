...
public class DesactivarFichaHogarMessage extends BusinessProcessMessage implements Serializable {

    public static final long PARAMETRO_ID_FICHA_HOGAR = 20341L;

    protected Long idFichaHogar;

    public DesactivarFichaHogarMessage(Long idFichaHogar) {
        this.init();
        this.funcion = 320100151L;
