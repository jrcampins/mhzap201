...
public class ProcesoExpPenDenMessage extends BusinessProcessMessage implements Serializable {

    public static final long PARAMETRO_CODIGO_SIME = 20996L;

    protected String codigoSime;

    public ProcesoExpPenDenMessage(String codigoSime) {
        this.init();
        this.funcion = 200200164L;
