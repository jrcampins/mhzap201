...
public class AprobarReclCenPotencialBenMessage extends BusinessProcessMessage implements Serializable {

    public static final long PARAMETRO_ID_POTENCIAL_BEN = 20571L;

    public static final long PARAMETRO_COMENTARIOS_APR_RECL_CEN = 20630L;

    protected Long idPotencialBen;

    protected String comentariosAprReclCen;

    public AprobarReclCenPotencialBenMessage(Long idPotencialBen, String comentariosAprReclCen) {
        this.init();
        this.funcion = 320400157L;
