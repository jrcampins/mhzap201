...
public class AcreditarPotencialBenMessage extends BusinessProcessMessage implements Serializable {

    public static final long PARAMETRO_ID_POTENCIAL_BEN = 20571L;

    protected Long idPotencialBen;

    public AcreditarPotencialBenMessage(Long idPotencialBen) {
        this.init();
        this.funcion = 320400159L;
