...
public class DesactivarPotencialBenMessage extends BusinessProcessMessage implements Serializable {

    public static final long PARAMETRO_ID_POTENCIAL_BEN = 20571L;

    protected Long idPotencialBen;

    public DesactivarPotencialBenMessage(Long idPotencialBen) {
        this.init();
        this.funcion = 320400151L;
