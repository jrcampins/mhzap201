...
public class RegReclCenPotencialBenMessage extends BusinessProcessMessage implements Serializable {

    public static final long PARAMETRO_ID_POTENCIAL_BEN = 20571L;

    public static final long PARAMETRO_COMENTARIOS_RECLAMO_CENSO = 20632L;

    protected Long idPotencialBen;

    protected String comentariosReclamoCenso;

    public RegReclCenPotencialBenMessage(Long idPotencialBen, String comentariosReclamoCenso) {
        this.init();
        this.funcion = 320400156L;
    ...
    public String getComentariosReclamoCenso() {
        return comentariosReclamoCenso;
    }
