...
public class ProcesoAprobarExclusionPenMessage extends BusinessProcessMessage implements Serializable {

    public static final long PARAMETRO_CODIGO_SIME = 20996L;

    protected String codigoSime;

    public ProcesoAprobarExclusionPenMessage(String codigoSime) {
        this.init();
        this.funcion = 200200162L;
