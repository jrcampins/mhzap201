...
public class ProcesoDenegarPensionesMessage extends BusinessProcessMessage implements Serializable {
    ...
    public ProcesoDenegarPensionesMessage(Long idUbicacion, String numeroResolucionDenPen, Date fechaResolucionDenPen) {
        this.init();
