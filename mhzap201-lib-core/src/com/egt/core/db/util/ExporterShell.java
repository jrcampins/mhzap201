...
public class ExporterShell {
    ...
    public static void main(String[] args) {
        ...
        ok &= Utils.checkEnvironmentVariable(SEV.EXPORT_RUNNER_LOG);
        if (ok) {
            TLC.iniciar();
...
//      Utils.println("*** ejecutar ***");
        Utils.println(Exporter.export(report, number, userid, target, format, select, args, true).getMensaje());
    }
}
